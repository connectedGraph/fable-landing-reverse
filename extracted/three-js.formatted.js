  ...
  (e) => {
    ...
    let L = {
      ...
      damp: function (e, t, i, n) {
        return C(e, t, 1 - Math.exp(-i * n));
      },
      pingpong: function (e, t = 1) {
        return t - Math.abs(R(e, 2 * t) - t);
      },
    ...
    class N {
      ...
      clampLength(e, t) {
        let i = this.length();
        return this.divideScalar(i || 1).multiplyScalar(w(i, e, t));
      }
      floor() {
      ...
      angleTo(e) {
        ...
        return 0 === t ? Math.PI / 2 : Math.acos(w(this.dot(e) / t, -1, 1));
      }
      distanceTo(e) {
      ...
      static slerpFlat(e, t, i, n, r, a, s) {
        ...
        if (c !== f || o !== u || l !== d || h !== p) {
          ...
          if (e < 0.9995) {
            let i = Math.acos(e),
              n = Math.sin(i);
            ((o = o * (t = Math.sin(t * i) / n) + u * (s = Math.sin(s * i) / n)),
              (l = l * t + d * s),
              (h = h * t + p * s),
              (c = c * t + f * s));
          } else {
            let e =
              1 /
              Math.sqrt(
                (o = o * t + u * s) * o + (l = l * t + d * s) * l + (h = h * t + p * s) * h + (c = c * t + f * s) * c,
              );
            ((o *= e), (l *= e), (h *= e), (c *= e));
          }
        }
      ...
      setFromUnitVectors(e, t) {
        ...
        return (
          i < 1e-8
            ...
            : ((this._x = e.y * t.z - e.z * t.y), (this._y = e.z * t.x - e.x * t.z), (this._z = e.x * t.y - e.y * t.x)),
          (this._w = i),
          this.normalize()
        );
      }
    ...
    class B {
      ...
      scale(e, t) {
        return (this.premultiply(z.makeScale(e, t)), this);
      }
      rotate(e) {
        return (this.premultiply(z.makeRotation(-e)), this);
      }
      translate(e, t) {
        return (this.premultiply(z.makeTranslation(e, t)), this);
      }
      makeTranslation(e, t) {
    ...
    let z = new B(),
      V = new B().set(0.4123908, 0.3575843, 0.1804808, 0.212639, 0.7151687, 0.0721923, 0.0193308, 0.1191948, 0.9505322),
      k = new B().set(
        3.2409699,
        -1.5373832,
        -0.4986108,
      ...
      G =
        ...
        (i = {
          ...
          convert: function (e, t, i) {
            return (
              !1 !== this.enabled &&
                ...
                t &&
                i &&
                (this.spaces[t].transfer === c && ((e.r = H(e.r)), (e.g = H(e.g)), (e.b = H(e.b))),
                this.spaces[t].primaries !== this.spaces[i].primaries &&
                  (e.applyMatrix3(this.spaces[t].toXYZ), e.applyMatrix3(this.spaces[i].fromXYZ)),
                this.spaces[i].transfer === c && ((e.r = W(e.r)), (e.g = W(e.g)), (e.b = W(e.b)))),
              e
            );
          },
          ...
          getTransfer: function (e) {
            return "" === e ? h : this.spaces[e].transfer;
          },
          ...
          fromWorkingColorSpace: function (e, t) {
            return (
              x("ColorManagement: .fromWorkingColorSpace() has been renamed to .workingToColorSpace()."),
    ...
    class X {
      static getDataURL(e, i = "image/png") {
        ...
        if (e instanceof HTMLCanvasElement) n = e;
          ...
          (e instanceof ImageData ? i.putImageData(e, 0, 0) : i.drawImage(e, 0, 0, e.width, e.height), (n = t));
        }
      ...
      static sRGBToLinear(e) {
        if (
          ...
          let n = i.getImageData(0, 0, e.width, e.height),
            r = n.data;
          for (let e = 0; e < r.length; e++) r[e] = 255 * H(r[e] / 255);
          return (i.putImageData(n, 0, 0), t);
        }
        if (!e.data)
          return (_("ImageUtils.sRGBToLinear(): Unsupported image type. No color space conversion applied."), e);
        {
          let t = e.data.slice(0);
          for (let e = 0; e < t.length; e++)
            t instanceof Uint8Array || t instanceof Uint8ClampedArray
              ? (t[e] = Math.floor(255 * H(t[e] / 255)))
              : (t[e] = H(t[e]));
    ...
    class q {
      ...
      toJSON(e) {
        ...
        if (null !== n) {
          ...
          if (Array.isArray(n)) {
            e = [];
            for (let t = 0, i = n.length; t < i; t++) n[t].isDataTexture ? e.push(Y(n[t].image)) : e.push(Y(n[t]));
          } else e = Y(n);
          i.url = e;
        }
    ...
    ((Z.DEFAULT_IMAGE = null), (Z.DEFAULT_MAPPING = 300), (Z.DEFAULT_ANISOTROPY = 1));
    class $ {
      constructor(e = 0, t = 0, i = 0, n = 1) {
        (($.prototype.isVector4 = !0), (this.x = e), (this.y = t), (this.z = i), (this.w = n));
      }
      get width() {
        return this.z;
      }
      ...
      setAxisAngleFromRotationMatrix(e) {
        let t,
          ...
          p = a[6],
          f = a[10];
        if (0.01 > Math.abs(o - h) && 0.01 > Math.abs(l - d) && 0.01 > Math.abs(u - p)) {
          if (0.1 > Math.abs(o + h) && 0.1 > Math.abs(l + d) && 0.1 > Math.abs(u + p) && 0.1 > Math.abs(s + c + f - 3))
    ...
    class Q extends M {
      constructor(e = 1, t = 1, i = {}) {
        (super(),
          ...
          (this.height = t),
          (this.depth = i.depth),
          (this.scissor = new $(0, 0, e, t)),
          (this.scissorTest = !1),
          (this.viewport = new $(0, 0, e, t)));
        const n = new Z({ width: e, height: t, depth: i.depth });
        this.textures = [];
        const r = i.count;
        for (let e = 0; e < r; e++)
      ...
      _setTextureOptions(e = {}) {
        let t = { minFilter: 1006, generateMipmaps: !1, flipY: !1, internalFormat: null };
      ...
      copy(e) {
        ...
        for (let t = 0, i = e.textures.length; t < i; t++) {
          ...
          this.textures[t].source = new q(i);
        }
        return (
    ...
    class en {
      constructor(e = new U(Infinity, Infinity, Infinity), t = new U(-1 / 0, -1 / 0, -1 / 0)) {
      ...
      setFromArray(e) {
        this.makeEmpty();
        for (let t = 0, i = e.length; t < i; t += 3) this.expandByPoint(ea.fromArray(e, t));
        return this;
      }
      setFromBufferAttribute(e) {
        this.makeEmpty();
        for (let t = 0, i = e.count; t < i; t++) this.expandByPoint(ea.fromBufferAttribute(e, t));
        return this;
      }
      setFromPoints(e) {
        this.makeEmpty();
      ...
      setFromCenterAndSize(e, t) {
        let i = ea.copy(t).multiplyScalar(0.5);
        ...
        if (void 0 !== i) {
          ...
          if (!0 === t && void 0 !== n && !0 !== e.isInstancedMesh)
            for (let t = 0, i = n.count; t < i; t++)
              (!0 === e.isMesh ? e.getVertexPosition(t, ea) : ea.fromBufferAttribute(n, t),
                ea.applyMatrix4(e.matrixWorld),
                this.expandByPoint(ea));
          else
            (void 0 !== e.boundingBox
              ? (null === e.boundingBox && e.computeBoundingBox(), es.copy(e.boundingBox))
              : (null === i.boundingBox && i.computeBoundingBox(), es.copy(i.boundingBox)),
      ...
      intersectsSphere(e) {
        return (this.clampPoint(e.center, ea), ea.distanceToSquared(e.center) <= e.radius * e.radius);
      }
      intersectsPlane(e) {
        let t, i;
        return (
      ...
      intersectsTriangle(e) {
        ...
        (this.getCenter(ep),
          ef.subVectors(this.max, ep),
          eo.subVectors(e.a, ep),
          el.subVectors(e.b, ep),
          eh.subVectors(e.c, ep),
          ec.subVectors(el, eo),
          eu.subVectors(eh, el),
          ed.subVectors(eo, eh));
        let t = [
        ...
        return (
          !!e_(t, eo, el, eh, ef) &&
          !!e_((t = [1, 0, 0, 0, 1, 0, 0, 0, 1]), eo, el, eh, ef) &&
          (em.crossVectors(ec, eu), e_((t = [em.x, em.y, em.z]), eo, el, eh, ef))
        );
      }
      clampPoint(e, t) {
      ...
      getBoundingSphere(e) {
        return (
          this.isEmpty() ? e.makeEmpty() : (this.getCenter(e.center), (e.radius = 0.5 * this.getSize(ea).length())),
          e
        );
      }
      intersect(e) {
    ...
    let er = [new U(), new U(), new U(), new U(), new U(), new U(), new U(), new U()],
      ea = new U(),
      es = new en(),
      eo = new U(),
      el = new U(),
    ...
    function e_(e, t, i, n, r) {
      for (let a = 0, s = e.length - 3; a <= s; a += 3) {
        eg.fromArray(e, a);
        let s = r.x * Math.abs(eg.x) + r.y * Math.abs(eg.y) + r.z * Math.abs(eg.z),
          o = t.dot(eg),
          l = i.dot(eg),
          h = n.dot(eg);
    ...
    class eM {
      ...
      setFromPoints(e, t) {
        let i = this.center;
        void 0 !== t ? i.copy(t) : ev.setFromPoints(e).getCenter(i);
        let n = 0;
      ...
      expandByPoint(e) {
        ...
        if (t > this.radius * this.radius) {
          let e = Math.sqrt(t),
            i = (e - this.radius) * 0.5;
          (this.center.addScaledVector(ex, i / e), (this.radius += i));
        }
        return this;
      }
      union(e) {
          ...
          e.isEmpty() ||
            (this.isEmpty()
              ...
              : !0 === this.center.equals(e.center)
                ...
                : (ey.subVectors(e.center, this.center).setLength(e.radius),
                  this.expandByPoint(ex.copy(e.center).add(ey)),
                  this.expandByPoint(ex.copy(e.center).sub(ey)))),
          this
        );
      }
      equals(e) {
    ...
    class eC {
      ...
      recast(e) {
        return (this.origin.copy(this.at(e, eS)), this);
      }
      ...
      distanceSqToPoint(e) {
        let t = eS.subVectors(e, this.origin).dot(this.direction);
        return t < 0
          ? this.origin.distanceToSquared(e)
          : (eS.copy(this.origin).addScaledVector(this.direction, t), eS.distanceToSquared(e));
      }
      distanceSqToSegment(e, t, i, n) {
        let r, a, s, o;
        (eT.copy(e).add(t).multiplyScalar(0.5), eb.copy(t).sub(e).normalize(), eE.copy(this.origin).sub(eT));
        let l = 0.5 * e.distanceTo(t),
          h = -this.direction.dot(eb),
          c = eE.dot(this.direction),
          u = -eE.dot(eb),
          d = eE.lengthSq(),
          p = Math.abs(1 - h * h);
        if (p > 0)
          if (((r = h * u - c), (a = h * c - u), (o = l * p), r >= 0))
            ...
            a <= -o
              ? ((a = (r = Math.max(0, -(-h * l + c))) > 0 ? -l : Math.min(Math.max(-l, -u), l)),
                (s = -r * r + a * (a + 2 * u) + d))
              : a <= o
                ? ((r = 0), (s = (a = Math.min(Math.max(-l, -u), l)) * (a + 2 * u) + d))
                : ((a = (r = Math.max(0, -(h * l + c))) > 0 ? l : Math.min(Math.max(-l, -u), l)),
                  (s = -r * r + a * (a + 2 * u) + d));
        else ((a = h > 0 ? -l : l), (s = -(r = Math.max(0, -(h * a + c))) * r + a * (a + 2 * u) + d));
        return (i && i.copy(this.origin).addScaledVector(this.direction, r), n && n.copy(eT).addScaledVector(eb, a), s);
      }
      intersectSphere(e, t) {
        eS.subVectors(e.center, this.origin);
        let i = eS.dot(this.direction),
          n = eS.dot(eS) - i * i,
          r = e.radius * e.radius;
        if (n > r) return null;
        let a = Math.sqrt(r - n),
      ...
      intersectBox(e, t) {
        ...
        i > a ||
          ...
          i > o || s > n || ((s > i || i != i) && (i = s), (o < n || n != n) && (n = o), n < 0)))
          ? null
          : this.at(i >= 0 ? i : n, t);
      }
      intersectsBox(e) {
        return null !== this.intersectBox(e, eS);
      }
      intersectTriangle(e, t, i, n, r) {
        let a;
        (eA.subVectors(t, e), ew.subVectors(i, e), eR.crossVectors(eA, ew));
        let s = this.direction.dot(eR);
        if (s > 0) {
          if (n) return null;
          a = 1;
        } else {
        ...
        let o = a * this.direction.dot(ew.crossVectors(eE, ew));
        if (o < 0) return null;
        let l = a * this.direction.dot(eA.cross(eE));
    ...
    class eP {
      ...
      clone() {
        return new eP().fromArray(this.elements);
      }
      copy(e) {
        let t = this.elements,
          i = e.elements;
      ...
      extractBasis(e, t, i) {
        return (
          0 === this.determinant()
            ...
            : (e.setFromMatrixColumn(this, 0), t.setFromMatrixColumn(this, 1), i.setFromMatrixColumn(this, 2)),
          this
        );
      }
      makeBasis(e, t, i) {
      ...
      makeRotationFromQuaternion(e) {
        return this.compose(eN, e, eD);
      }
      lookAt(e, t, i) {
        let n = this.elements;
        return (
          eF.subVectors(e, t),
          0 === eF.lengthSq() && (eF.z = 1),
          eF.normalize(),
          eU.crossVectors(i, eF),
          0 === eU.lengthSq() &&
            (1 === Math.abs(i.z) ? (eF.x += 1e-4) : (eF.z += 1e-4), eF.normalize(), eU.crossVectors(i, eF)),
          eU.normalize(),
          eO.crossVectors(eF, eU),
          (n[0] = eU.x),
          (n[4] = eO.x),
          (n[8] = eF.x),
          (n[1] = eU.y),
      ...
      multiplyMatrices(e, t) {
        ...
        return (
          ...
          (r[4] = a * S + s * A + o * P + l * D),
          (r[8] = a * T + s * w + o * I + l * U),
          (r[12] = a * b + s * R + o * L + l * O),
          (r[1] = h * M + c * E + u * C + d * N),
          (r[5] = h * S + c * A + u * P + d * D),
          (r[9] = h * T + c * w + u * I + d * U),
          (r[13] = h * b + c * R + u * L + d * O),
          (r[2] = p * M + f * E + m * C + g * N),
          (r[6] = p * S + f * A + m * P + g * D),
          (r[10] = p * T + f * w + m * I + g * U),
          (r[14] = p * b + f * R + m * L + g * O),
          (r[3] = _ * M + v * E + x * C + y * N),
          (r[7] = _ * S + v * A + x * P + y * D),
          (r[11] = _ * T + v * w + x * I + y * U),
      ...
      setPosition(e, t, i) {
        let n = this.elements;
        return (
          e.isVector3 ? ((n[12] = e.x), (n[13] = e.y), (n[14] = e.z)) : ((n[12] = e), (n[13] = t), (n[14] = i)),
          this
        );
      }
      invert() {
        ...
        return (
          (e[0] = _ * S),
          (e[1] = (f * u * r - c * m * r - f * n * d + i * m * d + c * n * g - i * u * g) * S),
          (e[2] = (s * m * r - f * o * r + f * n * l - i * m * l - s * n * g + i * o * g) * S),
          (e[3] = (c * o * r - s * u * r - c * n * l + i * u * l + s * n * d - i * o * d) * S),
          (e[4] = v * S),
          (e[5] = (h * m * r - p * u * r + p * n * d - t * m * d - h * n * g + t * u * g) * S),
          (e[6] = (p * o * r - a * m * r - p * n * l + t * m * l + a * n * g - t * o * g) * S),
          (e[7] = (a * u * r - h * o * r + h * n * l - t * u * l - a * n * d + t * o * d) * S),
          (e[8] = x * S),
          (e[9] = (p * c * r - h * f * r - p * i * d + t * f * d + h * i * g - t * c * g) * S),
          (e[10] = (a * f * r - p * s * r + p * i * l - t * f * l - a * i * g + t * s * g) * S),
          (e[11] = (h * s * r - a * c * r - h * i * l + t * c * l + a * i * d - t * s * d) * S),
          (e[12] = y * S),
          (e[13] = (h * f * n - p * c * n + p * i * u - t * f * u - h * i * m + t * c * m) * S),
          (e[14] = (p * s * n - a * f * n - p * i * o + t * f * o + a * i * m - t * s * m) * S),
          (e[15] = (a * c * n - h * s * n + h * i * o - t * c * o - a * i * u + t * s * u) * S),
          this
        );
      }
      scale(e) {
      ...
      decompose(e, t, i) {
        let n = this.elements;
        if (((e.x = n[12]), (e.y = n[13]), (e.z = n[14]), 0 === this.determinant()))
          return (i.set(1, 1, 1), t.identity(), this);
        let r = eI.set(n[0], n[1], n[2]).length(),
          a = eI.set(n[4], n[5], n[6]).length(),
          s = eI.set(n[8], n[9], n[10]).length();
        (0 > this.determinant() && (r = -r), eL.copy(this));
        let o = 1 / r,
          l = 1 / a,
          h = 1 / s;
        return (
    ...
    let eI = new U(),
      ...
      ez = new D();
    class eV {
      constructor(e = 0, t = 0, i = 0, n = eV.DEFAULT_ORDER) {
      ...
      setFromQuaternion(e, t, i) {
        return (eB.makeRotationFromQuaternion(e), this.setFromRotationMatrix(eB, t, i));
      }
      setFromVector3(e, t = this._order) {
        return this.set(e.x, e.y, e.z, t);
      }
      reorder(e) {
        return (ez.setFromEuler(this), this.setFromQuaternion(ez, e));
      }
      equals(e) {
    ...
    let eG = 0,
      ...
      eQ = { type: "added" },
      e0 = { type: "removed" },
      e1 = { type: "childadded", child: null },
      e3 = { type: "childremoved", child: null };
    class e2 extends M {
      constructor() {
        (super(),
          (this.isObject3D = !0),
        ...
        (t._onChange(function () {
          ...
          Object.defineProperties(this, {
            ...
            modelViewMatrix: { value: new eP() },
            normalMatrix: { value: new B() },
          }),
          (this.matrix = new eP()),
          (this.matrixWorld = new eP()),
          (this.matrixAutoUpdate = e2.DEFAULT_MATRIX_AUTO_UPDATE),
          (this.matrixWorldAutoUpdate = e2.DEFAULT_MATRIX_WORLD_AUTO_UPDATE),
      ...
      rotateOnAxis(e, t) {
        return (eW.setFromAxisAngle(e, t), this.quaternion.multiply(eW), this);
      }
      rotateOnWorldAxis(e, t) {
        return (eW.setFromAxisAngle(e, t), this.quaternion.premultiply(eW), this);
      }
      rotateX(e) {
      ...
      worldToLocal(e) {
        return (this.updateWorldMatrix(!0, !1), e.applyMatrix4(eX.copy(this.matrixWorld).invert()));
      }
      lookAt(e, t, i) {
        e.isVector3 ? ej.copy(e) : ej.set(e, t, i);
        let n = this.parent;
        (this.updateWorldMatrix(!0, !1),
          eq.setFromMatrixPosition(this.matrixWorld),
          this.isCamera || this.isLight ? eX.lookAt(eq, ej, this.up) : eX.lookAt(ej, eq, this.up),
          this.quaternion.setFromRotationMatrix(eX),
          n &&
            (eX.extractRotation(n.matrixWorld),
            eW.setFromRotationMatrix(eX),
            this.quaternion.premultiply(eW.invert())));
      }
      add(e) {
      ...
      attach(e) {
        return (
          this.updateWorldMatrix(!0, !1),
          eX.copy(this.matrixWorld).invert(),
          null !== e.parent && (e.parent.updateWorldMatrix(!0, !1), eX.multiply(e.parent.matrixWorld)),
          e.applyMatrix4(eX),
          e.removeFromParent(),
          (e.parent = this),
          this.children.push(e),
      ...
      getWorldQuaternion(e) {
        return (this.updateWorldMatrix(!0, !1), this.matrixWorld.decompose(eq, e, eY), e);
      }
      getWorldScale(e) {
        return (this.updateWorldMatrix(!0, !1), this.matrixWorld.decompose(eq, eK, e), e);
      }
      getWorldDirection(e) {
        this.updateWorldMatrix(!0, !1);
      ...
      toJSON(e) {
        ...
        if (
          ...
          this.isBatchedMesh &&
            ...
            null !== this.boundingSphere && (n.boundingSphere = this.boundingSphere.toJSON()),
            null !== this.boundingBox && (n.boundingBox = this.boundingBox.toJSON())),
          this.isScene)
        )
          (this.background &&
    ...
    ((e2.DEFAULT_UP = new U(0, 1, 0)),
      (e2.DEFAULT_MATRIX_AUTO_UPDATE = !0),
      (e2.DEFAULT_MATRIX_WORLD_AUTO_UPDATE = !0));
    let e4 = new U(),
      e5 = new U(),
      e6 = new U(),
      e8 = new U(),
    ...
    class to {
      ...
      static getNormal(e, t, i, n) {
        (n.subVectors(i, t), e4.subVectors(e, t), n.cross(e4));
        let r = n.lengthSq();
        return r > 0 ? n.multiplyScalar(1 / Math.sqrt(r)) : n.set(0, 0, 0);
      }
      static getBarycoord(e, t, i, n, r) {
        (e4.subVectors(n, t), e5.subVectors(i, t), e6.subVectors(e, t));
        let a = e4.dot(e4),
          s = e4.dot(e5),
          o = e4.dot(e6),
          l = e5.dot(e5),
      ...
      static containsPoint(e, t, i, n) {
        return null !== this.getBarycoord(e, t, i, n, e8) && e8.x >= 0 && e8.y >= 0 && e8.x + e8.y <= 1;
      }
      static getInterpolation(e, t, i, n, r, a, s, o) {
        return null === this.getBarycoord(e, t, i, n, e8)
          ? ((o.x = 0), (o.y = 0), "z" in o && (o.z = 0), "w" in o && (o.w = 0), null)
          : (o.setScalar(0), o.addScaledVector(r, e8.x), o.addScaledVector(a, e8.y), o.addScaledVector(s, e8.z), o);
      }
      static getInterpolatedAttribute(e, t, i, n, r, a) {
        return (
          ...
          ta.fromBufferAttribute(e, i),
          ts.fromBufferAttribute(e, n),
          a.setScalar(0),
          a.addScaledVector(tr, r.x),
          a.addScaledVector(ta, r.y),
          a.addScaledVector(ts, r.z),
          a
        );
      }
      static isFrontFacing(e, t, i, n) {
        return (e4.subVectors(i, t), e5.subVectors(e, t), 0 > e4.cross(e5).dot(n));
      }
      set(e, t, i) {
      ...
      getArea() {
        return (e4.subVectors(this.c, this.b), e5.subVectors(this.a, this.b), 0.5 * e4.cross(e5).length());
      }
      getMidpoint(e) {
        return e
      ...
      getInterpolation(e, t, i, n, r) {
        return to.getInterpolation(e, this.a, this.b, this.c, t, i, n, r);
      }
      containsPoint(e) {
      ...
      closestPointToPoint(e, t) {
        let i,
          ...
          a = this.b,
          s = this.c;
        (e9.subVectors(a, r), e7.subVectors(s, r), tt.subVectors(e, r));
        let o = e9.dot(tt),
          l = e7.dot(tt);
        ...
        let u = o * c - h * l;
        if (u <= 0 && o >= 0 && h <= 0) return ((i = o / (o - h)), t.copy(r).addScaledVector(e9, i));
        tn.subVectors(e, s);
        let d = e9.dot(tn),
          p = e7.dot(tn);
        if (p >= 0 && d <= p) return t.copy(s);
        let f = d * l - o * p;
        if (f <= 0 && l >= 0 && p <= 0) return ((n = l / (l - p)), t.copy(r).addScaledVector(e7, n));
        let m = h * p - d * c;
        if (m <= 0 && c - h >= 0 && d - p >= 0)
          return (te.subVectors(s, a), (n = (c - h) / (c - h + (d - p))), t.copy(a).addScaledVector(te, n));
        let g = 1 / (m + f + u);
        return ((i = f * g), (n = u * g), t.copy(r).addScaledVector(e9, i).addScaledVector(e7, n));
      }
      equals(e) {
    ...
    class td {
      ...
      setHex(e, t = o) {
        return (
          ...
          (this.g = ((e >> 8) & 255) / 255),
          (this.b = (255 & e) / 255),
          G.colorSpaceToWorking(this, t),
          this
        );
      }
      setRGB(e, t, i, n = G.workingColorSpace) {
        return ((this.r = e), (this.g = t), (this.b = i), G.colorSpaceToWorking(this, n), this);
      }
      setHSL(e, t, i, n = G.workingColorSpace) {
        if (((e = R(e, 1)), (t = w(t, 0, 1)), (i = w(i, 0, 1)), 0 === t)) this.r = this.g = this.b = i;
        else {
          let n = i <= 0.5 ? i * (1 + t) : i + t - i * t,
            r = 2 * i - n;
          ((this.r = tu(r, n, e + 1 / 3)), (this.g = tu(r, n, e)), (this.b = tu(r, n, e - 1 / 3)));
        }
        return (G.colorSpaceToWorking(this, n), this);
      }
      setStyle(e, t = o) {
        let i;
        function n(t) {
      ...
      setColorName(e, t = o) {
        let i = tl[e.toLowerCase()];
        return (void 0 !== i ? this.setHex(i, t) : _("Color: Unknown color " + e), this);
      }
      clone() {
      ...
      copyLinearToSRGB(e) {
        return ((this.r = W(e.r)), (this.g = W(e.g)), (this.b = W(e.b)), this);
      }
      convertSRGBToLinear() {
      ...
      getHex(e = o) {
        return (
          G.workingToColorSpace(tp.copy(this), e),
          65536 * Math.round(w(255 * tp.r, 0, 255)) +
            256 * Math.round(w(255 * tp.g, 0, 255)) +
            Math.round(w(255 * tp.b, 0, 255))
        );
      }
      getHexString(e = o) {
      ...
      getHSL(e, t = G.workingColorSpace) {
        let i, n;
        G.workingToColorSpace(tp.copy(this), t);
        let r = tp.r,
          a = tp.g,
          s = tp.b,
          o = Math.max(r, a, s),
      ...
      getRGB(e, t = G.workingColorSpace) {
        return (G.workingToColorSpace(tp.copy(this), t), (e.r = tp.r), (e.g = tp.g), (e.b = tp.b), e);
      }
      getStyle(e = o) {
        G.workingToColorSpace(tp.copy(this), e);
        let t = tp.r,
      ...
      offsetHSL(e, t, i) {
        return (this.getHSL(th), this.setHSL(th.h + e, th.s + t, th.l + i));
      }
      add(e) {
        return ((this.r += e.r), (this.g += e.g), (this.b += e.b), this);
      }
    ...
    class ty {
      constructor(e, t, i = !1) {
        ...
        ((this.isBufferAttribute = !0),
          Object.defineProperty(this, "id", { value: tx++ }),
          (this.name = ""),
          (this.array = e),
          (this.itemSize = t),
      ...
      applyMatrix3(e) {
        if (2 === this.itemSize)
          for (let t = 0, i = this.count; t < i; t++)
            (tv.fromBufferAttribute(this, t), tv.applyMatrix3(e), this.setXY(t, tv.x, tv.y));
        else if (3 === this.itemSize)
          for (let t = 0, i = this.count; t < i; t++)
            (t_.fromBufferAttribute(this, t), t_.applyMatrix3(e), this.setXYZ(t, t_.x, t_.y, t_.z));
        return this;
      }
      applyMatrix4(e) {
        for (let t = 0, i = this.count; t < i; t++)
          (t_.fromBufferAttribute(this, t), t_.applyMatrix4(e), this.setXYZ(t, t_.x, t_.y, t_.z));
        return this;
      }
      applyNormalMatrix(e) {
        for (let t = 0, i = this.count; t < i; t++)
          (t_.fromBufferAttribute(this, t), t_.applyNormalMatrix(e), this.setXYZ(t, t_.x, t_.y, t_.z));
        return this;
      }
      transformDirection(e) {
        for (let t = 0, i = this.count; t < i; t++)
          (t_.fromBufferAttribute(this, t), t_.transformDirection(e), this.setXYZ(t, t_.x, t_.y, t_.z));
        return this;
      }
      set(e, t = 0) {
      ...
      getComponent(e, t) {
        ...
        return (this.normalized && (i = P(i, this.array)), i);
      }
      setComponent(e, t, i) {
        return (this.normalized && (i = I(i, this.array)), (this.array[e * this.itemSize + t] = i), this);
      }
      getX(e) {
        let t = this.array[e * this.itemSize];
        return (this.normalized && (t = P(t, this.array)), t);
      }
      setX(e, t) {
        return (this.normalized && (t = I(t, this.array)), (this.array[e * this.itemSize] = t), this);
      }
      getY(e) {
      ...
      setY(e, t) {
        return (this.normalized && (t = I(t, this.array)), (this.array[e * this.itemSize + 1] = t), this);
      }
      getZ(e) {
      ...
      setZ(e, t) {
        return (this.normalized && (t = I(t, this.array)), (this.array[e * this.itemSize + 2] = t), this);
      }
      getW(e) {
      ...
      setW(e, t) {
        return (this.normalized && (t = I(t, this.array)), (this.array[e * this.itemSize + 3] = t), this);
      }
      setXY(e, t, i) {
        return (
          (e *= this.itemSize),
          this.normalized && ((t = I(t, this.array)), (i = I(i, this.array))),
          (this.array[e + 0] = t),
          (this.array[e + 1] = i),
          this
        );
      ...
      setXYZ(e, t, i, n) {
        return (
          (e *= this.itemSize),
          this.normalized && ((t = I(t, this.array)), (i = I(i, this.array)), (n = I(n, this.array))),
          (this.array[e + 0] = t),
          (this.array[e + 1] = i),
          (this.array[e + 2] = n),
          this
      ...
      setXYZW(e, t, i, n, r) {
        return (
          (e *= this.itemSize),
          this.normalized &&
            ((t = I(t, this.array)), (i = I(i, this.array)), (n = I(n, this.array)), (r = I(r, this.array))),
          (this.array[e + 0] = t),
          (this.array[e + 1] = i),
          (this.array[e + 2] = n),
          (this.array[e + 3] = r),
    ...
    class tI extends M {
      ...
      setIndex(e) {
        return (Array.isArray(e) ? (this.index = new (d(e) ? tS : tM)(e, 1)) : (this.index = e), this);
      }
      setIndirect(e, t = 0) {
      ...
      center() {
        return (
          ...
          this.boundingBox.getCenter(tw).negate(),
          this.translate(tw.x, tw.y, tw.z),
          this
        );
      }
      setFromPoints(e) {
        ...
        if (void 0 === t) {
          ...
          (e.length > t.count &&
            _("BufferGeometry: Buffer size too small for points data. Use .dispose() and create a new geometry."),
            (t.needsUpdate = !0));
        }
        return this;
      }
      computeBoundingBox() {
        ...
        if (e && e.isGLBufferAttribute) {
          (v("BufferGeometry.computeBoundingBox(): GLBufferAttribute requires a manual bounding box.", this),
            this.boundingBox.set(new U(-1 / 0, -1 / 0, -1 / 0), new U(Infinity, Infinity, Infinity)));
          return;
        }
        if (void 0 !== e) {
            ...
            for (let e = 0, i = t.length; e < i; e++) {
              ...
              (tR.setFromBufferAttribute(i),
                this.morphTargetsRelative
                  ? (tP.addVectors(this.boundingBox.min, tR.min),
                    this.boundingBox.expandByPoint(tP),
                    tP.addVectors(this.boundingBox.max, tR.max),
                    this.boundingBox.expandByPoint(tP))
                  : (this.boundingBox.expandByPoint(tR.min), this.boundingBox.expandByPoint(tR.max)));
            }
      ...
      computeBoundingSphere() {
        ...
        if (e) {
          ...
          if ((tR.setFromBufferAttribute(e), t))
            for (let e = 0, i = t.length; e < i; e++) {
              let i = t[e];
              (tC.setFromBufferAttribute(i),
                this.morphTargetsRelative
                  ? (tP.addVectors(tR.min, tC.min),
                    tR.expandByPoint(tP),
                    tP.addVectors(tR.max, tC.max),
                    tR.expandByPoint(tP))
                  : (tR.expandByPoint(tC.min), tR.expandByPoint(tC.max)));
            }
          tR.getCenter(i);
          let n = 0;
          for (let t = 0, r = e.count; t < r; t++)
            (tP.fromBufferAttribute(e, t), (n = Math.max(n, i.distanceToSquared(tP))));
          if (t)
            for (let r = 0, a = t.length; r < a; r++) {
              let a = t[r],
                s = this.morphTargetsRelative;
              for (let t = 0, r = a.count; t < r; t++)
                (tP.fromBufferAttribute(a, t),
                  s && (tw.fromBufferAttribute(e, t), tP.add(tw)),
                  (n = Math.max(n, i.distanceToSquared(tP))));
            }
      ...
      computeTangents() {
        ...
        let i = t.position,
          n = t.normal,
          r = t.uv;
        !1 === this.hasAttribute("tangent") && this.setAttribute("tangent", new ty(new Float32Array(4 * i.count), 4));
        let a = this.getAttribute("tangent"),
          s = [],
          o = [];
        for (let e = 0; e < i.count; e++) ((s[e] = new U()), (o[e] = new U()));
        let l = new U(),
          h = new U(),
          c = new U(),
          u = new N(),
        ...
        for (let t = 0, n = g.length; t < n; ++t) {
          ...
          for (let t = a, n = a + _; t < n; t += 3)
            !(function (e, t, n) {
              ...
              isFinite(a) &&
                (f.copy(h).multiplyScalar(p.y).addScaledVector(c, -d.y).multiplyScalar(a),
                m.copy(c).multiplyScalar(d.x).addScaledVector(h, -p.x).multiplyScalar(a),
                s[e].add(f),
                s[t].add(f),
                s[n].add(f),
                o[e].add(m),
        ...
        let _ = new U(),
          ...
          M = new U();
        function S(e) {
          (y.fromBufferAttribute(n, e), M.copy(y));
          let t = s[e];
          (_.copy(t), _.sub(y.multiplyScalar(y.dot(t))).normalize(), x.crossVectors(M, t));
          let i = x.dot(o[e]);
        ...
        for (let t = 0, i = g.length; t < i; ++t) {
          let i = g[t],
            n = i.start,
            r = i.count;
          for (let t = n, i = n + r; t < i; t += 3) (S(e.getX(t + 0)), S(e.getX(t + 1)), S(e.getX(t + 2)));
        }
      }
      computeVertexNormals() {
        ...
        if (void 0 !== t) {
          ...
          if (void 0 === i) ((i = new ty(new Float32Array(3 * t.count), 3)), this.setAttribute("normal", i));
      ...
      normalizeNormals() {
        ...
        for (let t = 0, i = e.count; t < i; t++)
          (tP.fromBufferAttribute(e, t), tP.normalize(), e.setXYZ(t, tP.x, tP.y, tP.z));
      }
      toNonIndexed() {
        function e(e, t) {
          let i = e.array,
        ...
        if (null === this.index)
          return (_("BufferGeometry.toNonIndexed(): BufferGeometry is already non-indexed."), this);
        let t = new tI(),
          i = this.index.array,
          n = this.attributes;
        for (let r in n) {
    ...
    class tH extends e2 {
      ...
      getVertexPosition(e, t) {
        ...
        if (r && s) {
          ...
          for (let i = 0, n = r.length; i < n; i++) {
            let n = s[i],
              o = r[i];
            0 !== n && (tz.fromBufferAttribute(o, e), a ? tV.addScaledVector(tz, n) : tV.addScaledVector(tz.sub(t), n));
          }
          t.add(tV);
        }
        return t;
      ...
      raycast(e, t) {
        ...
        void 0 === n ||
          ...
          tD.applyMatrix4(r),
          tN.copy(e.ray).recast(e.near),
          (!1 === tD.containsPoint(tN.origin) &&
            (null === tN.intersectSphere(tD, tU) || tN.origin.distanceToSquared(tU) > (e.far - e.near) ** 2)) ||
            (tL.copy(r).invert(),
            tN.copy(e.ray).applyMatrix4(tL),
            (null === i.boundingBox || !1 !== tN.intersectsBox(i.boundingBox)) &&
              this._computeIntersections(e, t, tN)));
      }
        ...
        if (null !== s)
          if (Array.isArray(a))
            for (let r = 0, o = u.length; r < o; r++) {
              ...
              for (let r = f; r < m; r += 3)
                (n = tW(this, p, e, i, l, h, c, s.getX(r), s.getX(r + 1), s.getX(r + 2))) &&
                  ((n.faceIndex = Math.floor(r / 3)), (n.face.materialIndex = o.materialIndex), t.push(n));
            }
          else {
            let r = Math.max(0, d.start),
              o = Math.min(s.count, d.start + d.count);
            for (let u = r; u < o; u += 3)
              (n = tW(this, a, e, i, l, h, c, s.getX(u), s.getX(u + 1), s.getX(u + 2))) &&
          ...
          if (Array.isArray(a))
            for (let r = 0, s = u.length; r < s; r++) {
              ...
              for (let r = f; r < m; r += 3)
                (n = tW(this, p, e, i, l, h, c, r, r + 1, r + 2)) &&
                  ((n.faceIndex = Math.floor(r / 3)), (n.face.materialIndex = s.materialIndex), t.push(n));
            }
          else {
            let r = Math.max(0, d.start),
              s = Math.min(o.count, d.start + d.count);
            for (let o = r; o < s; o += 3)
              (n = tW(this, a, e, i, l, h, c, o, o + 1, o + 2)) && ((n.faceIndex = Math.floor(o / 3)), t.push(n));
          }
      }
    }
    function tW(e, t, i, n, r, a, s, o, l, h) {
      (e.getVertexPosition(o, tO), e.getVertexPosition(l, tF), e.getVertexPosition(h, tB));
      let c = (function (e, t, i, n, r, a, s, o) {
        if (
          null === (1 === t.side ? n.intersectTriangle(s, a, r, !0, o) : n.intersectTriangle(r, a, s, 0 === t.side, o))
        )
          return null;
        (tG.copy(o), tG.applyMatrix4(e.matrixWorld));
        let l = i.ray.origin.distanceTo(tG);
        return l < i.near || l > i.far ? null : { distance: l, point: tG.clone(), object: e };
      })(e, t, i, n, tO, tF, tB, tk);
      if (c) {
        let e = new U();
        (to.getBarycoord(tk, tO, tF, tB, e),
          r && (c.uv = to.getInterpolatedAttribute(r, o, l, h, e, new N())),
          a && (c.uv1 = to.getInterpolatedAttribute(a, o, l, h, e, new N())),
          s &&
            ((c.normal = to.getInterpolatedAttribute(s, o, l, h, e, new U())),
            c.normal.dot(n.direction) > 0 && c.normal.multiplyScalar(-1)));
        let t = { a: o, b: l, c: h, normal: new U(), materialIndex: 0 };
        (to.getNormal(tO, tF, tB, t.normal), (c.face = t), (c.barycoord = e));
      }
      return c;
    }
    class tX extends tI {
      constructor(e = 1, t = 1, i = 1, n = 1, r = 1, a = 1) {
        (super(),
          ...
          (this.parameters = { width: e, height: t, depth: i, widthSegments: n, heightSegments: r, depthSegments: a }));
        const s = this;
      ...
      static fromJSON(e) {
        return new tX(e.width, e.height, e.depth, e.widthSegments, e.heightSegments, e.depthSegments);
      }
    }
    function tj(e) {
      let t = {};
    ...
    function tY(e) {
      ...
      return null === t ? e.outputColorSpace : !0 === t.isXRRenderTarget ? t.texture.colorSpace : G.workingColorSpace;
    }
    let tK = { clone: tj, merge: tq };
    class tJ extends tm {
      constructor(e) {
        (super(),
    ...
    class tZ extends e2 {
      constructor() {
        (super(),
          (this.isCamera = !0),
          (this.type = "Camera"),
          (this.matrixWorldInverse = new eP()),
          (this.projectionMatrix = new eP()),
          (this.projectionMatrixInverse = new eP()),
    ...
    class t1 extends tZ {
      ...
      setFocalLength(e) {
        ...
        ((this.fov = 2 * E * Math.atan(t)), this.updateProjectionMatrix());
      }
      getFocalLength() {
        let e = Math.tan(0.5 * b * this.fov);
        return (0.5 * this.getFilmHeight()) / e;
      }
      getEffectiveFOV() {
        return 2 * E * Math.atan(Math.tan(0.5 * b * this.fov) / this.zoom);
      }
      getFilmWidth() {
      ...
      getViewBounds(e, t, i) {
        (t$.set(-1, -1, 0.5).applyMatrix4(this.projectionMatrixInverse),
          t.set(t$.x, t$.y).multiplyScalar(-e / t$.z),
          t$.set(1, 1, 0.5).applyMatrix4(this.projectionMatrixInverse),
          i.set(t$.x, t$.y).multiplyScalar(-e / t$.z));
      }
      getViewSize(e, t) {
        return (this.getViewBounds(e, tQ, t0), t.subVectors(t0, tQ));
      }
      ...
      updateProjectionMatrix() {
        let e = this.near,
          t = (e * Math.tan(0.5 * b * this.fov)) / this.zoom,
          i = 2 * t,
          n = this.aspect * i,
          r = -0.5 * n,
          a = this.view;
    ...
    class t3 extends e2 {
      constructor(e, t, i) {
        ...
        const n = new t1(-90, 1, e, t);
        ((n.layers = this.layers), this.add(n));
        const r = new t1(-90, 1, e, t);
        ((r.layers = this.layers), this.add(r));
        const a = new t1(-90, 1, e, t);
        ((a.layers = this.layers), this.add(a));
        const s = new t1(-90, 1, e, t);
        ((s.layers = this.layers), this.add(s));
        const o = new t1(-90, 1, e, t);
        ((o.layers = this.layers), this.add(o));
        const l = new t1(-90, 1, e, t);
    ...
    class t4 extends ee {
      constructor(e = 1, t = {}) {
        ...
        ((this.texture = new t2([i, i, i, i, i, i])),
    ...
    class t9 {
      ...
      clone(e) {
        (void 0 === e.arrayBuffers && (e.arrayBuffers = {}),
          void 0 === this.array.buffer._uuid && (this.array.buffer._uuid = A()),
    ...
    class ie {
      ...
      applyMatrix4(e) {
        for (let t = 0, i = this.data.count; t < i; t++)
          (t7.fromBufferAttribute(this, t), t7.applyMatrix4(e), this.setXYZ(t, t7.x, t7.y, t7.z));
        return this;
      }
      applyNormalMatrix(e) {
        for (let t = 0, i = this.count; t < i; t++)
          (t7.fromBufferAttribute(this, t), t7.applyNormalMatrix(e), this.setXYZ(t, t7.x, t7.y, t7.z));
        return this;
      }
      transformDirection(e) {
        for (let t = 0, i = this.count; t < i; t++)
          (t7.fromBufferAttribute(this, t), t7.transformDirection(e), this.setXYZ(t, t7.x, t7.y, t7.z));
        return this;
      }
      getComponent(e, t) {
      ...
      setX(e, t) {
        return (
          this.normalized && (t = I(t, this.array)),
      ...
      clone(e) {
        if (void 0 !== e)
          return (
            ...
            new ie(e.interleavedBuffers[this.data.uuid], this.itemSize, this.offset, this.normalized)
          );
        {
          g(
          ...
          return new ty(new this.array.constructor(e), this.itemSize, this.normalized);
        }
      }
      toJSON(e) {
        if (void 0 !== e)
    ...
    class iu extends tH {
      constructor(e, t) {
        (super(e, t),
          ...
          (this.bindMode = s),
          (this.bindMatrix = new eP()),
          (this.bindMatrixInverse = new eP()),
          (this.boundingBox = null),
          (this.boundingSphere = null));
      }
      computeBoundingBox() {
        ...
        for (let e = 0; e < t.count; e++) (this.getVertexPosition(e, io), this.boundingBox.expandByPoint(io));
      }
      computeBoundingSphere() {
        let e = this.geometry;
        (null === this.boundingSphere && (this.boundingSphere = new eM()), this.boundingSphere.makeEmpty());
        let t = e.getAttribute("position");
        for (let e = 0; e < t.count; e++) (this.getVertexPosition(e, io), this.boundingSphere.expandByPoint(io));
      }
      copy(e, t) {
        return (
          super.copy(e, t),
      ...
      raycast(e, t) {
        ...
        void 0 === i ||
          ...
          il.applyMatrix4(n),
          !1 === e.ray.intersectsSphere(il) ||
            (ih.copy(n).invert(),
            ic.copy(e.ray).applyMatrix4(ih),
            (null === this.boundingBox || !1 !== ic.intersectsBox(this.boundingBox)) &&
              this._computeIntersections(e, t, ic)));
      }
      getVertexPosition(e, t) {
      ...
      applyBoneTransform(e, t) {
        let i = this.skeleton,
          n = this.geometry;
        (ii.fromBufferAttribute(n.attributes.skinIndex, e),
          ir.fromBufferAttribute(n.attributes.skinWeight, e),
          it.copy(t).applyMatrix4(this.bindMatrix),
          t.set(0, 0, 0));
        for (let e = 0; e < 4; e++) {
          let n = ir.getComponent(e);
          if (0 !== n) {
            let r = ii.getComponent(e);
            (is.multiplyMatrices(i.bones[r].matrixWorld, i.boneInverses[r]),
              t.addScaledVector(ia.copy(it).applyMatrix4(is), n));
          }
        }
    ...
    class i_ {
      ...
      init() {
        ...
        if (((this.boneMatrices = new Float32Array(16 * e.length)), 0 === t.length)) this.calculateInverses();
          ...
          for (let e = 0, t = this.bones.length; e < t; e++) this.boneInverses.push(new eP());
        }
      }
      calculateInverses() {
      ...
      update() {
        ...
        for (let n = 0, r = e.length; n < r; n++) {
          let r = e[n] ? e[n].matrixWorld : ig;
          (im.multiplyMatrices(r, t[n]), im.toArray(i, 16 * n));
        }
        null !== n && (n.needsUpdate = !0);
      }
      clone() {
        return new i_(this.bones, this.boneInverses);
      }
      computeBoneTexture() {
        let e = Math.sqrt(4 * this.bones.length),
          t = new Float32Array((e = Math.max((e = 4 * Math.ceil(e / 4)), 4)) * e * 4);
        t.set(this.boneMatrices);
        let i = new ip(t, e, e, 1023, 1015);
      ...
      fromJSON(e, t) {
        ...
        for (let i = 0, n = e.bones.length; i < n; i++) {
          let n = e.bones[i],
            r = t[n];
          (void 0 === r && (_("Skeleton: No bone found with UUID:", n), (r = new id())),
            this.bones.push(r),
            this.boneInverses.push(new eP().fromArray(e.boneInverses[i])));
        }
    ...
    class iA extends tH {
      constructor(e, t, i) {
        (super(e, t),
          ...
          (this.instanceMatrix = new iv(new Float32Array(16 * i), 16)),
          (this.instanceColor = null),
          (this.morphTexture = null),
          (this.count = i),
          (this.boundingBox = null),
          (this.boundingSphere = null));
        for (let e = 0; e < i; e++) this.setMatrixAt(e, iT);
      }
      computeBoundingBox() {
        let e = this.geometry,
          t = this.count;
        ...
        for (let i = 0; i < t; i++)
          (this.getMatrixAt(i, ix), iS.copy(e.boundingBox).applyMatrix4(ix), this.boundingBox.union(iS));
      }
      computeBoundingSphere() {
        let e = this.geometry,
          t = this.count;
        ...
        for (let i = 0; i < t; i++)
          (this.getMatrixAt(i, ix), iE.copy(e.boundingSphere).applyMatrix4(ix), this.boundingSphere.union(iE));
      }
      copy(e, t) {
        return (
          super.copy(e, t),
      ...
      raycast(e, t) {
        let i = this.matrixWorld,
          n = this.count;
        if (
          ((ib.geometry = this.geometry), (ib.material = this.material), void 0 !== ib.material) &&
          (null === this.boundingSphere && this.computeBoundingSphere(),
          iE.copy(this.boundingSphere),
          iE.applyMatrix4(i),
          !1 !== e.ray.intersectsSphere(iE))
        )
          for (let r = 0; r < n; r++) {
            (this.getMatrixAt(r, ix), iy.multiplyMatrices(i, ix), (ib.matrixWorld = iy), ib.raycast(e, iM));
            for (let e = 0, i = iM.length; e < i; e++) {
              let i = iM[e];
      ...
      setColorAt(e, t) {
        (null === this.instanceColor &&
          (this.instanceColor = new iv(new Float32Array(3 * this.instanceMatrix.count).fill(1), 3)),
      ...
      setMorphAt(e, t) {
        ...
        null === this.morphTexture &&
          (this.morphTexture = new ip(new Float32Array(n * this.count), n, this.count, 1028, 1015));
    ...
    class iP {
      ...
      setFromCoplanarPoints(e, t, i) {
        let n = iw.subVectors(i, t).cross(iR.subVectors(e, t)).normalize();
      ...
      applyMatrix4(e, t) {
        let i = t || iC.getNormalMatrix(e),
          n = this.coplanarPoint(iw).applyMatrix4(e),
    ...
    let iI = new eM(),
      ...
      iN = new U();
    class iD {
      constructor(e = new iP(), t = new iP(), i = new iP(), n = new iP(), r = new iP(), a = new iP()) {
      ...
      setFromProjectionMatrix(e, t = 2e3, i = !1) {
        let n = this.planes,
          ...
          y = r[15];
        if (
          (n[0].setComponents(l - a, d - h, g - p, y - _).normalize(),
          n[1].setComponents(l + a, d + h, g + p, y + _).normalize(),
          n[2].setComponents(l + s, d + c, g + f, y + v).normalize(),
          n[3].setComponents(l - s, d - c, g - f, y - v).normalize(),
          i)
        )
          (n[4].setComponents(o, u, m, x).normalize(), n[5].setComponents(l - o, d - u, g - m, y - x).normalize());
        else if ((n[4].setComponents(l - o, d - u, g - m, y - x).normalize(), 2e3 === t))
          n[5].setComponents(l + o, d + u, g + m, y + x).normalize();
      ...
      intersectsSprite(e) {
        return (
          iI.center.set(0, 0, 0),
          (iI.radius = 0.7071067811865476 + iL.distanceTo(e.center)),
      ...
      intersectsBox(e) {
        ...
        for (let i = 0; i < 6; i++) {
          let n = t[i];
          if (
            ((iN.x = n.normal.x > 0 ? e.max.x : e.min.x),
            (iN.y = n.normal.y > 0 ? e.max.y : e.min.y),
            (iN.z = n.normal.z > 0 ? e.max.z : e.min.z),
            0 > n.distanceToPoint(iN))
          )
            return !1;
        }
        return !0;
    ...
    class iH extends e2 {
        ...
        if (null === e.index) {
          ...
          for (let e = 1, n = t.count; e < n; e++)
            (iO.fromBufferAttribute(t, e - 1),
              iF.fromBufferAttribute(t, e),
              (i[e] = i[e - 1]),
              (i[e] += iO.distanceTo(iF)));
      ...
      raycast(e, t) {
        ...
        if (
          (null === i.boundingSphere && i.computeBoundingSphere(),
          iV.copy(i.boundingSphere),
          iV.applyMatrix4(n),
          (iV.radius += r),
          !1 === e.ray.intersectsSphere(iV))
        )
          return;
        (iB.copy(n).invert(), iz.copy(e.ray).applyMatrix4(iB));
        ...
        if (null !== h) {
          ...
          for (let r = i, a = n - 1; r < a; r += l) {
            let i = iW(this, e, iz, o, h.getX(r), h.getX(r + 1), r);
            i && t.push(i);
          }
          if (this.isLineLoop) {
            let r = iW(this, e, iz, o, h.getX(n - 1), h.getX(i), n - 1);
            r && t.push(r);
          }
        } else {
          let i = Math.max(0, a.start),
          ...
          for (let r = i, a = n - 1; r < a; r += l) {
            let i = iW(this, e, iz, o, r, r + 1, r);
            i && t.push(i);
          }
          if (this.isLineLoop) {
            let r = iW(this, e, iz, o, n - 1, i, n - 1);
            r && t.push(r);
          }
        }
      }
    ...
    function iW(e, t, i, n, r, a, s) {
      let o = e.geometry.attributes.position;
      if ((iO.fromBufferAttribute(o, r), iF.fromBufferAttribute(o, a), i.distanceSqToSegment(iO, iF, ik, iG) > n))
        return;
      ik.applyMatrix4(e.matrixWorld);
      let l = t.ray.origin.distanceTo(ik);
      if (!(l < t.near) && !(l > t.far))
        return {
          distance: l,
          point: iG.clone().applyMatrix4(e.matrixWorld),
          index: s,
          face: null,
          faceIndex: null,
          barycoord: null,
      ...
      computeLineDistances() {
        ...
        if (null === e.index) {
          ...
          for (let e = 0, n = t.count; e < n; e += 2)
            (iX.fromBufferAttribute(t, e),
              ij.fromBufferAttribute(t, e + 1),
              (i[e] = 0 === e ? 0 : i[e - 1]),
              (i[e + 1] = i[e] + iX.distanceTo(ij)));
          e.setAttribute("lineDistance", new tT(i, 1));
    ...
    class i0 extends e2 {
      ...
      raycast(e, t) {
        ...
        if (
          (null === i.boundingSphere && i.computeBoundingSphere(),
          i$.copy(i.boundingSphere),
          i$.applyMatrix4(n),
          (i$.radius += r),
          !1 === e.ray.intersectsSphere(i$))
        )
          return;
        (iJ.copy(n).invert(), iZ.copy(e.ray).applyMatrix4(iJ));
        let s = r / ((this.scale.x + this.scale.y + this.scale.z) / 3),
          o = s * s,
          l = i.index,
        ...
        if (null !== l) {
          ...
          for (let a = i; a < r; a++) {
            let i = l.getX(a);
            (iQ.fromBufferAttribute(h, i), i1(iQ, i, o, n, e, t, this));
          }
        } else {
          let i = Math.max(0, a.start),
            r = Math.min(h.count, a.start + a.count);
          for (let a = i; a < r; a++) (iQ.fromBufferAttribute(h, a), i1(iQ, a, o, n, e, t, this));
        }
      }
      updateMorphTargets() {
        let e = this.geometry.morphAttributes,
    ...
    function i1(e, t, i, n, r, a, s) {
      let o = iZ.distanceSqToPoint(e);
      if (o < i) {
        let i = new U();
        (iZ.closestPointToPoint(e, i), i.applyMatrix4(n));
    ...
    class i3 extends Z {
      ...
      copy(e) {
        return (
          super.copy(e),
          (this.source = new q(Object.assign({}, e.image))),
      ...
      computeFrenetFrames(e, t = !1) {
        ...
        for (let t = 1; t <= e; t++) {
          if (
            ...
            s.normalize();
            let e = Math.acos(w(n[t - 1].dot(n[t]), -1, 1));
            r[t].applyMatrix4(o.makeRotationAxis(s, e));
          }
          a[t].crossVectors(n[t], r[t]);
        }
        if (!0 === t) {
          let t = Math.acos(w(r[0].dot(r[e]), -1, 1));
    ...
    class nh extends i7 {
      constructor(e = new N(), t = new N(), i = new N(), n = new N()) {
        (super(),
      ...
      getPoint(e, t = new N()) {
        let i = this.v0,
          ...
          r = this.v2,
          a = this.v3;
        return (t.set(nl(e, i.x, n.x, r.x, a.x), nl(e, i.y, n.y, r.y, a.y)), t);
      }
      copy(e) {
    ...
    class nu extends i7 {
      ...
      getPoint(e, t = new N()) {
        let i = this.v0,
          n = this.v1,
          r = this.v2;
        return (t.set(no(e, i.x, n.x, r.x), no(e, i.y, n.y, r.y)), t);
      }
      copy(e) {
    ...
    class nd extends i7 {
      ...
      getPoint(e, t = new U()) {
        let i = this.v0,
          n = this.v1,
          r = this.v2;
        return (t.set(no(e, i.x, n.x, r.x), no(e, i.y, n.y, r.y), no(e, i.z, n.z, r.z)), t);
      }
      copy(e) {
        return (super.copy(e), this.v0.copy(e.v0), this.v1.copy(e.v1), this.v2.copy(e.v2), this);
      }
    ...
    class np extends i7 {
      ...
      getPoint(e, t = new N()) {
        ...
        return (t.set(ns(a, s.x, o.x, l.x, h.x), ns(a, s.y, o.y, l.y, h.y)), t);
      }
      copy(e) {
    ...
    class nf extends tI {
      ...
      static fromJSON(e) {
        return new nf(e.width, e.height, e.widthSegments, e.heightSegments);
      }
    }
    class nm extends tI {
      constructor(e = 1, t = 32, i = 16, n = 0, r = 2 * Math.PI, a = 0, s = Math.PI) {
        ...
        for (let d = 0; d <= i; d++) {
          const g = [],
            _ = d / i;
          let v = 0;
          0 === d && 0 === a ? (v = 0.5 / t) : d === i && o === Math.PI && (v = -0.5 / t);
          for (let i = 0; i <= t; i++) {
            const o = i / t;
    ...
    class nv extends n_ {
      constructor(e) {
        (super(),
          ...
          (this.attenuationDistance = 1 / 0),
          (this.attenuationColor = new td(1, 1, 1)),
          (this.specularIntensity = 1),
          (this.specularIntensityMap = null),
          (this.specularColor = new td(1, 1, 1)),
    ...
    class nR {
      constructor(e, t, i, n) {
        ...
        ((this.name = e),
          (this.times = nM(t, this.TimeBufferType)),
          (this.values = nM(i, this.ValueBufferType)),
      ...
      static toJSON(e) {
        ...
        if (i.toJSON !== this.toJSON) t = i.toJSON(e);
          ...
          t = { name: e.name, times: nM(e.times, Array), values: nM(e.values, Array) };
      ...
      validate() {
        ...
        let t = !0,
          i = this.getValueSize();
        i - Math.floor(i) != 0 && (v("KeyframeTrack: Invalid value size in track.", this), (t = !1));
        let n = this.times,
          r = this.values,
          a = n.length;
        ...
        for (let e = 0; e !== a; e++) {
          ...
          if ("number" == typeof i && isNaN(i)) {
            (v("KeyframeTrack: Time is not a valid number.", this, e, i), (t = !1));
            break;
          }
          if (null !== s && s > i) {
        ...
        if (void 0 !== r && ArrayBuffer.isView((e = r)) && !(e instanceof DataView))
          for (let e = 0, i = r.length; e !== i; ++e) {
            let i = r[e];
            if (isNaN(i)) {
              (v("KeyframeTrack: Value is not a valid number.", this, e, i), (t = !1));
              break;
            }
          }
        return t;
    ...
    ((nC.prototype.ValueTypeName = "bool"),
      ...
      (nC.prototype.DefaultInterpolation = 2300),
    ...
    class nL extends nb {
      ...
      interpolate_(e, t, i, n) {
        let r = this.resultBuffer,
          ...
          o = (i - t) / (n - t),
          l = e * s;
        for (let e = l + s; l !== e; l += 4) D.slerpFlat(r, 0, a, l - s, a, l, o);
        return r;
      }
    }
    class nN extends nR {
    ...
    ((nN.prototype.ValueTypeName = "quaternion"), (nN.prototype.InterpolantFactoryMethodSmooth = void 0));
    class nD extends nR {
      constructor(e, t, i) {
        super(e, t, i);
      }
    ...
    ((nD.prototype.ValueTypeName = "string"),
      ...
      (nD.prototype.DefaultInterpolation = 2300),
    ...
    class nO {
          ...
          t.push(
            (function (e) {
              ...
              if (void 0 === e.times) {
                let t = [],
                  i = [];
                (nT(e.keys, t, i, "value"), (e.times = t), (e.values = i));
              }
      ...
      static toJSON(e) {
        ...
        for (let e = 0, n = i.length; e !== n; ++e) t.push(nR.toJSON(i[e]));
        return n;
      }
      static CreateFromMorphTargetSequence(e, t, i, n) {
        ...
        for (let e = 0; e < r; e++) {
          ...
          ((s = nS(s, 1, l)),
            ...
            a.push(new nI(".morphTargetInfluences[" + t[e].name + "]", s, o).scale(1 / i)));
        }
      ...
      static parseAnimation(e, t) {
        if ((_("AnimationClip: parseAnimation() is deprecated and will be removed with r185"), !e))
          return (v("AnimationClip: No animation in JSONLoader data."), null);
        let i = function (e, t, i, n, r) {
            if (0 !== i.length) {
              let a = [],
                s = [];
              (nT(i, a, s, n), 0 !== a.length && r.push(new e(t, a, s)));
            }
          },
          n = [],
          r = e.name || "default",
          ...
          if (r && 0 !== r.length)
            if (r[0].morphTargets) {
              ...
              for (let i in t) {
                ...
                n.push(new nI(".morphTargetInfluence[" + i + "]", t, a));
              }
              o = t.length * a;
            } else {
              let a = ".bones[" + t[e].name + "]";
              (i(nU, a + ".position", r, "pos", n),
                i(nN, a + ".quaternion", r, "rot", n),
                i(nU, a + ".scale", r, "scl", n));
            }
        }
    ...
    nz.DEFAULT_MATERIAL_NAME = "__DEFAULT";
    let nV = {};
    ...
    class nG extends nz {
      ...
      load(e, t, i, n) {
        ...
        if (void 0 !== nV[e]) return void nV[e].push({ onLoad: t, onProgress: i, onError: n });
        ((nV[e] = []), nV[e].push({ onLoad: t, onProgress: i, onError: n }));
        let a = new Request(e, {
        ...
        (fetch(a)
          .then((t) => {
            if (200 === t.status || 0 === t.status) {
              if (
                (0 === t.status && _("FileLoader: HTTP Status 0 received."),
                "u" < typeof ReadableStream || void 0 === t.body || void 0 === t.body.getReader)
              )
                return t;
              let i = nV[e],
                n = t.body.getReader(),
            ...
            throw new nk(`fetch for "${t.url}" responded with ${t.status}: ${t.statusText}`, t);
          })
          .then((e) => {
            switch (o) {
              case "arraybuffer":
      ...
      load(e, t, i, n) {
        ...
        if (void 0 !== a) {
          if (!0 === a.complete)
            ...
            let e = nH.get(a);
            (void 0 === e && ((e = []), nH.set(a, e)), e.push({ onLoad: t, onError: n }));
          }
          return a;
        }
        let s = p("img");
        function o() {
          ...
          (nH.delete(this), r.manager.itemEnd(e));
        }
        function l(t) {
          (h(), n && n(t), nF.remove(`image:${e}`));
          let i = nH.get(this) || [];
          for (let e = 0; e < i.length; e++) {
            let n = i[e];
            n.onError && n.onError(t);
          }
          (nH.delete(this), r.manager.itemError(e), r.manager.itemEnd(e));
        }
        function h() {
    ...
    class nj extends e2 {
      constructor(e, t = 1) {
        (super(), (this.isLight = !0), (this.type = "Light"), (this.color = new td(e)), (this.intensity = t));
      }
      dispose() {
        this.dispatchEvent({ type: "dispose" });
      }
    ...
    class nJ {
      constructor(e) {
        ((this.camera = e),
          ...
          (this.autoUpdate = !0),
          (this.needsUpdate = !1),
          (this._frustum = new iD()),
          (this._frameExtents = new N(1, 1)),
          (this._viewportCount = 1),
          (this._viewports = [new $(0, 0, 1, 1)]));
      }
      getViewportCount() {
      ...
      updateMatrices(e) {
        let t = this.camera,
          i = this.matrix;
        (nY.setFromMatrixPosition(e.matrixWorld),
          t.position.copy(nY),
          nK.setFromMatrixPosition(e.target.matrixWorld),
          t.lookAt(nK),
          t.updateMatrixWorld(),
          nq.multiplyMatrices(t.projectionMatrix, t.matrixWorldInverse),
          this._frustum.setFromProjectionMatrix(nq, t.coordinateSystem, t.reversedDepth),
          t.reversedDepth
    ...
    class nZ extends nJ {
      constructor() {
        (super(new t1(50, 1, 0.5, 500)), (this.isSpotLightShadow = !0), (this.focus = 1), (this.aspect = 1));
      }
      updateMatrices(e) {
        let t = this.camera,
          i = 2 * E * e.angle * this.focus,
          n = (this.mapSize.width / this.mapSize.height) * this.aspect,
          r = e.distance || t.far;
    ...
    class n$ extends nj {
      constructor(e, t, i = 0, n = Math.PI / 3, r = 0, a = 2) {
        (super(e, t),
          (this.isSpotLight = !0),
          (this.type = "SpotLight"),
          this.position.copy(e2.DEFAULT_UP),
          this.updateMatrix(),
          (this.target = new e2()),
          (this.distance = i),
          (this.angle = n),
    ...
    class nQ extends nJ {
      constructor() {
        (super(new t1(90, 1, 0.5, 500)), (this.isPointLightShadow = !0));
      }
    }
    class n0 extends nj {
    ...
    class n3 extends nJ {
      constructor() {
        (super(new n1(-5, 5, 5, -5, 0.5, 500)), (this.isDirectionalLightShadow = !0));
      }
    }
    class n2 extends nj {
      constructor(e, t) {
    ...
    class n6 extends nz {
      constructor(e) {
        (super(e),
          ...
          "u" < typeof createImageBitmap && _("ImageBitmapLoader: createImageBitmap() not supported."),
      ...
      load(e, t, i, n) {
        (void 0 === e && (e = ""), void 0 !== this.path && (e = this.path + e), (e = this.manager.resolveURL(e)));
        let r = this,
          a = nF.get(`image-bitmap:${e}`);
        if (void 0 !== a)
          return (r.manager.itemStart(e), a.then)
            ? void a.then((i) => {
                if (!0 !== n5.has(a)) return (t && t(i), r.manager.itemEnd(e), i);
                (n && n(n5.get(a)), r.manager.itemError(e), r.manager.itemEnd(e));
              })
            : (setTimeout(function () {
                (t && t(a), r.manager.itemEnd(e));
              }, 0),
        ...
        let o = fetch(e, s)
          ...
          .then(function (i) {
            return (nF.add(`image-bitmap:${e}`, i), t && t(i), r.manager.itemEnd(e), i);
          })
          .catch(function (t) {
            (n && n(t), n5.set(o, t), nF.remove(`image-bitmap:${e}`), r.manager.itemError(e), r.manager.itemEnd(e));
          });
        (nF.add(`image-bitmap:${e}`, o), r.manager.itemStart(e));
      }
      abort() {
        return (this._abortController.abort(), (this._abortController = new AbortController()), this);
      }
    ...
    class n9 {
      ...
      _slerp(e, t, i, n) {
        D.slerpFlat(e, t, e, t, e, i, n);
      }
      _slerpAdditive(e, t, i, n, r) {
        let a = this._workIndex * r;
        (D.multiplyQuaternionsFlat(e, a, e, t, e, i), D.slerpFlat(e, t, e, t, e, a, n));
      }
      _lerp(e, t, i, n, r) {
        let a = 1 - n;
        for (let s = 0; s !== r; ++s) {
    ...
    let n7 = "\\[\\]\\.:\\/",
      ...
      rn = RegExp(
        "^" +
          /((?:WC+[\/:])*)/.source.replace("WC", rt) +
          /(WCOD+)?/.source.replace("WCOD", ri) +
          /(?:\.(WC+)(?:\[(.+)\])?)?/.source.replace("WC", rt) +
          /\.(WC+)(?:\[(.+)\])?/.source.replace("WC", rt) +
          "$",
      ),
    ...
    class ra {
      constructor(e, t, i) {
        ((this.path = t),
          (this.parsedPath = i || ra.parseTrackName(t)),
          (this.node = ra.findNode(e, this.parsedPath.nodeName)),
          (this.rootNode = e),
          (this.getValue = this._getValue_unbound),
          (this.setValue = this._setValue_unbound));
      }
      static create(e, t, i) {
        return e && e.isAnimationObjectGroup ? new ra.Composite(e, t, i) : new ra(e, t, i);
      }
      static sanitizeNodeName(e) {
        return e.replace(/\s/g, "_").replace(re, "");
      }
      static parseTrackName(e) {
        ...
        if (void 0 !== n && -1 !== n) {
          ...
          -1 !== rr.indexOf(e) && ((i.nodeName = i.nodeName.substring(0, n)), (i.objectName = e));
        }
      ...
      bind() {
        let e = this.node,
          ...
          r = t.propertyIndex;
        if (
          (e || ((e = ra.findNode(this.rootNode, t.nodeName)), (this.node = e)),
        ...
        if (void 0 === a)
          return void v(
            "PropertyBinding: Trying to update property for track: " + t.nodeName + "." + n + " but it wasn't found.",
            e,
          );
        ...
        ((this.targetObject = e),
          !0 === e.isMaterial
            ...
            : !0 === e.isObject3D && (s = this.Versioning.MatrixWorldNeedsUpdate));
    ...
    ((ra.Composite = class {
      ...
      (ra.prototype.BindingType = { Direct: 0, EntireArray: 1, ArrayElement: 2, HasFromToArray: 3 }),
      (ra.prototype.Versioning = { None: 0, NeedsUpdate: 1, MatrixWorldNeedsUpdate: 2 }),
      (ra.prototype.GetterByBindingType = [
        ra.prototype._getValue_direct,
        ra.prototype._getValue_array,
        ra.prototype._getValue_arrayElement,
        ra.prototype._getValue_toArray,
      ]),
      (ra.prototype.SetterByBindingTypeAndVersioning = [
        [
          ra.prototype._setValue_direct,
          ra.prototype._setValue_direct_setNeedsUpdate,
          ra.prototype._setValue_direct_setMatrixWorldNeedsUpdate,
        ],
        [
          ra.prototype._setValue_array,
          ra.prototype._setValue_array_setNeedsUpdate,
          ra.prototype._setValue_array_setMatrixWorldNeedsUpdate,
        ],
        [
          ra.prototype._setValue_arrayElement,
          ra.prototype._setValue_arrayElement_setNeedsUpdate,
          ra.prototype._setValue_arrayElement_setMatrixWorldNeedsUpdate,
        ],
        [
          ra.prototype._setValue_fromArray,
          ra.prototype._setValue_fromArray_setNeedsUpdate,
          ra.prototype._setValue_fromArray_setMatrixWorldNeedsUpdate,
        ],
      ]));
    class rs {
      ...
      crossFadeFrom(e, t, i = !1) {
        if ((e.fadeOut(t), this.fadeIn(t), !0 === i)) {
      ...
      _setEndings(e, t, i) {
        ...
        i
          ...
          : (e ? (n.endingStart = this.zeroSlopeAtStart ? 2401 : 2400) : (n.endingStart = 2402),
            t ? (n.endingEnd = this.zeroSlopeAtEnd ? 2401 : 2400) : (n.endingEnd = 2402));
      }
        ...
        update: function (i, n) {
          if ((i.isInterleavedBufferAttribute && (i = i.data), i.isGLBufferAttribute)) {
            ...
            (!e || e.version < i.version) &&
              t.set(i, { buffer: i.buffer, type: i.type, bytesPerElement: i.elementSize, version: i.version });
            return;
          }
          let r = t.get(i);
          if (void 0 === r)
            t.set(
              ...
              (function (t, i) {
                let n,
                  ...
                  s = r.byteLength,
                  o = e.createBuffer();
                if ((e.bindBuffer(i, o), e.bufferData(i, r, a), t.onUploadCallback(), r instanceof Float32Array))
                  n = e.FLOAT;
                ...
                return { buffer: o, type: n, bytesPerElement: r.BYTES_PER_ELEMENT, version: t.version, size: s };
              })(i, n),
            );
    ...
    ("u" > typeof __THREE_DEVTOOLS__ &&
      ...
      "u" > typeof window &&
        (window.__THREE__ ? _("WARNING: Multiple instances of Three.js being imported.") : (window.__THREE__ = "182")),
      e.s(
        [
          ...
          class extends M {
            ...
            _bindAction(e, t) {
              ...
              for (let e = 0; e !== r; ++e) {
                let r = n[e],
                  l = r.name,
                  c = h[l];
                if (void 0 !== c) (++c.referenceCount, (a[e] = c));
                else {
                  if (void 0 !== (c = a[e])) {
                  ...
                  ((c = new n9(ra.create(i, l, n), r.ValueTypeName, r.getValueSize())),
                    ++c.referenceCount,
            ...
            _addInactiveAction(e, t, i) {
              let n = this._actions,
                ...
                a = r[t];
              if (void 0 === a) ((a = { knownActions: [e], actionByRoot: {} }), (e._byClipCacheIndex = 0), (r[t] = a));
              else {
            ...
            _lendControlInterpolant() {
              ...
              return (
                void 0 === i &&
                  (((i = new nA(new Float32Array(2), new Float32Array(2), 1, ro)).__cacheIndex = t), (e[t] = i)),
                i
              );
            }
            ...
            clipAction(e, t, i) {
              let n = t || this._root,
                r = n.uuid,
                a = "string" == typeof e ? nO.findByName(n, e) : e,
                s = null !== a ? a.uuid : e,
              ...
              let h = new rs(this, a, t, i);
              return (this._bindAction(h, l), this._addInactiveAction(h, s, r), h);
            }
            existingAction(e, t) {
              let i = t || this._root,
                n = i.uuid,
                r = "string" == typeof e ? nO.findByName(i, e) : e,
                a = r ? r.uuid : e,
          ...
          class extends M {
            ...
            connect(e) {
              void 0 === e
                ...
                : (null !== this.domElement && this.disconnect(), (this.domElement = e));
            }
            disconnect() {}
            dispose() {}
            update() {}
                  ...
                  if (
                    ...
                    for (let e = 0; e < 3; e++) {
                      const t = (e + 1) % 3,
                        ...
                        p = `${r}_${n}`;
                      p in h && h[p]
                        ? (i8.dot(h[p].normal) <= i && (c.push(a.x, a.y, a.z), c.push(u.x, u.y, u.z)), (h[p] = null))
                        : d in h || (h[d] = { index0: s[e], index1: s[t], normal: i8.clone() });
                    }
                }
                for (const e in h)
                  if (h[e]) {
                    const { index0: t, index1: i } = h[e];
                    (i5.fromBufferAttribute(r, t),
                      i6.fromBufferAttribute(r, i),
                      c.push(i5.x, i5.y, i5.z),
                      c.push(i6.x, i6.y, i6.z));
                  }
          ...
          class extends e2 {
            constructor() {
              (super(),
                ...
                (this.backgroundRotation = new eV()),
                (this.environmentIntensity = 1),
                (this.environmentRotation = new eV()),
          ...
          class {
            ...
            makeSafe() {
              return ((this.phi = w(this.phi, 1e-6, Math.PI - 1e-6)), this);
            }
            setFromVector3(e) {
            ...
            setFromCartesianCoords(e, t, i) {
              return (
                ...
                0 === this.radius
                  ...
                  : ((this.theta = Math.atan2(e, i)), (this.phi = Math.acos(w(t / this.radius, -1, 1)))),
                this
              );
            }
            clone() {
    ...
    let ru = {
      ...
      rd = {
        common: {
          diffuse: { value: new td(0xffffff) },
          opacity: { value: 1 },
          map: { value: null },
          mapTransform: { value: new B() },
          alphaMap: { value: null },
          alphaMapTransform: { value: new B() },
          alphaTest: { value: 0 },
        },
        specularmap: { specularMap: { value: null }, specularMapTransform: { value: new B() } },
        envmap: {
          envMap: { value: null },
          envMapRotation: { value: new B() },
          flipEnvMap: { value: -1 },
        ...
        aomap: { aoMap: { value: null }, aoMapIntensity: { value: 1 }, aoMapTransform: { value: new B() } },
        lightmap: { lightMap: { value: null }, lightMapIntensity: { value: 1 }, lightMapTransform: { value: new B() } },
        bumpmap: { bumpMap: { value: null }, bumpMapTransform: { value: new B() }, bumpScale: { value: 1 } },
        normalmap: {
          normalMap: { value: null },
          normalMapTransform: { value: new B() },
          normalScale: { value: new N(1, 1) },
        },
        displacementmap: {
          displacementMap: { value: null },
          displacementMapTransform: { value: new B() },
          displacementScale: { value: 1 },
          displacementBias: { value: 0 },
        },
        emissivemap: { emissiveMap: { value: null }, emissiveMapTransform: { value: new B() } },
        metalnessmap: { metalnessMap: { value: null }, metalnessMapTransform: { value: new B() } },
        roughnessmap: { roughnessMap: { value: null }, roughnessMapTransform: { value: new B() } },
        gradientmap: { gradientMap: { value: null } },
        fog: {
          fogDensity: { value: 25e-5 },
          fogNear: { value: 1 },
          fogFar: { value: 2e3 },
          fogColor: { value: new td(0xffffff) },
        },
        lights: {
      ...
      rp = {
        basic: {
          uniforms: tq([rd.common, rd.specularmap, rd.envmap, rd.aomap, rd.lightmap, rd.fog]),
        ...
        phong: {
          uniforms: tq([
            ...
            rd.fog,
            rd.lights,
            { emissive: { value: new td(0) }, specular: { value: new td(1118481) }, shininess: { value: 30 } },
          ]),
        ...
        matcap: {
          uniforms: tq([rd.common, rd.bumpmap, rd.normalmap, rd.displacementmap, rd.fog, { matcap: { value: null } }]),
          vertexShader: ru.meshmatcap_vert,
          fragmentShader: ru.meshmatcap_frag,
        },
        points: { uniforms: tq([rd.points, rd.fog]), vertexShader: ru.points_vert, fragmentShader: ru.points_frag },
        dashed: {
          uniforms: tq([rd.common, rd.fog, { scale: { value: 1 }, dashSize: { value: 1 }, totalSize: { value: 2 } }]),
          vertexShader: ru.linedashed_vert,
          fragmentShader: ru.linedashed_frag,
        },
        depth: {
          uniforms: tq([rd.common, rd.displacementmap]),
          vertexShader: ru.depth_vert,
          fragmentShader: ru.depth_frag,
        },
        normal: {
          uniforms: tq([rd.common, rd.bumpmap, rd.normalmap, rd.displacementmap, { opacity: { value: 1 } }]),
          vertexShader: ru.meshnormal_vert,
          fragmentShader: ru.meshnormal_frag,
        },
        sprite: { uniforms: tq([rd.sprite, rd.fog]), vertexShader: ru.sprite_vert, fragmentShader: ru.sprite_frag },
        background: {
          uniforms: { uvTransform: { value: new B() }, t2D: { value: null }, backgroundIntensity: { value: 1 } },
        ...
        backgroundCube: {
          uniforms: {
            ...
            backgroundRotation: { value: new B() },
          },
          vertexShader: ru.backgroundCube_vert,
          fragmentShader: ru.backgroundCube_frag,
        },
        cube: {
        ...
        distance: {
          ...
          vertexShader: ru.distance_vert,
          fragmentShader: ru.distance_frag,
        },
        shadow: {
          uniforms: tq([rd.lights, rd.fog, { color: { value: new td(0) }, opacity: { value: 1 } }]),
    ...
    rp.physical = {
      uniforms: tq([
        rp.standard.uniforms,
        {
          clearcoat: { value: 0 },
          clearcoatMap: { value: null },
          clearcoatMapTransform: { value: new B() },
          clearcoatNormalMap: { value: null },
          clearcoatNormalMapTransform: { value: new B() },
          clearcoatNormalScale: { value: new N(1, 1) },
          clearcoatRoughness: { value: 0 },
          clearcoatRoughnessMap: { value: null },
          clearcoatRoughnessMapTransform: { value: new B() },
          dispersion: { value: 0 },
          iridescence: { value: 0 },
          iridescenceMap: { value: null },
          iridescenceMapTransform: { value: new B() },
          iridescenceIOR: { value: 1.3 },
          iridescenceThicknessMinimum: { value: 100 },
          iridescenceThicknessMaximum: { value: 400 },
          iridescenceThicknessMap: { value: null },
          iridescenceThicknessMapTransform: { value: new B() },
          sheen: { value: 0 },
          sheenColor: { value: new td(0) },
          sheenColorMap: { value: null },
          sheenColorMapTransform: { value: new B() },
          sheenRoughness: { value: 1 },
          sheenRoughnessMap: { value: null },
          sheenRoughnessMapTransform: { value: new B() },
          transmission: { value: 0 },
          transmissionMap: { value: null },
          transmissionMapTransform: { value: new B() },
          transmissionSamplerSize: { value: new N() },
          transmissionSamplerMap: { value: null },
          thickness: { value: 0 },
          thicknessMap: { value: null },
          thicknessMapTransform: { value: new B() },
          attenuationDistance: { value: 0 },
          attenuationColor: { value: new td(0) },
          specularColor: { value: new td(1, 1, 1) },
          specularColorMap: { value: null },
          specularColorMapTransform: { value: new B() },
          specularIntensity: { value: 1 },
          specularIntensityMap: { value: null },
          specularIntensityMapTransform: { value: new B() },
          anisotropyVector: { value: new N() },
          anisotropyMap: { value: null },
          anisotropyMapTransform: { value: new B() },
        },
      ]),
      vertexShader: ru.meshphysical_vert,
      fragmentShader: ru.meshphysical_frag,
    ...
    function r_(e, t, i, n, r, a, s) {
      ...
      function g(t, i) {
        (t.getRGB(rf, tY(e)), n.buffers.color.setClear(rf.r, rf.g, rf.b, i, s));
      }
      return {
        ...
        render: function (t) {
          let i = !1,
            r = m(t);
          null === r ? g(h, u) : r && r.isColor && (g(r, 1), (i = !0));
        ...
        addToRenderList: function (t, i) {
          ...
          n && (n.isCubeTexture || 306 === n.mapping)
            ? (void 0 === l &&
                ((l = new tH(
                  ...
                  new tJ({
                    ...
                    uniforms: tj(rp.backgroundCube.uniforms),
                    vertexShader: rp.backgroundCube.vertexShader,
                    fragmentShader: rp.backgroundCube.fragmentShader,
                    side: 1,
                    depthTest: !1,
                    depthWrite: !1,
                    fog: !1,
                ...
                r.update(l)),
              rm.copy(i.backgroundRotation),
              (rm.x *= -1),
              (rm.y *= -1),
              (rm.z *= -1),
              n.isCubeTexture && !1 === n.isRenderTargetTexture && ((rm.y *= -1), (rm.z *= -1)),
              (l.material.uniforms.envMap.value = n),
              (l.material.uniforms.flipEnvMap.value = n.isCubeTexture && !1 === n.isRenderTargetTexture ? -1 : 1),
              ...
              l.material.uniforms.backgroundRotation.value.setFromMatrix4(rg.makeRotationFromEuler(rm)),
              (l.material.toneMapped = G.getTransfer(n.colorSpace) !== c),
              (d !== n || p !== n.version || f !== e.toneMapping) &&
                ((l.material.needsUpdate = !0), (d = n), (p = n.version), (f = e.toneMapping)),
              l.layers.enableAll(),
            ...
            : n &&
              ...
              (void 0 === o &&
                ((o = new tH(
                  ...
                  new tJ({
                    ...
                    uniforms: tj(rp.background.uniforms),
                    vertexShader: rp.background.vertexShader,
                    fragmentShader: rp.background.fragmentShader,
                    side: 0,
                    depthTest: !1,
                    depthWrite: !1,
                    fog: !1,
              ...
              (o.material.toneMapped = G.getTransfer(n.colorSpace) !== c),
              !0 === n.matrixAutoUpdate && n.updateMatrix(),
              o.material.uniforms.uvTransform.value.copy(n.matrix),
              (d !== n || p !== n.version || f !== e.toneMapping) &&
                ((o.material.needsUpdate = !0), (d = n), (p = n.version), (f = e.toneMapping)),
              o.layers.enableAll(),
              t.unshift(o, o.geometry, o.material, 0, 0, null));
        },
        dispose: function () {
          (void 0 !== l && (l.geometry.dispose(), l.material.dispose(), (l = void 0)),
            void 0 !== o && (o.geometry.dispose(), o.material.dispose(), (o = void 0)));
        },
      };
    }
    function rv(e, t) {
        ...
        setup: function (i, r, l, m, g) {
          ...
          let x,
            ...
            b =
              ...
              (v = l),
              (x = !0 === r.wireframe),
              void 0 === (y = n[_.id]) && ((y = {}), (n[_.id] = y)),
              void 0 === (M = y[v.id]) && ((M = {}), (y[v.id] = M)),
              void 0 === (S = M[x]) && ((S = h(e.createVertexArray())), (M[x] = S)),
              S);
          (a !== b && o((a = b).object),
            (T = (function (e, t, i, n) {
              let r = a.attributes,
              ...
              (function (i, n, r, a) {
                ...
                for (let n in o) {
                  ...
                  if (r.location >= 0) {
                    ...
                    if (
                      (void 0 === o &&
                        ("instanceMatrix" === n && i.instanceMatrix && (o = i.instanceMatrix),
                      ...
                      let h = l.buffer,
                        c = l.type,
                        p = l.bytesPerElement,
                        m = c === e.INT || c === e.UNSIGNED_INT || 1013 === o.gpuType;
                      if (o.isInterleavedBufferAttribute) {
                        ...
                        for (let e = 0; e < r.locationSize; e++)
                          f(r.location + e, s / r.locationSize, c, n, l * p, (g + (s / r.locationSize) * e) * p, m);
                      } else {
                        ...
                        e.bindBuffer(e.ARRAY_BUFFER, h);
                        for (let e = 0; e < r.locationSize; e++)
                          f(r.location + e, s / r.locationSize, c, n, s * p, (s / r.locationSize) * e * p, m);
                      }
                    } else if (void 0 !== l) {
                      let t = l[n];
                      if (void 0 !== t)
    ...
    let rT = [0.125, 0.215, 0.35, 0.446, 0.526, 0.582],
      rb = new n1(),
      rE = new td(),
      rA = null,
      rw = 0,
    ...
    class rI {
      ...
      fromScene(e, t = 0, i = 0.1, n = 100, r = {}) {
        let { size: a = 256, position: s = rP } = r;
        ((rA = this._renderer.getRenderTarget()),
          (rw = this._renderer.getActiveCubeFace()),
          (rR = this._renderer.getActiveMipmapLevel()),
          (rC = this._renderer.xr.enabled),
      ...
      compileCubemapShader() {
        null === this._cubemapMaterial &&
          ((this._cubemapMaterial = rU()), this._compileMaterial(this._cubemapMaterial));
      }
      compileEquirectangularShader() {
        null === this._equirectMaterial &&
          ((this._equirectMaterial = rD()), this._compileMaterial(this._equirectMaterial));
      }
      dispose() {
        (this._dispose(),
      ...
      _cleanup(e) {
        (this._renderer.setRenderTarget(rA, rw, rR),
          (this._renderer.xr.enabled = rC),
          (e.scissorTest = !1),
          rN(e, 0, 0, e.width, e.height));
      }
      _fromTexture(e, t) {
      ...
      _allocateTargets() {
        ...
        if (
          ...
          var r, a;
          (null !== this._pingPongRenderTarget && this._dispose(), (this._pingPongRenderTarget = rL(e, t, i)));
          let { _lodMax: n } = this;
          (({
            ...
            for (let s = 0; s < a; s++) {
              ...
              t.push(a);
              let o = 1 / a;
              (s > e - 4 ? (o = rT[s - e + 4 - 1]) : 0 === s && (o = 0), i.push(o));
              let l = 1 / (a - 2),
                h = -l,
                c = 1 + l,
              ...
              let m = new tI();
              (m.setAttribute("position", new ty(d, 3)),
                m.setAttribute("uv", new ty(p, 2)),
                m.setAttribute("faceIndex", new ty(f, 1)),
                n.push(new tH(m, null)),
                r > 4 && r--);
            }
            ...
            (this._blurMaterial =
              ...
              new tJ({
                ...
                defines: { n: 20, CUBEUV_TEXEL_WIDTH: 1 / e, CUBEUV_TEXEL_HEIGHT: 1 / t, CUBEUV_MAX_MIP: `${r}.0` },
                uniforms: {
                  envMap: { value: null },
                  samples: { value: 1 },
      ...
      _compileMaterial(e) {
        let t = new tH(new tI(), e);
        this._renderer.compile(t, rb);
      }
      _sceneToCubeUV(e, t, i, n, r) {
        let a = new t1(90, 1, t, i),
          s = [1, -1, 1, 1, 1, 1],
          o = [1, 1, 1, -1, -1, -1],
          l = this._renderer,
          h = l.autoClear,
        ...
        (l.getClearColor(rE),
          (l.toneMapping = 0),
          (l.autoClear = !1),
          l.state.buffers.depth.getReversed() && (l.setRenderTarget(n), l.clearDepth(), l.setRenderTarget(null)),
          null === this._backgroundBox &&
            (this._backgroundBox = new tH(
              new tX(),
              new tg({ name: "PMREM.Background", side: 1, depthWrite: !1, depthTest: !1 }),
            )));
        let u = this._backgroundBox,
          d = u.material,
          p = !1,
          f = e.background;
        f ? f.isColor && (d.color.copy(f), (e.background = null), (p = !0)) : (d.color.copy(rE), (p = !0));
        for (let t = 0; t < 6; t++) {
          let i = t % 3;
          0 === i
            ? (a.up.set(0, s[t], 0), a.position.set(r.x, r.y, r.z), a.lookAt(r.x + o[t], r.y, r.z))
            : 1 === i
              ? (a.up.set(0, 0, s[t]), a.position.set(r.x, r.y, r.z), a.lookAt(r.x, r.y + o[t], r.z))
              : (a.up.set(0, s[t], 0), a.position.set(r.x, r.y, r.z), a.lookAt(r.x, r.y, r.z + o[t]));
          let h = this._cubeSize;
          (rN(n, i * h, t > 2 ? h : 0, h, h), l.setRenderTarget(n), p && l.render(u, a), l.render(e, a));
        }
      ...
      _halfBlur(e, t, i, n, r, a, s) {
        ...
        let y = this._sizeLods[n],
          M = 4 * (this._cubeSize - y);
        (rN(t, 3 * y * (n > x - 4 ? n - x + 4 : 0), M, 3 * y, 2 * y), o.setRenderTarget(t), o.render(h, rb));
      }
    }
    function rL(e, t, i) {
      let n = new ee(e, t, i);
          ...
          if (r && r.isTexture) {
            ...
            if (s || o) {
              ...
              if (r.isRenderTargetTexture && r.pmremVersion !== l)
                return (
                  null === i && (i = new rI(e)),
                  ((a = s ? i.fromEquirectangular(r, a) : i.fromCubemap(r, a)).texture.pmremVersion = r.pmremVersion),
                  t.set(r, a),
                  a.texture
                );
              {
                ...
                return (s && l && l.height > 0) ||
                  ...
                  ? (null === i && (i = new rI(e)),
                    ((a = s ? i.fromEquirectangular(r) : i.fromCubemap(r)).texture.pmremVersion = r.pmremVersion),
                    t.set(r, a),
                    r.addEventListener("dispose", n),
                    a.texture)
                  : null;
      ...
      return {
        update: function (a, s, o) {
          ...
          if (void 0 === u || u.count !== c) {
            ...
            ((u = { count: c, texture: g, size: new N(p, f) }),
              n.set(s, u),
    ...
    function rX(e, t, i, n, r) {
      let a,
        s = new ee(t, i, { type: e, depthBuffer: n, stencilBuffer: r }),
        o = new ee(t, i, { type: 1016, depthBuffer: !1, stencilBuffer: !1 }),
        l = new tI();
      (l.setAttribute("position", new tT([-1, 3, 0, -1, -1, 0, 3, -1, 0], 3)),
        l.setAttribute("uv", new tT([0, 2, 0, 0, 2, 0], 2)));
      let h = new ng({
        ...
        (this.end = function (e, t) {
          ...
          if (p !== e.outputColorSpace || f !== e.toneMapping) {
            ((p = e.outputColorSpace),
              (f = e.toneMapping),
              (h.defines = {}),
              G.getTransfer(p) === c && (h.defines.SRGB_TRANSFER = ""));
            let t = rW[f];
            (t && (h.defines[t] = ""), (h.needsUpdate = !0));
          }
          ((h.uniforms.tDiffuse.value = i.texture), e.setRenderTarget(g), e.render(u, d), (g = null), (m = !1));
        }),
    ...
    function r3(e, t, i) {
      ...
      let r = t * i,
        a = rZ[r];
      if ((void 0 === a && ((a = new Float32Array(r)), (rZ[r] = a)), 0 !== t)) {
        n.toArray(a, 0);
    ...
    function r8(e, t) {
      ...
      if (void 0 !== t.x)
        ...
        if (r2(i, t)) return;
        (e.uniform2fv(this.addr, t), r4(i, t));
      }
    }
    function r9(e, t) {
      let i = this.cache;
      if (void 0 !== t.x)
        ...
        if (r2(i, t)) return;
        (e.uniform3fv(this.addr, t), r4(i, t));
      }
    }
    function r7(e, t) {
      let i = this.cache;
      if (void 0 !== t.x)
        ...
        if (r2(i, t)) return;
        (e.uniform4fv(this.addr, t), r4(i, t));
      }
    }
    function ae(e, t) {
      let i = this.cache,
      ...
      if (void 0 === n) {
        if (r2(i, t)) return;
        (e.uniformMatrix2fv(this.addr, !1, t), r4(i, t));
      } else {
        if (r2(i, n)) return;
        (r1.set(n), e.uniformMatrix2fv(this.addr, !1, r1), r4(i, n));
      }
    }
    function at(e, t) {
      let i = this.cache,
      ...
      if (void 0 === n) {
        if (r2(i, t)) return;
        (e.uniformMatrix3fv(this.addr, !1, t), r4(i, t));
      } else {
        if (r2(i, n)) return;
        (r0.set(n), e.uniformMatrix3fv(this.addr, !1, r0), r4(i, n));
      }
    }
    function ai(e, t) {
      let i = this.cache,
      ...
      if (void 0 === n) {
        if (r2(i, t)) return;
        (e.uniformMatrix4fv(this.addr, !1, t), r4(i, t));
      } else {
        if (r2(i, n)) return;
        (rQ.set(n), e.uniformMatrix4fv(this.addr, !1, rQ), r4(i, n));
      }
    }
    function an(e, t) {
      let i = this.cache;
    ...
    function ar(e, t) {
      ...
      if (void 0 !== t.x)
        ...
        if (r2(i, t)) return;
        (e.uniform2iv(this.addr, t), r4(i, t));
      }
    }
    function aa(e, t) {
      let i = this.cache;
      if (void 0 !== t.x)
        ...
        if (r2(i, t)) return;
        (e.uniform3iv(this.addr, t), r4(i, t));
      }
    }
    function as(e, t) {
      let i = this.cache;
      if (void 0 !== t.x)
        (i[0] !== t.x || i[1] !== t.y || i[2] !== t.z || i[3] !== t.w) &&
          (e.uniform4i(this.addr, t.x, t.y, t.z, t.w), (i[0] = t.x), (i[1] = t.y), (i[2] = t.z), (i[3] = t.w));
      else {
        if (r2(i, t)) return;
        (e.uniform4iv(this.addr, t), r4(i, t));
      }
    }
    function ao(e, t) {
      let i = this.cache;
    ...
    function al(e, t) {
      ...
      if (void 0 !== t.x)
        ...
        if (r2(i, t)) return;
        (e.uniform2uiv(this.addr, t), r4(i, t));
      }
    }
    function ah(e, t) {
      let i = this.cache;
      if (void 0 !== t.x)
        ...
        if (r2(i, t)) return;
        (e.uniform3uiv(this.addr, t), r4(i, t));
      }
    }
    function ac(e, t) {
      let i = this.cache;
      if (void 0 !== t.x)
        (i[0] !== t.x || i[1] !== t.y || i[2] !== t.z || i[3] !== t.w) &&
          (e.uniform4ui(this.addr, t.x, t.y, t.z, t.w), (i[0] = t.x), (i[1] = t.y), (i[2] = t.z), (i[3] = t.w));
      else {
        if (r2(i, t)) return;
        (e.uniform4uiv(this.addr, t), r4(i, t));
      }
    }
    function au(e, t, i) {
      let n,
      ...
      (r[0] !== a && (e.uniform1i(this.addr, a), (r[0] = a)),
        this.type === e.SAMPLER_2D_SHADOW
          ? ((rq.compareFunction = i.isReversedDepthBuffer() ? 518 : 515), (n = rq))
          : (n = rj),
    ...
    function ad(e, t, i) {
      ...
      (n[0] !== r && (e.uniform1i(this.addr, r), (n[0] = r)), i.setTexture3D(t || rK, r));
    }
    function ap(e, t, i) {
      let n = this.cache,
        r = i.allocateTextureUnit();
      (n[0] !== r && (e.uniform1i(this.addr, r), (n[0] = r)), i.setTextureCube(t || rJ, r));
    }
    function af(e, t, i) {
      let n = this.cache,
        r = i.allocateTextureUnit();
      (n[0] !== r && (e.uniform1i(this.addr, r), (n[0] = r)), i.setTexture2DArray(t || rY, r));
    }
    function am(e, t) {
      e.uniform1fv(this.addr, t);
    }
    function ag(e, t) {
      let i = r3(t, this.size, 2);
      e.uniform2fv(this.addr, i);
    }
    function a_(e, t) {
      let i = r3(t, this.size, 3);
      e.uniform3fv(this.addr, i);
    }
    function av(e, t) {
      let i = r3(t, this.size, 4);
    ...
    function ay(e, t) {
      let i = r3(t, this.size, 9);
      e.uniformMatrix3fv(this.addr, !1, i);
    }
    function aM(e, t) {
      let i = r3(t, this.size, 16);
    ...
    function aP(e, t, i) {
      let n,
        ...
        a = t.length,
        s = r5(i, a);
      (r2(r, s) || (e.uniform1iv(this.addr, s), r4(r, s)), (n = this.type === e.SAMPLER_2D_SHADOW ? rq : rj));
    ...
    function aI(e, t, i) {
      let n = this.cache,
        r = t.length,
        a = r5(i, r);
      r2(n, a) || (e.uniform1iv(this.addr, a), r4(n, a));
      for (let e = 0; e !== r; ++e) i.setTexture3D(t[e] || rK, a[e]);
    }
    function aL(e, t, i) {
      let n = this.cache,
        r = t.length,
        a = r5(i, r);
      r2(n, a) || (e.uniform1iv(this.addr, a), r4(n, a));
      for (let e = 0; e !== r; ++e) i.setTextureCube(t[e] || rJ, a[e]);
    }
    function aN(e, t, i) {
      let n = this.cache,
        r = t.length,
        a = r5(i, r);
      r2(n, a) || (e.uniform1iv(this.addr, a), r4(n, a));
      for (let e = 0; e !== r; ++e) i.setTexture2DArray(t[e] || rY, a[e]);
    }
    class aD {
      constructor(e, t, i) {
        ((this.id = e),
          ...
          !(function (e, t, i) {
            ...
            for (aF.lastIndex = 0; ;) {
              ...
              if ((l && (o |= 0), void 0 === h || ("[" === h && s + 2 === r))) {
                aB(i, void 0 === h ? new aD(o, e, t) : new aU(o, e, t));
                break;
              }
              {
                let e = i.map[o];
                (void 0 === e && aB(i, (e = new aO(o))), (i = e));
              }
            }
          })(i, r, this);
        }
    ...
    let aW = { 1: "Linear", 2: "Reinhard", 3: "Cineon", 4: "ACESFilmic", 6: "AgX", 7: "Neutral", 5: "Custom" },
      aX = new U();
    function aj(e) {
      return "" !== e;
    }
    ...
    let aK = /^[ \t]*#include +<([\w\d./]+)>/gm;
    function aJ(e) {
      return e.replace(aK, a$);
    }
    let aZ = new Map();
    function a$(e, t) {
      let i = ru[t];
      if (void 0 === i) {
        let e = aZ.get(t);
        if (void 0 !== e)
          ((i = ru[e]), _('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.', t, e));
    ...
    let a2 = { 1: "SHADOWMAP_TYPE_PCF", 3: "SHADOWMAP_TYPE_VSM" },
      a4 = { 301: "ENVMAP_TYPE_CUBE", 302: "ENVMAP_TYPE_CUBE", 306: "ENVMAP_TYPE_CUBE_UV" },
      a5 = { 302: "ENVMAP_MODE_REFRACTION" },
      a6 = { 0: "ENVMAP_BLENDING_MULTIPLY", 1: "ENVMAP_BLENDING_MIX", 2: "ENVMAP_BLENDING_ADD" };
    function a8(e, t, i, n) {
      var r, a;
      let s,
        o,
        ...
        m = i.vertexShader,
        g = i.fragmentShader,
        x = a2[i.shadowMapType] || "SHADOWMAP_TYPE_BASIC",
        y = !1 === i.envMap ? "ENVMAP_TYPE_CUBE" : a4[i.envMapMode] || "ENVMAP_TYPE_CUBE",
        M = !1 === i.envMap ? "ENVMAP_MODE_REFLECTION" : a5[i.envMapMode] || "ENVMAP_MODE_REFLECTION",
        S = !1 === i.envMap ? "ENVMAP_BLENDING_NONE" : a6[i.combine] || "ENVMAP_BLENDING_NONE",
        T = (function (e) {
      ...
      if (i.isRawShaderMaterial)
        ((s = ["#define SHADER_TYPE " + i.shaderType, "#define SHADER_NAME " + i.shaderName, E].filter(aj).join("\n"))
          .length > 0 && (s += "\n"),
          (o = ["#define SHADER_TYPE " + i.shaderType, "#define SHADER_NAME " + i.shaderName, E].filter(aj).join("\n"))
            .length > 0 && (o += "\n"));
      else {
        let e, t, n, l, u;
        ((s = [
          ...
          (o = [
            ...
            0 !== i.toneMapping ? ru.tonemapping_pars_fragment : "",
            0 !== i.toneMapping
              ? ((r = "toneMapping"),
                void 0 === (e = aW[(a = i.toneMapping)])
                  ? (_("WebGLProgram: Unsupported toneMapping:", a),
                    "vec3 " + r + "( vec3 color ) { return LinearToneMapping( color ); }")
                  : "vec3 " + r + "( vec3 color ) { return " + e + "ToneMapping( color ); }")
              : "",
            i.dithering ? "#define DITHERING" : "",
            i.opaque ? "#define OPAQUE" : "",
            ru.colorspace_pars_fragment,
            ((t = (function (e) {
              G._getMatrix(aG, G.workingColorSpace, e);
              let t = `mat3( ${aG.elements.map((e) => e.toFixed(4))} )`;
	...
	return ${t[1]}( vec4( value.rgb * ${t[0]}, value.a ) );
            ...
            (G.getLuminanceCoefficients(aX),
            (n = aX.x.toFixed(4)),
            (l = aX.y.toFixed(4)),
            (u = aX.z.toFixed(4)),
            `float luminance( const in vec3 rgb ) {
	const vec3 weights = vec3( ${n}, ${l}, ${u} );
	return dot( weights, rgb );
      ...
      ((m = aY((m = aq((m = aJ(m)), i)), i)),
        (g = aY((g = aq((g = aJ(g)), i)), i)),
        (m = a0(m)),
        (g = a0(g)),
        !0 !== i.isRawShaderMaterial &&
          ...
          (o =
            [
              "#define varying in",
              i.glslVersion === u ? "" : "layout(location = 0) out highp vec4 pc_fragColor;",
              i.glslVersion === u ? "" : "#define gl_FragColor pc_fragColor",
      ...
      let R = w + s + m,
        C = w + o + g,
        P = aV(p, p.VERTEX_SHADER, R),
        I = aV(p, p.FRAGMENT_SHADER, C);
      function L(t) {
        if (e.debug.checkShaderErrors) {
          let i = p.getProgramInfoLog(A) || "",
            n = p.getShaderInfoLog(P) || "",
            r = p.getShaderInfoLog(I) || "",
            a = i.trim(),
            l = n.trim(),
            h = r.trim(),
            c = !0,
          ...
          if (!1 === p.getProgramParameter(A, p.LINK_STATUS))
            if (((c = !1), "function" == typeof e.debug.onShaderError)) e.debug.onShaderError(p, A, P, I);
            else {
              let e = aH(p, P, "vertex"),
                i = aH(p, I, "fragment");
              v(
                "THREE.WebGLProgram: Shader Error " +
                  p.getError() +
                  " - VALIDATE_STATUS " +
                  p.getProgramParameter(A, p.VALIDATE_STATUS) +
                  "\n\nMaterial Name: " +
                  t.name +
                  "\nMaterial Type: " +
                  t.type +
          ...
          else "" !== a ? _("WebGLProgram: Program Info Log:", a) : ("" === l || "" === h) && (u = !1);
          u &&
            (t.diagnostics = {
              runnable: c,
              programLog: a,
      ...
      (p.attachShader(A, P),
        ...
        void 0 !== i.index0AttributeName
          ? p.bindAttribLocation(A, 0, i.index0AttributeName)
          : !0 === i.morphTargets && p.bindAttribLocation(A, 0, "position"),
        p.linkProgram(A),
        (this.getUniforms = function () {
          return (void 0 === l && L(this), l);
        }),
        (this.getAttributes = function () {
          return (void 0 === d && L(this), d);
        }));
      let N = !1 === i.rendererExtensionParallelShaderCompile;
      return (
        (this.isReady = function () {
          return (!1 === N && (N = p.getProgramParameter(A, 37297)), N);
        }),
    ...
    class a7 {
      ...
      _getShaderStage(e) {
        let t = this.shaderCache,
          i = t.get(e);
        return (void 0 === i && ((i = new se(e)), t.set(e, i)), i);
      }
    }
    class se {
      constructor(e) {
        ((this.id = a9++), (this.code = e), (this.usedTimes = 0));
      }
    }
    function st(e, t, i, n, r, a, s) {
      let o = new ek(),
        h = new a7(),
        u = new Set(),
        d = [],
      ...
      return {
        getParameters: function (a, o, d, p, x) {
          let y,
            ...
            b = p.fog,
            E = x.geometry,
            A = a.isMeshStandardMaterial ? p.environment : null,
          ...
          null !== a.precision &&
            ...
            _("WebGLProgram.getParameters:", a.precision, "not supported, using", m, "instead.");
          let P = E.morphAttributes.position || E.morphAttributes.normal || E.morphAttributes.color,
            I = void 0 !== P ? P.length : 0,
            L = 0;
          if (
            (void 0 !== E.morphAttributes.position && (L = 1),
            void 0 !== E.morphAttributes.normal && (L = 2),
            void 0 !== E.morphAttributes.color && (L = 3),
            C)
          ) {
            let e = rp[C];
            ...
            ((y = a.vertexShader),
              (M = a.fragmentShader),
              h.update(a),
              (S = h.getVertexShaderID(a)),
              (T = h.getFragmentShaderID(a)));
          let N = e.getRenderTarget(),
            ...
            ev = !!a.extensions,
            ex = 0;
          a.toneMapped && (null === N || !0 === N.isXRRenderTarget) && (ex = e.toneMapping);
          let ey = {
            shaderID: C,
            shaderType: a.type,
            shaderName: a.name,
            ...
            instancing: U,
            instancingColor: U && null !== x.instanceColor,
            instancingMorph: U && null !== x.morphTexture,
            outputColorSpace: null === N ? e.outputColorSpace : !0 === N.isXRRenderTarget ? N.texture.colorSpace : l,
            ...
            alphaHash: e_,
            combine: a.combine,
            mapUv: F && v(a.map.channel),
            aoMapUv: V && v(a.aoMap.channel),
            lightMapUv: k && v(a.lightMap.channel),
            bumpMapUv: H && v(a.bumpMap.channel),
            ...
            vertexTangents: !!E.attributes.tangent && (W || K),
            vertexColors: a.vertexColors,
            vertexAlphas: !0 === a.vertexColors && !!E.attributes.color && 4 === E.attributes.color.itemSize,
            pointsUvs: !0 === x.isPoints && !!E.attributes.uv && (F || em),
            fog: !!b,
            useFog: !0 === a.fog,
            ...
            morphTargets: void 0 !== E.morphAttributes.position,
            morphNormals: void 0 !== E.morphAttributes.normal,
            morphColors: void 0 !== E.morphAttributes.color,
            morphTargetsCount: I,
            ...
            toneMapping: ex,
            decodeVideoTexture: F && !0 === a.map.isVideoTexture && G.getTransfer(a.map.colorSpace) === c,
            decodeVideoTextureEmissive:
              j && !0 === a.emissiveMap.isVideoTexture && G.getTransfer(a.emissiveMap.colorSpace) === c,
            ...
            extensionMultiDraw: ((ev && !0 === a.extensions.multiDraw) || O) && n.has("WEBGL_multi_draw"),
            rendererExtensionParallelShaderCompile: n.has("KHR_parallel_shader_compile"),
            customProgramCacheKey: a.customProgramCacheKey(),
          };
          return ((ey.vertexUv1s = u.has(1)), (ey.vertexUv2s = u.has(2)), (ey.vertexUv3s = u.has(3)), u.clear(), ey);
        },
        getProgramCacheKey: function (t) {
          var i, n, r, a;
          let s = [];
          if (
            (t.shaderID ? s.push(t.shaderID) : (s.push(t.customVertexShaderID), s.push(t.customFragmentShaderID)),
            void 0 !== t.defines)
          )
        ...
        acquireProgram: function (t, i) {
          let n = p.get(i);
          return (void 0 !== n ? ++n.usedTimes : ((n = new a8(e, i, t, a)), d.push(n), p.set(i, n)), n);
        },
    ...
    function sa() {
      ...
      return {
        ...
        sort: function (e, t) {
          (i.length > 1 && i.sort(e || sn), n.length > 1 && n.sort(t || sr), r.length > 1 && r.sort(t || sr));
        },
      };
    }
    function ss() {
      ...
      return {
        get: function (t, i) {
          let n,
            r = e.get(t);
          return (
            void 0 === r ? ((n = new sa()), e.set(t, [n])) : i >= r.length ? ((n = new sa()), r.push(n)) : (n = r[i]),
            n
          );
        },
        dispose: function () {
        ...
        get: function (t) {
          ...
          switch (t.type) {
            case "DirectionalLight":
              i = { direction: new U(), color: new td() };
              break;
            case "SpotLight":
              i = {
                position: new U(),
              ...
              break;
            case "PointLight":
              i = { position: new U(), color: new td(), distance: 0, decay: 0 };
              break;
            case "HemisphereLight":
              i = { direction: new U(), skyColor: new td(), groundColor: new td() };
              break;
            case "RectAreaLight":
              i = { color: new td(), position: new U(), halfWidth: new U(), halfHeight: new U() };
          }
          return ((e[t.id] = i), i);
        },
      };
        ...
        setup: function (t) {
          ...
          for (let e = 0, x = t.length; e < x; e++) {
            ...
            if (
              ...
              let t = x.shadow;
              if (
                (x.map && ((r.spotLightMap[g] = x.map), g++, t.updateMatrices(x), x.castShadow && _++),
          ...
          (u > 0 &&
            (!0 === e.has("OES_texture_float_linear")
              ? ((r.rectAreaLTC1 = rd.LTC_FLOAT_1), (r.rectAreaLTC2 = rd.LTC_FLOAT_2))
              : ((r.rectAreaLTC1 = rd.LTC_HALF_1), (r.rectAreaLTC2 = rd.LTC_HALF_2))),
            (r.ambient[0] = a),
            (r.ambient[1] = s),
            (r.ambient[2] = o));
          let x = r.hash;
      ...
      return {
        get: function (i, n = 0) {
          let r,
            a = t.get(i);
          return (
            void 0 === a ? ((r = new su(e)), t.set(i, [r])) : n >= a.length ? ((r = new su(e)), a.push(r)) : (r = a[n]),
            r
          );
        },
        dispose: function () {
    ...
    let sp = [new U(1, 0, 0), new U(-1, 0, 0), new U(0, 1, 0), new U(0, -1, 0), new U(0, 0, 1), new U(0, 0, -1)],
      sf = [new U(0, -1, 0), new U(0, -1, 0), new U(0, 0, 1), new U(0, 0, -1), new U(0, -1, 0), new U(0, -1, 0)],
      sm = new eP(),
      sg = new U(),
      s_ = new U();
    function sv(e, t, i) {
      let n = new iD(),
        ...
        d = new tJ({
          ...
          uniforms: { shadow_pass: { value: null }, resolution: { value: new N() }, radius: { value: 4 } },
      ...
      let f = new tI();
      f.setAttribute("position", new ty(new Float32Array([-1, -1, 0.5, 3, -1, 0.5, -1, 3, 0.5]), 3));
      let m = new tH(f, d),
        g = this;
      ...
      function x(t, i, n, r) {
        ...
        if (void 0 !== s) a = s;
          ...
          void 0 === n && ((n = {}), (h[e] = n));
          let r = n[t];
          (void 0 === r && ((r = a.clone()), (n[t] = r), i.addEventListener("dispose", y)), (a = r));
        }
        return (
          (a.visible = i.visible),
      ...
      this.render = function (i, o, l) {
        ...
        2 === i.type &&
          (_("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."), (i.type = 1));
        let h = e.getRenderTarget(),
          u = e.getActiveCubeFace(),
          f = e.getActiveMipmapLevel(),
          y = e.state;
        (y.setBlending(0),
          !0 === y.buffers.depth.getReversed()
        ...
        for (let h = 0, u = i.length; h < u; h++) {
          ...
          if (
            ...
            a.copy(f.mapSize),
            (r.x > c || r.y > c) &&
              (r.x > c && ((a.x = Math.floor(c / g.x)), (r.x = a.x * g.x), (f.mapSize.x = a.x)),
              r.y > c && ((a.y = Math.floor(c / g.y)), (r.y = a.y * g.y), (f.mapSize.y = a.y))),
            null === f.map || !0 === M)
          ) {
            if (
              (null !== f.map &&
                (null !== f.map.depthTexture && (f.map.depthTexture.dispose(), (f.map.depthTexture = null)),
                f.map.dispose()),
              3 === this.type)
            ) {
              if (u.isPointLight) {
              ...
              ((f.map = new ee(r.x, r.y, {
                ...
                (f.map.depthTexture = new i3(r.x, r.y, 1015)),
              ...
              (u.isPointLight
                ? ((f.map = new t4(r.x)), (f.map.depthTexture = new i2(r.x, 1014)))
                : ((f.map = new ee(r.x, r.y)), (f.map.depthTexture = new i3(r.x, r.y, 1014))),
          ...
          for (let i = 0; i < v; i++) {
            if (f.map.isWebGLCubeRenderTarget) (e.setRenderTarget(f.map, i), e.clear());
            else {
              0 === i && (e.setRenderTarget(f.map), e.clear());
              let t = f.getViewport(i);
              (s.set(a.x * t.x, a.y * t.y, a.x * t.z, a.y * t.w), y.viewport(s));
            }
            if (u.isPointLight) {
              let e = f.camera,
                t = f.matrix,
              ...
              (n !== e.far && ((e.far = n), e.updateProjectionMatrix()),
                sg.setFromMatrixPosition(u.matrixWorld),
                e.position.copy(sg),
                s_.copy(e.position),
                s_.add(sp[i]),
                e.up.copy(sf[i]),
                e.lookAt(s_),
                e.updateMatrixWorld(),
                t.makeTranslation(-sg.x, -sg.y, -sg.z),
                sm.multiplyMatrices(e.projectionMatrix, e.matrixWorldInverse),
                f._frustum.setFromProjectionMatrix(sm, e.coordinateSystem, e.reversedDepth));
          ...
          (!0 !== f.isPointLightShadow &&
            ...
            (function (i, n) {
              ...
              (d.defines.VSM_SAMPLES !== i.blurSamples &&
                ...
                (d.needsUpdate = !0),
                (p.needsUpdate = !0)),
                null === i.mapPass && (i.mapPass = new ee(r.x, r.y, { format: 1030, type: 1016 })),
    ...
    let sx = { 0: 1, 2: 6, 4: 7, 3: 5, 1: 0, 6: 2, 7: 4, 5: 3 };
    function sy(e, t) {
      let i = new (function () {
          let t = !1,
            i = new $(),
            ...
            setReversed: function (e) {
              if (n !== e) {
                ...
                (e
                  ...
                  : i.clipControlEXT(i.LOWER_LEFT_EXT, i.NEGATIVE_ONE_TO_ONE_EXT),
                  (n = e));
                let r = s;
        ...
        P = !1,
        I = e.getParameter(e.VERSION);
      -1 !== I.indexOf("WebGL")
        ? (P = parseFloat(/^WebGL (\d)/.exec(I)[1]) >= 1)
        : -1 !== I.indexOf("OpenGL ES") && (P = parseFloat(/^OpenGL ES (\d)/.exec(I)[1]) >= 2);
      let L = null,
        N = {},
      ...
      ((z[e.TEXTURE_2D] = B(e.TEXTURE_2D, e.TEXTURE_2D, 1)),
        (z[e.TEXTURE_CUBE_MAP] = B(e.TEXTURE_CUBE_MAP, e.TEXTURE_CUBE_MAP_POSITIVE_X, 6)),
        ...
        V(e.CULL_FACE),
        W(0));
      let G = { 100: e.FUNC_ADD, 101: e.FUNC_SUBTRACT, 102: e.FUNC_REVERSE_SUBTRACT };
      ...
      function W(t, i, n, r, a, s, o, l, h, c) {
        ...
        if ((!1 === d && (V(e.BLEND), (d = !0)), 5 !== t)) {
          if (t !== p || c !== T) {
            if (((100 !== f || 100 !== _) && (e.blendEquation(e.FUNC_ADD), (f = 100), (_ = 100)), c))
              switch (t) {
                case 1:
            ...
            ((m = null), (g = null), (x = null), (y = null), M.set(0, 0, 0), (S = 0), (p = t), (T = c));
          }
          return;
        }
        ((a = a || i),
          (s = s || n),
          (o = o || r),
          (i !== f || a !== _) && (e.blendEquationSeparate(G[i], G[a]), (f = i), (_ = a)),
          (n !== m || r !== g || s !== x || o !== y) &&
            (e.blendFuncSeparate(H[n], H[r], H[s], H[o]), (m = n), (g = r), (x = s), (y = o)),
          (!1 === l.equals(M) || h !== S) && (e.blendColor(l.r, l.g, l.b, h), M.copy(l), (S = h)),
          (p = t),
          (T = !1));
      }
      function X(t) {
      ...
      function j(t) {
        (0 !== t
          ? (V(e.CULL_FACE),
            t !== E && (1 === t ? e.cullFace(e.BACK) : 2 === t ? e.cullFace(e.FRONT) : e.cullFace(e.FRONT_AND_BACK)))
          : k(e.CULL_FACE),
          (E = t));
      }
      function q(t, i, n) {
        t
          ? (V(e.POLYGON_OFFSET_FILL), (w !== i || R !== n) && (e.polygonOffset(i, n), (w = i), (R = n)))
      ...
      return {
        ...
        setMaterial: function (t, a) {
          ...
          (r.setTest(o),
            ...
            !0 === t.alphaToCoverage ? V(e.SAMPLE_ALPHA_TO_COVERAGE) : k(e.SAMPLE_ALPHA_TO_COVERAGE));
        },
        setFlipSided: X,
        setCullFace: j,
        ...
        activeTexture: function (t) {
          (void 0 === t && (t = e.TEXTURE0 + C - 1), L !== t && (e.activeTexture(t), (L = t)));
        },
        bindTexture: function (t, i, n) {
          void 0 === n && (n = null === L ? e.TEXTURE0 + C - 1 : L);
          let r = N[n];
          (void 0 === r && ((r = { type: void 0, texture: void 0 }), (N[n] = r)),
            (r.type !== t || r.texture !== i) &&
              (L !== n && (e.activeTexture(n), (L = n)), e.bindTexture(t, i || z[t]), (r.type = t), (r.texture = i)));
        },
    ...
    function sM(e, t, i, n, r, a, s) {
      ...
      function b(i, n, r, a, s = !1) {
        if (null !== i) {
          ...
          _("WebGLRenderer: Attempt to use non-existing WebGL internal format '" + i + "'");
        }
        let o = n;
        if (
          (n === e.RED &&
            (r === e.FLOAT && (o = e.R32F), r === e.HALF_FLOAT && (o = e.R16F), r === e.UNSIGNED_BYTE && (o = e.R8)),
          n === e.RED_INTEGER &&
            ...
            r === e.INT && (o = e.R32I)),
          n === e.RG &&
            (r === e.FLOAT && (o = e.RG32F), r === e.HALF_FLOAT && (o = e.RG16F), r === e.UNSIGNED_BYTE && (o = e.RG8)),
          n === e.RG_INTEGER &&
          ...
          let t = s ? h : G.getTransfer(a);
          (r === e.FLOAT && (o = e.RGBA32F),
            r === e.HALF_FLOAT && (o = e.RGBA16F),
            r === e.UNSIGNED_BYTE && (o = t === c ? e.SRGB8_ALPHA8 : e.RGBA8),
            r === e.UNSIGNED_SHORT_4_4_4_4 && (o = e.RGBA4),
            r === e.UNSIGNED_SHORT_5_5_5_1 && (o = e.RGB5_A1));
        }
        return (
          (o === e.R16F || o === e.R32F || o === e.RG16F || o === e.RG32F || o === e.RGBA16F || o === e.RGBA32F) &&
          ...
          t
            ? null === i || 1014 === i || 1020 === i
              ...
              : 1015 === i
                ...
                : 1012 === i &&
                  ((n = e.DEPTH24_STENCIL8),
                  _("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment."))
            : null === i || 1014 === i || 1020 === i
      ...
      function A(e, t) {
        return !0 === S(e) || (e.isFramebufferTexture && 1003 !== e.minFilter && 1006 !== e.minFilter)
        ...
        (t.removeEventListener("dispose", w),
          (function (e) {
            ...
            if (r) {
              ...
              (n.usedTimes--, 0 === n.usedTimes && C(e), 0 === Object.keys(r).length && g.delete(i));
            }
            n.remove(e);
          })(t),
      ...
      function I(t, r) {
        ...
        let o,
          l = n.get(t);
        if (
          (t.isVideoTexture && ((a = t), (o = s.render.frame), m.get(a) !== o && (m.set(a, o), a.update())),
          ...
          if (null === e) _("WebGLRenderer: Texture marked for update but no image data found.");
            ...
            if (!1 !== e.complete) return void z(l, t, r);
      ...
      let L = { 1e3: e.REPEAT, 1001: e.CLAMP_TO_EDGE, 1002: e.MIRRORED_REPEAT },
        D = {
          1003: e.NEAREST,
      ...
      function O(i, a) {
        if (
          ...
          e.texParameteri(i, e.TEXTURE_WRAP_S, L[a.wrapS]),
          e.texParameteri(i, e.TEXTURE_WRAP_T, L[a.wrapT]),
          (i === e.TEXTURE_3D || i === e.TEXTURE_2D_ARRAY) && e.texParameteri(i, e.TEXTURE_WRAP_R, L[a.wrapR]),
          e.texParameteri(i, e.TEXTURE_MAG_FILTER, D[a.magFilter]),
          e.texParameteri(i, e.TEXTURE_MIN_FILTER, D[a.minFilter]),
          a.compareFunction &&
            (e.texParameteri(i, e.TEXTURE_COMPARE_MODE, e.COMPARE_REF_TO_TEXTURE),
            e.texParameteri(i, e.TEXTURE_COMPARE_FUNC, U[a.compareFunction])),
      ...
      function F(t, i) {
        let n,
          r = !1;
        void 0 === t.__webglInit && ((t.__webglInit = !0), i.addEventListener("dispose", w));
        let a = i.source,
          o = g.get(a);
        ...
        let l =
          ...
          n.join());
        if (l !== t.__cacheKey) {
          (void 0 === o[l] && ((o[l] = { texture: e.createTexture(), usedTimes: 0 }), s.memory.textures++, (r = !0)),
            o[l].usedTimes++);
          let n = o[t.__cacheKey];
          (void 0 !== n && (o[t.__cacheKey].usedTimes--, 0 === n.usedTimes && C(i)),
            (t.__cacheKey = l),
      ...
      function z(t, s, o) {
        ...
        if (c.version !== u.__version || !0 === h) {
          ...
          let n = G.getPrimaries(G.workingColorSpace),
            d = "" === s.colorSpace ? null : G.getPrimaries(s.colorSpace),
          ...
          let m = a.convert(s.format, s.colorSpace),
            g = a.convert(s.type),
            v = b(s.internalFormat, m, g, s.colorSpace, s.isVideoTexture);
          O(l, s);
          let x = s.mipmaps,
            ...
            C = A(s, f);
          if (s.isDepthTexture)
            ((v = E(1027 === s.format, s.type)),
              w &&
                (y
                  ? i.texStorage2D(e.TEXTURE_2D, 1, v, f.width, f.height)
                  : i.texImage2D(e.TEXTURE_2D, 0, v, f.width, f.height, 0, m, g, null)));
          else if (s.isDataTexture)
            if (x.length > 0) {
              y && w && i.texStorage2D(e.TEXTURE_2D, C, v, x[0].width, x[0].height);
              for (let n = 0, r = x.length; n < r; n++)
                ((t = x[n]),
                  y
                    ? R && i.texSubImage2D(e.TEXTURE_2D, n, 0, 0, t.width, t.height, m, g, t.data)
                    : i.texImage2D(e.TEXTURE_2D, n, v, t.width, t.height, 0, m, g, t.data));
              s.generateMipmaps = !1;
            } else
              y
                ? (w && i.texStorage2D(e.TEXTURE_2D, C, v, f.width, f.height),
                  R &&
                    (function (t, n, r, a) {
                      ...
                      if (0 === s.length) i.texSubImage2D(e.TEXTURE_2D, 0, 0, 0, n.width, n.height, r, a, n.data);
                        ...
                        for (let e = 1; e < s.length; e++) {
                          let t = s[o],
                            i = s[e],
                            r = t.start + t.count,
                            a = B(i.start, n.width, 4),
                            l = B(t.start, n.width, 4);
                          i.start <= r + 1 && a === l && B(i.start + i.count - 1, n.width, 4) === a
                        ...
                        for (let t = 0, o = s.length; t < o; t++) {
                          ...
                          (e.pixelStorei(e.UNPACK_SKIP_PIXELS, c),
                            ...
                            i.texSubImage2D(e.TEXTURE_2D, 0, c, u, h, 1, r, a, n.data));
                        }
                        (t.clearUpdateRanges(),
                ...
                : i.texImage2D(e.TEXTURE_2D, 0, v, f.width, f.height, 0, m, g, f.data);
          else if (s.isCompressedTexture)
            if (s.isCompressedArrayTexture) {
              y && w && i.texStorage3D(e.TEXTURE_2D_ARRAY, C, v, x[0].width, x[0].height, f.depth);
              for (let n = 0, r = x.length; n < r; n++)
                    ...
                    if (y) {
                      if (R)
                        if (s.layerUpdates.size > 0) {
                          let r = rl(t.width, t.height, s.format, s.type);
                          for (let a of s.layerUpdates) {
                            let s = t.data.subarray(
                              (a * r) / t.data.BYTES_PER_ELEMENT,
                              ((a + 1) * r) / t.data.BYTES_PER_ELEMENT,
                            );
                            i.compressedTexSubImage3D(e.TEXTURE_2D_ARRAY, n, 0, 0, a, t.width, t.height, 1, m, s);
                          }
                          s.clearLayerUpdates();
                        } else
                      ...
                      i.compressedTexImage3D(e.TEXTURE_2D_ARRAY, n, v, t.width, t.height, f.depth, 0, t.data, 0, 0);
                  else _("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");
                else
                  y
                    ? R && i.texSubImage3D(e.TEXTURE_2D_ARRAY, n, 0, 0, 0, t.width, t.height, f.depth, m, g, t.data)
              ...
              for (let n = 0, r = x.length; n < r; n++)
                ((t = x[n]),
                  1023 !== s.format
                    ? null !== m
                      ? y
                        ? R && i.compressedTexSubImage2D(e.TEXTURE_2D, n, 0, 0, t.width, t.height, m, t.data)
                        : i.compressedTexImage2D(e.TEXTURE_2D, n, v, t.width, t.height, 0, t.data)
            ...
            if (y) {
              if ((w && i.texStorage3D(e.TEXTURE_2D_ARRAY, C, v, f.width, f.height, f.depth), R))
                if (s.layerUpdates.size > 0) {
                  let t = rl(f.width, f.height, s.format, s.type);
                  for (let n of s.layerUpdates) {
                    let r = f.data.subarray(
                      (n * t) / f.data.BYTES_PER_ELEMENT,
                      ((n + 1) * t) / f.data.BYTES_PER_ELEMENT,
                    );
                    i.texSubImage3D(e.TEXTURE_2D_ARRAY, 0, 0, 0, n, f.width, f.height, 1, m, g, r);
                  }
                  s.clearLayerUpdates();
                } else i.texSubImage3D(e.TEXTURE_2D_ARRAY, 0, 0, 0, 0, f.width, f.height, f.depth, m, g, f.data);
            } else i.texImage3D(e.TEXTURE_2D_ARRAY, 0, v, f.width, f.height, f.depth, 0, m, g, f.data);
          else if (s.isData3DTexture)
            y
              ? (w && i.texStorage3D(e.TEXTURE_3D, C, v, f.width, f.height, f.depth),
                R && i.texSubImage3D(e.TEXTURE_3D, 0, 0, 0, 0, f.width, f.height, f.depth, m, g, f.data))
              : i.texImage3D(e.TEXTURE_3D, 0, v, f.width, f.height, f.depth, 0, m, g, f.data);
          else if (s.isFramebufferTexture) {
            if (w)
              if (y) i.texStorage2D(e.TEXTURE_2D, C, v, f.width, f.height);
              else {
                let t = f.width,
                  n = f.height;
                for (let r = 0; r < C; r++)
                  (i.texImage2D(e.TEXTURE_2D, r, v, t, n, 0, m, g, null), (t >>= 1), (n >>= 1));
              }
          } else if (x.length > 0) {
            if (y && w) {
              let t = J(x[0]);
            ...
            for (let n = 0, r = x.length; n < r; n++)
              ((t = x[n]),
                y ? R && i.texSubImage2D(e.TEXTURE_2D, n, 0, 0, m, g, t) : i.texImage2D(e.TEXTURE_2D, n, v, m, g, t));
            s.generateMipmaps = !1;
          } else if (y) {
            if (w) {
              let t = J(f);
          ...
          (S(s) && T(l), (u.__version = c.version), s.onUpdate && s.onUpdate(s));
        }
        t.__version = s.version;
      }
      function V(t, r, s, o, l, h) {
        let c = a.convert(s.format, s.colorSpace),
          d = a.convert(s.type),
          p = b(s.internalFormat, c, d, s.colorSpace),
          f = n.get(r),
          m = n.get(s);
        ...
        (i.bindFramebuffer(e.FRAMEBUFFER, t),
          Y(r)
            ? u.framebufferTexture2DMultisampleEXT(e.FRAMEBUFFER, o, l, m.__webglTexture, 0, q(r))
            : (l === e.TEXTURE_2D || (l >= e.TEXTURE_CUBE_MAP_POSITIVE_X && l <= e.TEXTURE_CUBE_MAP_NEGATIVE_Z)) &&
      ...
      function k(t, i, n) {
        if ((e.bindRenderbuffer(e.RENDERBUFFER, t), i.depthBuffer)) {
          ...
          (Y(i)
            ? u.renderbufferStorageMultisampleEXT(e.RENDERBUFFER, q(i), s, i.width, i.height)
            : n
              ? e.renderbufferStorageMultisample(e.RENDERBUFFER, q(i), s, i.width, i.height)
          ...
          for (let r = 0; r < t.length; r++) {
            let s = t[r],
              ...
              l = a.convert(s.type),
              h = b(s.internalFormat, o, l, s.colorSpace);
            Y(i)
              ? u.renderbufferStorageMultisampleEXT(e.RENDERBUFFER, q(i), h, i.width, i.height)
              : n
                ? e.renderbufferStorageMultisample(e.RENDERBUFFER, q(i), h, i.width, i.height)
      ...
      function H(t, r, s) {
        ...
        if ((i.bindFramebuffer(e.FRAMEBUFFER, t), !(r.depthTexture && r.depthTexture.isDepthTexture)))
          throw Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");
        let l = n.get(r.depthTexture);
        if (
          ((l.__renderTarget = r),
          (l.__webglTexture && r.depthTexture.image.width === r.width && r.depthTexture.image.height === r.height) ||
          ...
          if (
            (void 0 === l.__webglInit && ((l.__webglInit = !0), r.depthTexture.addEventListener("dispose", w)),
            ...
            for (let i = 0; i < 6; i++)
              e.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X + i, 0, t, r.width, r.height, 0, n, s, null);
          }
        } else I(r.depthTexture, 0);
        let h = l.__webglTexture,
          c = q(r),
        ...
        if (1026 === r.depthTexture.format)
          Y(r)
            ? u.framebufferTexture2DMultisampleEXT(e.FRAMEBUFFER, p, d, h, 0, c)
            : e.framebufferTexture2D(e.FRAMEBUFFER, p, d, h, 0);
      ...
      function W(t) {
        ...
        if (t.depthTexture && !r.__autoAllocateDepthBuffer)
          if (a) for (let e = 0; e < 6; e++) H(r.__webglFramebuffer[e], t, e);
          else {
          ...
          for (let n = 0; n < 6; n++)
            if ((i.bindFramebuffer(e.FRAMEBUFFER, r.__webglFramebuffer[n]), void 0 === r.__webglDepthbuffer[n]))
              ((r.__webglDepthbuffer[n] = e.createRenderbuffer()), k(r.__webglDepthbuffer[n], t, !1));
            else {
          ...
          if (
            ...
            ((r.__webglDepthbuffer = e.createRenderbuffer()), k(r.__webglDepthbuffer, t, !1));
          else {
            let i = t.stencilBuffer ? e.DEPTH_STENCIL_ATTACHMENT : e.DEPTH_ATTACHMENT,
        ...
        return (
          !0 === e.isCompressedTexture ||
            ...
            (i !== l &&
              ...
              (G.getTransfer(i) === c
                ? (1023 !== n || 1009 !== r) &&
                  _("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType.")
      ...
      function J(e) {
        return (
          "u" > typeof HTMLImageElement && e instanceof HTMLImageElement
            ? ((f.width = e.naturalWidth || e.width), (f.height = e.naturalHeight || e.height))
            : "u" > typeof VideoFrame && e instanceof VideoFrame
              ? ((f.width = e.displayWidth), (f.height = e.displayHeight))
      ...
      ((this.allocateTextureUnit = function () {
        ...
        return (
          e >= r.maxTextures &&
            _("WebGLTextures: Trying to use " + e + " texture units while this GPU supports only " + r.maxTextures),
          (P += 1),
          e
        );
      }),
        ...
        (this.setTextureCube = function (t, s) {
          let o = n.get(t);
          !0 !== t.isCubeDepthTexture && t.version > 0 && o.__version !== t.version
            ? (function (t, s, o) {
                ...
                if (h.version !== c.__version || !0 === l) {
                  ...
                  i.activeTexture(e.TEXTURE0 + o);
                  let n = G.getPrimaries(G.workingColorSpace),
                    u = "" === s.colorSpace ? null : G.getPrimaries(s.colorSpace),
                    d = "" === s.colorSpace || n === u ? e.NONE : e.BROWSER_DEFAULT_WEBGL;
                  (e.pixelStorei(e.UNPACK_FLIP_Y_WEBGL, s.flipY),
                    e.pixelStorei(e.UNPACK_PREMULTIPLY_ALPHA_WEBGL, s.premultiplyAlpha),
                    e.pixelStorei(e.UNPACK_ALIGNMENT, s.unpackAlignment),
                  ...
                  let p = s.isCompressedTexture || s.image[0].isCompressedTexture,
                    ...
                    m = [];
                  for (let e = 0; e < 6; e++)
                    (p || f ? (m[e] = f ? s.image[e].image : s.image[e]) : (m[e] = M(s.image[e], !0, r.maxCubemapSize)),
                      (m[e] = K(s, m[e])));
                  let g = m[0],
                    v = a.convert(s.format, s.colorSpace),
                    x = a.convert(s.type),
                    y = b(s.internalFormat, v, x, s.colorSpace),
                    E = !0 !== s.isVideoTexture,
                    w = void 0 === c.__version || !0 === l,
                    R = h.dataReady,
                    C = A(s, g);
                  if ((O(e.TEXTURE_CUBE_MAP, s), p)) {
                    E && w && i.texStorage2D(e.TEXTURE_CUBE_MAP, C, y, g.width, g.height);
                    for (let n = 0; n < 6; n++) {
                      t = m[n].mipmaps;
                      for (let r = 0; r < t.length; r++) {
                        let a = t[r];
                        1023 !== s.format
                          ...
                          : E
                            ...
                            : i.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X + n, r, y, a.width, a.height, 0, v, x, a.data);
                      }
                    }
                  } else {
                    if (((t = s.mipmaps), E && w)) {
                      t.length > 0 && C++;
                      let n = J(m[0]);
                      i.texStorage2D(e.TEXTURE_CUBE_MAP, C, y, n.width, n.height);
                    }
                    for (let n = 0; n < 6; n++)
                      if (f) {
                        E
                        ...
                        E
                          ? R && i.texSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X + n, 0, 0, 0, v, x, m[n])
                          : i.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X + n, 0, y, v, x, m[n]);
                        for (let r = 0; r < t.length; r++) {
                          let a = t[r];
                          E
                            ? R && i.texSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X + n, r + 1, 0, 0, v, x, a.image[n])
                            : i.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X + n, r + 1, y, v, x, a.image[n]);
                        }
                      }
                  }
                  (S(s) && T(e.TEXTURE_CUBE_MAP), (c.__version = h.version), s.onUpdate && s.onUpdate(s));
                }
                t.__version = s.version;
              })(o, t, s)
        ...
        (this.rebindTextures = function (t, i, r) {
          let a = n.get(t);
          (void 0 !== i && V(a.__webglFramebuffer, t, t.texture, e.COLOR_ATTACHMENT0, e.TEXTURE_2D, 0),
            void 0 !== r && W(t));
        }),
          ...
          if (
            ...
            for (let t = 0; t < 6; t++)
              if (r.mipmaps && r.mipmaps.length > 0) {
                ...
                for (let i = 0; i < r.mipmaps.length; i++) o.__webglFramebuffer[t][i] = e.createFramebuffer();
            ...
            if (t.samples > 0 && !1 === Y(t)) {
              ...
              for (let i = 0; i < h.length; i++) {
                ...
                let r = a.convert(n.format, n.colorSpace),
                  s = a.convert(n.type),
                  l = b(n.internalFormat, r, s, n.colorSpace, !0 === t.isXRRenderTarget),
                  c = q(t);
                (e.renderbufferStorageMultisample(e.RENDERBUFFER, c, l, t.width, t.height),
              ...
              (e.bindRenderbuffer(e.RENDERBUFFER, null),
                t.depthBuffer &&
                  ((o.__webglDepthRenderbuffer = e.createRenderbuffer()), k(o.__webglDepthRenderbuffer, t, !0)),
                i.bindFramebuffer(e.FRAMEBUFFER, null));
            }
          }
          if (c) {
            (i.bindTexture(e.TEXTURE_CUBE_MAP, l.__webglTexture), O(e.TEXTURE_CUBE_MAP, r));
            for (let i = 0; i < 6; i++)
              if (r.mipmaps && r.mipmaps.length > 0)
                for (let n = 0; n < r.mipmaps.length; n++)
                  V(o.__webglFramebuffer[i][n], t, r, e.COLOR_ATTACHMENT0, e.TEXTURE_CUBE_MAP_POSITIVE_X + i, n);
              else V(o.__webglFramebuffer[i], t, r, e.COLOR_ATTACHMENT0, e.TEXTURE_CUBE_MAP_POSITIVE_X + i, 0);
            (S(r) && T(e.TEXTURE_CUBE_MAP), i.unbindTexture());
          } else if (u) {
            for (let r = 0, a = h.length; r < a; r++) {
              ...
              ((t.isWebGL3DRenderTarget || t.isWebGLArrayRenderTarget) &&
                ...
                O(l, a),
                V(o.__webglFramebuffer, t, a, e.COLOR_ATTACHMENT0 + r, l, 0),
                S(a) && T(l));
            }
            i.unbindTexture();
          } else {
            ...
            if (
              ...
              for (let i = 0; i < r.mipmaps.length; i++) V(o.__webglFramebuffer[i], t, r, e.COLOR_ATTACHMENT0, n, i);
            else V(o.__webglFramebuffer, t, r, e.COLOR_ATTACHMENT0, n, 0);
            (S(r) && T(n), i.unbindTexture());
          }
          t.depthBuffer && W(t);
        }),
                ...
                (e.blitFramebuffer(0, 0, a, s, 0, 0, a, s, o, e.NEAREST),
                  !0 === d &&
                    ...
                    t.depthBuffer &&
                      ...
                      (X.push(l), j.push(l), e.invalidateFramebuffer(e.DRAW_FRAMEBUFFER, j)),
                    e.invalidateFramebuffer(e.READ_FRAMEBUFFER, X)));
              }
              if ((i.bindFramebuffer(e.READ_FRAMEBUFFER, null), i.bindFramebuffer(e.DRAW_FRAMEBUFFER, null), c))
                for (let t = 0; t < r.length; t++) {
                  (i.bindFramebuffer(e.FRAMEBUFFER, h.__webglMultisampledFramebuffer),
                    e.framebufferRenderbuffer(
                      e.FRAMEBUFFER,
      ...
      return {
        convert: function (i, n = "") {
          ...
          if (36196 === i || 37492 === i || 37496 === i || 37488 === i || 37489 === i || 37490 === i || 37491 === i) {
            ...
            if (36196 === i || 37492 === i) return a === c ? r.COMPRESSED_SRGB8_ETC2 : r.COMPRESSED_RGB8_ETC2;
            if (37496 === i) return a === c ? r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC : r.COMPRESSED_RGBA8_ETC2_EAC;
          ...
          if (
            ...
            if (37808 === i) return a === c ? r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR : r.COMPRESSED_RGBA_ASTC_4x4_KHR;
            if (37809 === i) return a === c ? r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR : r.COMPRESSED_RGBA_ASTC_5x4_KHR;
            if (37810 === i) return a === c ? r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR : r.COMPRESSED_RGBA_ASTC_5x5_KHR;
            if (37811 === i) return a === c ? r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR : r.COMPRESSED_RGBA_ASTC_6x5_KHR;
            if (37812 === i) return a === c ? r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR : r.COMPRESSED_RGBA_ASTC_6x6_KHR;
            if (37813 === i) return a === c ? r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR : r.COMPRESSED_RGBA_ASTC_8x5_KHR;
            if (37814 === i) return a === c ? r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR : r.COMPRESSED_RGBA_ASTC_8x6_KHR;
            if (37815 === i) return a === c ? r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR : r.COMPRESSED_RGBA_ASTC_8x8_KHR;
            if (37816 === i) return a === c ? r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR : r.COMPRESSED_RGBA_ASTC_10x5_KHR;
            if (37817 === i) return a === c ? r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR : r.COMPRESSED_RGBA_ASTC_10x6_KHR;
            if (37818 === i) return a === c ? r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR : r.COMPRESSED_RGBA_ASTC_10x8_KHR;
            if (37819 === i)
              return a === c ? r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR : r.COMPRESSED_RGBA_ASTC_10x10_KHR;
            if (37820 === i)
              return a === c ? r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR : r.COMPRESSED_RGBA_ASTC_12x10_KHR;
            if (37821 === i)
              return a === c ? r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR : r.COMPRESSED_RGBA_ASTC_12x12_KHR;
          }
          if (36492 === i || 36494 === i || 36495 === i) {
            if (null === (r = t.get("EXT_texture_compression_bptc"))) return null;
            if (36492 === i) return a === c ? r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT : r.COMPRESSED_RGBA_BPTC_UNORM_EXT;
...
void main() {
    ...
    class sE {
      ...
      getMesh(e) {
        if (null !== this.texture && null === this.mesh) {
          ...
          this.mesh = new tH(new nf(20, 20), i);
        }
        return this.mesh;
      }
      reset() {
    ...
    class sA extends M {
      constructor(e, t) {
        ...
        function L(e) {
          ...
          let i = M[t];
          void 0 !== i &&
            (i.update(e.inputSource, e.frame, l || a), i.dispatchEvent({ type: e.type, data: e.inputSource }));
        }
        function D() {
          (n.removeEventListener("select", L),
            n.removeEventListener("selectstart", L),
            n.removeEventListener("selectend", L),
            n.removeEventListener("squeeze", L),
            n.removeEventListener("squeezestart", L),
            n.removeEventListener("squeezeend", L),
            n.removeEventListener("end", D),
            n.removeEventListener("inputsourceschange", O));
          for (let e = 0; e < M.length; e++) {
            let t = S[e];
            null !== t && ((S[e] = null), M[e].disconnect(t));
          }
          for (let e in ((P = null), (I = null), m.reset(), g)) delete g[e];
          (e.setRenderTarget(x),
            (d = null),
            (u = null),
            (c = null),
        ...
        ((this.cameraAutoUpdate = !0),
          ...
          (this.getController = function (e) {
            let t = M[e];
            return (void 0 === t && ((t = new t8()), (M[e] = t)), t.getTargetRaySpace());
          }),
          (this.getControllerGrip = function (e) {
            let t = M[e];
            return (void 0 === t && ((t = new t8()), (M[e] = t)), t.getGripSpace());
          }),
          (this.getHand = function (e) {
            let t = M[e];
            return (void 0 === t && ((t = new t8()), (M[e] = t)), t.getHandSpace());
          }),
          (this.setFramebufferScaleFactor = function (e) {
            ((r = e), !0 === i.isPresenting && _("WebXRManager: Cannot change framebuffer scale while presenting."));
          }),
          (this.setReferenceSpaceType = function (e) {
            ((s = e), !0 === i.isPresenting && _("WebXRManager: Cannot change reference space type while presenting."));
          }),
          ...
          (this.setSession = async function (h) {
            if (null !== (n = h)) {
              if (
                ((x = e.getRenderTarget()),
                n.addEventListener("select", L),
                n.addEventListener("selectstart", L),
                n.addEventListener("selectend", L),
                n.addEventListener("squeeze", L),
                n.addEventListener("squeezestart", L),
                n.addEventListener("squeezeend", L),
                ...
                ((u = (c = this.getBinding()).createProjectionLayer(o)),
                  ...
                  (y = new ee(u.textureWidth, u.textureHeight, {
                    format: 1023,
                    type: 1009,
                    depthTexture: new i3(
                      u.textureWidth,
                ...
                ((d = new XRWebGLLayer(n, t, i)),
                  ...
                  (y = new ee(d.framebufferWidth, d.framebufferHeight, {
                    format: 1023,
                    type: 1009,
                    colorSpace: e.outputColorSpace,
                    stencilBuffer: v.stencil,
        ...
        ((this.updateCamera = function (e) {
          ...
          let a = e.near,
            s = e.far;
          (null !== m.texture && (m.depthNear > 0 && (a = m.depthNear), m.depthFar > 0 && (s = m.depthFar)),
            (C.near = w.near = A.near = a),
            (C.far = w.far = A.far = s),
            (P !== C.near || I !== C.far) &&
              (n.updateRenderState({ depthNear: C.near, depthFar: C.far }), (P = C.near), (I = C.far)),
            (C.layers.mask = 6 | e.layers.mask),
            (A.layers.mask = 3 & C.layers.mask),
            (w.layers.mask = 5 & C.layers.mask));
          let o = e.parent,
            l = C.cameras;
          z(C, o);
          ...
          (2 === l.length
            ...
            null === (r = o)
              ...
              : (t.matrix.copy(r.matrixWorld), t.matrix.invert(), t.matrix.multiply(i.matrixWorld)),
            t.matrix.decompose(t.position, t.quaternion, t.scale),
            t.updateMatrixWorld(!0),
            t.projectionMatrix.copy(i.projectionMatrix),
            t.projectionMatrixInverse.copy(i.projectionMatrixInverse),
            t.isPerspectiveCamera && ((t.fov = 2 * E * Math.atan(1 / t.projectionMatrix.elements[5])), (t.zoom = 1)));
        }),
        ...
        (k.setAnimationLoop(function (t, r) {
          if (((h = r.getViewerPose(l || a)), (p = r), null !== h)) {
            let t = h.views;
            null !== d && (e.setRenderTargetFramebuffer(y, d.framebuffer), e.setRenderTarget(y));
            let r = !1;
            t.length !== C.cameras.length && ((C.cameras.length = 0), (r = !0));
            for (let i = 0; i < t.length; i++) {
              ...
              if (null !== d) a = d.getViewport(n);
                ...
                ((a = t.viewport),
                  0 === i &&
                    (e.setRenderTargetTextures(y, t.colorTexture, t.depthStencilTexture), e.setRenderTarget(y)));
              }
              let s = R[i];
              (void 0 === s && ((s = new t1()).layers.enable(i), (s.viewport = new $()), (R[i] = s)),
                s.matrix.fromArray(n.transform.matrix),
                ...
                0 === i && (C.matrix.copy(s.matrix), C.matrix.decompose(C.position, C.quaternion, C.scale)),
                !0 === r && C.cameras.push(s));
            }
            let a = n.enabledFeatures;
            if (a && a.includes("depth-sensing") && "gpu-optimized" == n.depthUsage && f) {
          ...
          (V && V(t, r), r.detectedPlanes && i.dispatchEvent({ type: "planesdetected", data: r }), (p = null));
        }),
    ...
    function sC(e, t) {
      ...
      function n(e, n) {
        ((e.opacity.value = n.opacity),
          ...
          n.alphaMap && ((e.alphaMap.value = n.alphaMap), i(n.alphaMap, e.alphaMapTransform)),
          n.bumpMap &&
          ...
          n.emissiveMap && ((e.emissiveMap.value = n.emissiveMap), i(n.emissiveMap, e.emissiveMapTransform)),
          n.specularMap && ((e.specularMap.value = n.specularMap), i(n.specularMap, e.specularMapTransform)),
        ...
        (a &&
          ...
          (sw.y *= -1),
          (sw.z *= -1),
          a.isCubeTexture && !1 === a.isRenderTargetTexture && ((sw.y *= -1), (sw.z *= -1)),
          e.envMapRotation.value.setFromMatrix4(sR.makeRotationFromEuler(sw)),
          ...
          n.aoMap &&
            ((e.aoMap.value = n.aoMap), (e.aoMapIntensity.value = n.aoMapIntensity), i(n.aoMap, e.aoMapTransform)));
      }
      return {
        refreshFogUniforms: function (t, i) {
          (i.color.getRGB(t.fogColor.value, tY(e)),
            i.isFog
        ...
        refreshMaterialUniforms: function (e, r, a, s, o) {
          var l, h, c, u, d, p, f, m, g, _, v, x, y, M, S, T, b, E, A, w, R, C, P;
          let I;
          r.isMeshBasicMaterial || r.isMeshLambertMaterial
            ? n(e, r)
            : r.isMeshToonMaterial
              ? (n(e, r), (l = e), (h = r).gradientMap && (l.gradientMap.value = h.gradientMap))
              : r.isMeshPhongMaterial
                ...
                : r.isMeshStandardMaterial
                  ? (n(e, r),
                    ...
                    p.metalnessMap &&
                      ((d.metalnessMap.value = p.metalnessMap), i(p.metalnessMap, d.metalnessMapTransform)),
                    (d.roughness.value = p.roughness),
                    p.roughnessMap &&
                      ((d.roughnessMap.value = p.roughnessMap), i(p.roughnessMap, d.roughnessMapTransform)),
                    ...
                    r.isMeshPhysicalMaterial &&
                      ...
                      (f.ior.value = m.ior),
                      m.sheen > 0 &&
                        (f.sheenColor.value.copy(m.sheenColor).multiplyScalar(m.sheen),
                        (f.sheenRoughness.value = m.sheenRoughness),
                        m.sheenColorMap &&
                          ((f.sheenColorMap.value = m.sheenColorMap), i(m.sheenColorMap, f.sheenColorMapTransform)),
                        m.sheenRoughnessMap &&
                          ((f.sheenRoughnessMap.value = m.sheenRoughnessMap),
                          i(m.sheenRoughnessMap, f.sheenRoughnessMapTransform))),
                      m.clearcoat > 0 &&
                        ((f.clearcoat.value = m.clearcoat),
                        (f.clearcoatRoughness.value = m.clearcoatRoughness),
                        m.clearcoatMap &&
                          ((f.clearcoatMap.value = m.clearcoatMap), i(m.clearcoatMap, f.clearcoatMapTransform)),
                        m.clearcoatRoughnessMap &&
                          ((f.clearcoatRoughnessMap.value = m.clearcoatRoughnessMap),
                          i(m.clearcoatRoughnessMap, f.clearcoatRoughnessMapTransform)),
                        m.clearcoatNormalMap &&
                          ((f.clearcoatNormalMap.value = m.clearcoatNormalMap),
                          i(m.clearcoatNormalMap, f.clearcoatNormalMapTransform),
                      ...
                      m.iridescence > 0 &&
                        ...
                        m.iridescenceMap &&
                          ((f.iridescenceMap.value = m.iridescenceMap), i(m.iridescenceMap, f.iridescenceMapTransform)),
                        m.iridescenceThicknessMap &&
                          ((f.iridescenceThicknessMap.value = m.iridescenceThicknessMap),
                          i(m.iridescenceThicknessMap, f.iridescenceThicknessMapTransform))),
                      m.transmission > 0 &&
                        ...
                        m.thicknessMap &&
                          ((f.thicknessMap.value = m.thicknessMap), i(m.thicknessMap, f.thicknessMapTransform)),
                      ...
                      m.anisotropy > 0 &&
                        ...
                        m.anisotropyMap &&
                          ((f.anisotropyMap.value = m.anisotropyMap), i(m.anisotropyMap, f.anisotropyMapTransform))),
                      ...
                      m.specularIntensityMap &&
                        ((f.specularIntensityMap.value = m.specularIntensityMap),
                        i(m.specularIntensityMap, f.specularIntensityMapTransform))))
                  : r.isMeshMatcapMaterial
                    ? (n(e, r), (_ = e), (v = r).matcap && (_.matcap.value = v.matcap))
                    : r.isMeshDepthMaterial
                      ...
                      : r.isMeshDistanceMaterial
                        ? (n(e, r),
                          ...
                          (y = r),
                          (I = t.get(y).light),
                          x.referencePosition.value.setFromMatrixPosition(I.matrixWorld),
                          (x.nearDistance.value = I.shadow.camera.near),
                          (x.farDistance.value = I.shadow.camera.far))
                        : r.isMeshNormalMaterial
                          ? n(e, r)
                          : r.isLineBasicMaterial
                            ? ((M = e),
                              (S = r),
                              M.diffuse.value.copy(S.color),
                              (M.opacity.value = S.opacity),
                              S.map && ((M.map.value = S.map), i(S.map, M.mapTransform)),
                              r.isLineDashedMaterial &&
                                ((T = e),
                                (b = r),
                                (T.dashSize.value = b.dashSize),
                                (T.totalSize.value = b.dashSize + b.gapSize),
                                (T.scale.value = b.scale)))
                            : r.isPointsMaterial
                              ? ((E = e),
                                (A = r),
                                (w = a),
                                ...
                                (E.size.value = A.size * w),
                                (E.scale.value = 0.5 * R),
                                A.map && ((E.map.value = A.map), i(A.map, E.uvTransform)),
                                A.alphaMap && ((E.alphaMap.value = A.alphaMap), i(A.alphaMap, E.alphaMapTransform)),
                              ...
                              : r.isSpriteMaterial
                                ? ((C = e),
                                  ...
                                  P.map && ((C.map.value = P.map), i(P.map, C.mapTransform)),
                                  P.alphaMap && ((C.alphaMap.value = P.alphaMap), i(P.alphaMap, C.alphaMapTransform)),
                                  P.alphaTest > 0 && (C.alphaTest.value = P.alphaTest))
                                : r.isShadowMaterial
                ...
                : e.isVector4
                  ...
                  : e.isMatrix3
                    ...
                    : e.isMatrix4
                      ...
                      : e.isTexture
                        ? _("WebGLRenderer: Texture samplers can not be part of an uniforms group.")
                        : _("WebGLRenderer: Unsupported uniform value type.", e),
          t
        );
      }
      function h(t) {
                  ...
                  if (
                    ...
                    (function (e, t, i, n) {
                      let r = e.value,
                        a = t + "_" + i;
                      if (void 0 === n[a])
                        return ("number" == typeof r || "boolean" == typeof r ? (n[a] = r) : (n[a] = r.clone()), !0);
                      {
                        let e = n[a];
                    ...
                    for (let a = 0; a < i.length; a++) {
                      ...
                      "number" == typeof s || "boolean" == typeof s
                        ? ((r.__data[0] = s), e.bufferSubData(e.UNIFORM_BUFFER, t + n, r.__data))
                        : s.isMatrix3
                          ? ((r.__data[0] = s.elements[0]),
                            ...
                            (r.__data[11] = 0))
                          : (s.toArray(r.__data, n), (n += o.storage / Float32Array.BYTES_PER_ELEMENT));
                    }
    ...
    let sI = new Uint16Array([
        ...
        14878, 11247, 14859, 10765, 14828, 10401, 14784, 10011, 14727, 9600, 14660, 9289, 14586, 8893, 14508, 8533,
        15111, 12234, 15110, 12234, 15104, 12216, 15092, 12156, 15067, 12010, 15028, 11776, 14981, 11500, 14942, 11205,
        14902, 10752, 14861, 10393, 14812, 9991, 14752, 9570, 14682, 9252, 14603, 8808, 14519, 8445, 14431, 8145, 15209,
        11449, 15208, 11451, 15202, 11451, 15190, 11438, 15163, 11384, 15117, 11274, 15055, 10979, 14994, 10648, 14932,
        10343, 14871, 9936, 14803, 9532, 14729, 9218, 14645, 8742, 14556, 8381, 14461, 8020, 14365, 7603, 15273, 10603,
        15272, 10607, 15267, 10619, 15256, 10631, 15231, 10614, 15182, 10535, 15118, 10389, 15042, 10167, 14963, 9787,
        14883, 9447, 14800, 9115, 14710, 8665, 14615, 8318, 14514, 7911, 14411, 7507, 14279, 7198, 15314, 9675, 15313,
        9683, 15309, 9712, 15298, 9759, 15277, 9797, 15229, 9773, 15166, 9668, 15084, 9487, 14995, 9274, 14898, 8910,
        14800, 8539, 14697, 8234, 14590, 7790, 14479, 7409, 14367, 7067, 14178, 6621, 15337, 8619, 15337, 8631, 15333,
        8677, 15325, 8769, 15305, 8871, 15264, 8940, 15202, 8909, 15119, 8775, 15022, 8565, 14916, 8328, 14804, 8009,
        14688, 7614, 14569, 7287, 14448, 6888, 14321, 6483, 14088, 6171, 15350, 7402, 15350, 7419, 15347, 7480, 15340,
        7613, 15322, 7804, 15287, 7973, 15229, 8057, 15148, 8012, 15046, 7846, 14933, 7611, 14810, 7357, 14682, 7069,
        14552, 6656, 14421, 6316, 14251, 5948, 14007, 5528, 15356, 5942, 15356, 5977, 15353, 6119, 15348, 6294, 15332,
        6551, 15302, 6824, 15249, 7044, 15171, 7122, 15070, 7050, 14949, 6861, 14818, 6611, 14679, 6349, 14538, 6067,
        14398, 5651, 14189, 5311, 13935, 4958, 15359, 4123, 15359, 4153, 15356, 4296, 15353, 4646, 15338, 5160, 15311,
        5508, 15263, 5829, 15188, 6042, 15088, 6094, 14966, 6001, 14826, 5796, 14678, 5543, 14527, 5287, 14377, 4985,
        14133, 4586, 13869, 4257, 15360, 1563, 15360, 1642, 15358, 2076, 15354, 2636, 15341, 3350, 15317, 4019, 15273,
        4429, 15203, 4732, 15105, 4911, 14981, 4932, 14836, 4818, 14679, 4621, 14517, 4386, 14359, 4156, 14083, 3795,
        13808, 3437, 15360, 122, 15360, 137, 15358, 285, 15355, 636, 15344, 1274, 15322, 2177, 15281, 2765, 15215, 3223,
        15120, 3451, 14995, 3569, 14846, 3567, 14681, 3466, 14511, 3305, 14344, 3121, 14037, 2800, 13753, 2467, 15360,
        0, 15360, 1, 15359, 21, 15355, 89, 15346, 253, 15325, 479, 15287, 796, 15225, 1148, 15133, 1492, 15008, 1749,
    ...
    function sN(e, t) {
        ...
        return (console.error("THREE.BufferGeometryUtils.toTrianglesDrawMode(): Unknown draw mode:", t), e);
      {
        ...
        let n = i.count - 2,
          r = [];
        if (2 === t) for (let e = 1; e <= n; e++) (r.push(i.getX(0)), r.push(i.getX(e)), r.push(i.getX(e + 1)));
        else
          for (let e = 0; e < n; e++)
            e % 2 == 0
    ...
    e.s(
      [
        ...
        class {
          constructor(e = {}) {
            let t, i, n, r, a, s, h, c, u, d, p, m, M, S, T, b, E, A, w, R, C, P, I, L, N;
            const {
              canvas: D = f(),
              context: O = null,
              depth: F = !0,
              ...
              outputBufferType: q = 1009,
            } = e;
            if (((this.isWebGLRenderer = !0), null !== O)) {
              if ("u" > typeof WebGLRenderingContext && O instanceof WebGLRenderingContext)
                throw Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");
              t = O.getContextAttributes().alpha;
            } else t = z;
            const Y = new Set([1033, 1031, 1029]),
              K = new Set([1009, 1014, 1012, 1020, 1017, 1018]),
              J = new Uint32Array(4),
              Z = new Int32Array(4);
            let Q = null,
              et = null;
            ...
            const eR = new eP(),
              eC = new U(),
              eI = new $(),
              eL = { background: null, fog: null, environment: null, overrideMaterial: null, isScene: !0 };
            let eN = !1;
            function eD() {
              return null === eh ? ex : 1;
            }
            let eU = O;
            function eO(e, t) {
              return D.getContext(e, t);
            }
            try {
              if (
                ("setAttribute" in D && D.setAttribute("data-engine", "three.js r182"),
                D.addEventListener("webglcontextlost", ez, !1),
                D.addEventListener("webglcontextrestored", eV, !1),
                D.addEventListener("webglcontextcreationerror", ek, !1),
                null === eU)
              ) {
                const e = "webgl2";
                if (
            ...
            function eF() {
              ((i = new rB(eU)).init(),
                ...
                (n = new ry(eU, i, e, I)),
                (r = new sy(eU, i)),
                n.reversedDepthBuffer && j && r.buffers.depth.setReversed(!0),
                (a = new rk(eU)),
                (s = new si()),
                (h = new sM(eU, i, r, s, n, I, a)),
                (c = new rS(ea)),
                (u = new rF(ea)),
                (d = new rc(eU)),
                (L = new rv(eU, d)),
                ...
                (R = new rG(eU, n, h)),
                (E = new rM(s)),
                (M = new st(ea, c, u, i, n, L, E)),
                (S = new sC(ea, s)),
                (T = new ss()),
                (b = new sd(i)),
                (w = new r_(ea, c, u, r, m, t, k)),
                (A = new sv(ea, m, n)),
                (N = new sP(eU, a, n, r)),
                (C = new rx(eU, i, a)),
                (P = new rV(eU, i, a)),
            ...
            (eF(), 1009 !== q && (er = new rX(q, D.width, D.height, F, B)));
            const eB = new sA(ea, eU);
            function ez(e) {
              (e.preventDefault(), g("WebGLRenderer: Context Lost."), (es = !0));
            }
            function eV() {
              (g("WebGLRenderer: Context Restored."), (es = !1));
              let e = a.autoReset,
                t = A.enabled,
                i = A.autoUpdate,
                n = A.needsUpdate,
                r = A.type;
              (eF(), (a.autoReset = e), (A.enabled = t), (A.autoUpdate = i), (A.needsUpdate = n), (A.type = r));
            }
            function ek(e) {
            ...
            ((this.xr = eB),
              ...
              (this.setSize = function (e, t, i = !0) {
                eB.isPresenting
                  ...
                  : ((e_ = e),
                    (ev = t),
                    (D.width = Math.floor(e * ex)),
                    (D.height = Math.floor(t * ex)),
                    !0 === i && ((D.style.width = e + "px"), (D.style.height = t + "px")),
                    null !== er && er.setSize(D.width, D.height),
              ...
              (this.setDrawingBufferSize = function (e, t, i) {
                ((e_ = e),
                  (ev = t),
                  (ex = i),
                  (D.width = Math.floor(e * i)),
                  (D.height = Math.floor(t * i)),
                  this.setViewport(0, 0, e, t));
              }),
              (this.setEffects = function (e) {
                if (1009 === q)
              ...
              (this.setViewport = function (e, t, i, n) {
                (e.isVector4 ? eS.set(e.x, e.y, e.z, e.w) : eS.set(e, t, i, n),
                  r.viewport(ed.copy(eS).multiplyScalar(ex).round()));
              }),
              (this.getScissor = function (e) {
                return e.copy(eT);
              }),
              (this.setScissor = function (e, t, i, n) {
                (e.isVector4 ? eT.set(e.x, e.y, e.z, e.w) : eT.set(e, t, i, n),
                  r.scissor(ep.copy(eT).multiplyScalar(ex).round()));
              }),
                ...
                if (e) {
                  ...
                  if (e) {
                    let e = eh.texture.type,
                      ...
                      s = i.b;
                    t
                      ? ((J[0] = r), (J[1] = a), (J[2] = s), (J[3] = n), eU.clearBufferuiv(eU.COLOR, 0, J))
                      : ((Z[0] = r), (Z[1] = a), (Z[2] = s), (Z[3] = n), eU.clearBufferiv(eU.COLOR, 0, Z));
                  } else n |= eU.COLOR_BUFFER_BIT;
                }
                (t && (n |= eU.DEPTH_BUFFER_BIT),
                  i && ((n |= eU.STENCIL_BUFFER_BIT), this.state.buffers.stencil.setMask(0xffffffff)),
                  eU.clear(n));
              }),
              ...
              (this.dispose = function () {
                (D.removeEventListener("webglcontextlost", ez, !1),
                  D.removeEventListener("webglcontextrestored", eV, !1),
                  D.removeEventListener("webglcontextcreationerror", ek, !1),
                  w.dispose(),
                  T.dispose(),
                  b.dispose(),
                  s.dispose(),
                  ...
                  M.dispose(),
                  eB.dispose(),
                  eB.removeEventListener("sessionstart", eX),
                  eB.removeEventListener("sessionend", ej),
                  eq.stop());
              }),
              (this.renderBufferDirect = function (e, t, a, o, f, m) {
                let g;
                null === t && (t = eL);
                let _ = f.isMesh && 0 > f.matrixWorld.determinant(),
                  v = (function (e, t, i, a, o) {
                    var d, p;
                    (!0 !== t.isScene && (t = eL), h.resetTextureUnits());
                    let f = t.fog,
                      m = a.isMeshStandardMaterial ? t.environment : null,
                      g = null === eh ? ea.outputColorSpace : !0 === eh.isXRRenderTarget ? eh.texture.colorSpace : l,
                      _ = (a.isMeshStandardMaterial ? u : c).get(a.envMap || m),
                      v = !0 === a.vertexColors && !!i.attributes.color && 4 === i.attributes.color.itemSize,
                      x = !!i.attributes.tangent && (!!a.normalMap || a.anisotropy > 0),
                    ...
                    a.version === C.__version
                      ? (C.needsLights && C.lightsStateVersion !== P.state.version) ||
                        ...
                        (o.isBatchedMesh && !1 === C.batching)
                        ? (I = !0)
                        : o.isBatchedMesh || !0 !== C.batching
                          ? (o.isBatchedMesh && !0 === C.batchingColor && null === o.colorTexture) ||
                            (o.isBatchedMesh && !1 === C.batchingColor && null !== o.colorTexture) ||
                            ...
                            : o.isInstancedMesh || !0 !== C.instancing
                              ? o.isSkinnedMesh && !1 === C.skinning
                                ...
                                : o.isSkinnedMesh || !0 !== C.skinning
                                  ? (o.isInstancedMesh && !0 === C.instancingColor && null === o.instanceColor) ||
                                    (o.isInstancedMesh && !1 === C.instancingColor && null !== o.instanceColor) ||
                                    (o.isInstancedMesh && !0 === C.instancingMorph && null === o.morphTexture) ||
                                    (o.isInstancedMesh && !1 === C.instancingMorph && null !== o.morphTexture) ||
                                    C.envMap !== _ ||
                                    (!0 === a.fog && C.fog !== f) ||
                                    ...
                                    C.toneMapping !== b
                                    ? (I = !0)
                                    : C.morphTargetsCount !== w && (I = !0)
                                  : (I = !0)
                              : (I = !0)
                          : (I = !0)
                      : ((I = !0), (C.__version = a.version));
                    let L = C.currentProgram;
                    !0 === I && (L = eQ(a, t, o));
                    let D = !1,
                      U = !1,
                      O = !1,
                      ...
                      B = C.uniforms;
                    if (
                      (r.useProgram(L.program) && ((D = !0), (U = !0), (O = !0)),
                      a.id !== ec && ((ec = a.id), (U = !0)),
                      D || eu !== e)
                    ) {
                      (r.buffers.depth.getReversed() &&
                        ...
                        F.setValue(eU, "projectionMatrix", e.projectionMatrix),
                        F.setValue(eU, "viewMatrix", e.matrixWorldInverse));
                      let t = F.map.cameraPosition;
                      (void 0 !== t && t.setValue(eU, eC.setFromMatrixPosition(e.matrixWorld)),
                        n.logarithmicDepthBuffer &&
                          F.setValue(eU, "logDepthBufFC", 2 / (Math.log(e.far + 1) / Math.LN2)),
                        (a.isMeshPhongMaterial ||
                          ...
                          a.isShaderMaterial) &&
                          F.setValue(eU, "isOrthographic", !0 === e.isOrthographicCamera),
                        eu !== e && ((eu = e), (U = !0), (O = !0)));
                    }
                    if (
                      (C.needsLights &&
                        (P.state.directionalShadowMap.length > 0 &&
                          F.setValue(eU, "directionalShadowMap", P.state.directionalShadowMap, h),
                        P.state.spotShadowMap.length > 0 && F.setValue(eU, "spotShadowMap", P.state.spotShadowMap, h),
                        P.state.pointShadowMap.length > 0 &&
                          F.setValue(eU, "pointShadowMap", P.state.pointShadowMap, h)),
                      o.isSkinnedMesh)
                    ) {
                      (F.setOptional(eU, o, "bindMatrix"), F.setOptional(eU, o, "bindMatrixInverse"));
                      let e = o.skeleton;
                      e &&
                        (null === e.boneTexture && e.computeBoneTexture(),
                        F.setValue(eU, "boneTexture", e.boneTexture, h));
                    }
                    o.isBatchedMesh &&
                      (F.setOptional(eU, o, "batchingTexture"),
                      F.setValue(eU, "batchingTexture", o._matricesTexture, h),
                      F.setOptional(eU, o, "batchingIdTexture"),
                      F.setValue(eU, "batchingIdTexture", o._indirectTexture, h),
                      F.setOptional(eU, o, "batchingColorTexture"),
                      null !== o._colorsTexture && F.setValue(eU, "batchingColorTexture", o._colorsTexture, h));
                    let z = i.morphAttributes;
                    if (
                      ((void 0 !== z.position || void 0 !== z.normal || void 0 !== z.color) && R.update(o, i, L),
                      (U || C.receiveShadow !== o.receiveShadow) &&
                        ((C.receiveShadow = o.receiveShadow), F.setValue(eU, "receiveShadow", o.receiveShadow)),
                      a.isMeshGouraudMaterial &&
                        null !== a.envMap &&
                        ((B.envMap.value = _),
                        (B.flipEnvMap.value = _.isCubeTexture && !1 === _.isRenderTargetTexture ? -1 : 1)),
                      a.isMeshStandardMaterial &&
                        null === a.envMap &&
                        null !== t.environment &&
                      ...
                      void 0 !== B.dfgLUT &&
                        (B.dfgLUT.value =
                          (null === sL &&
                            (((sL = new ip(sI, 16, 16, 1030, 1016)).name = "DFG_LUT"),
                            (sL.minFilter = 1006),
                            (sL.magFilter = 1006),
                            (sL.wrapS = 1001),
                            (sL.wrapT = 1001),
                            (sL.generateMipmaps = !1),
                            (sL.needsUpdate = !0)),
                          sL)),
                      U &&
                        (F.setValue(eU, "toneMappingExposure", ea.toneMappingExposure),
                        C.needsLights &&
                          ((d = B),
                          (p = O),
                        ...
                        S.refreshMaterialUniforms(B, a, ex, ev, et.state.transmissionRenderTarget[e.id]),
                        az.upload(eU, e0(C), B, h)),
                      a.isShaderMaterial &&
                        !0 === a.uniformsNeedUpdate &&
                        (az.upload(eU, e0(C), B, h), (a.uniformsNeedUpdate = !1)),
                      a.isSpriteMaterial && F.setValue(eU, "center", o.center),
                      F.setValue(eU, "modelViewMatrix", o.modelViewMatrix),
                      F.setValue(eU, "normalMatrix", o.normalMatrix),
                      F.setValue(eU, "modelMatrix", o.matrixWorld),
                      a.isShaderMaterial || a.isRawShaderMaterial)
                    ) {
                      let e = a.uniformsGroups;
                      for (let t = 0, i = e.length; t < i; t++) {
                        let i = e[t];
                        (N.update(i, L), N.bind(i, L));
                      }
                    }
                    return L;
                  })(e, t, a, o, f);
                ...
                let y = a.index,
                  M = 1;
                if (!0 === o.wireframe) {
                  if (void 0 === (y = p.getWireframeAttribute(a))) return;
                  M = 2;
                }
                let T = a.drawRange,
                  ...
                  A = T.start * M,
                  w = (T.start + T.count) * M;
                (null !== m && ((A = Math.max(A, m.start * M)), (w = Math.min(w, (m.start + m.count) * M))),
                  null !== y
                    ? ((A = Math.max(A, 0)), (w = Math.min(w, y.count)))
                    : null != b && ((A = Math.max(A, 0)), (w = Math.min(w, b.count))));
                let I = w - A;
                if (I < 0 || I === 1 / 0) return;
                L.setup(f, o, v, a, y);
                let D = C;
                if ((null !== y && ((g = d.get(y)), (D = P).setIndex(g)), f.isMesh))
                  !0 === o.wireframe
                    ? (r.setLineWidth(o.wireframeLinewidth * eD()), D.setMode(eU.LINES))
                    : D.setMode(eU.TRIANGLES);
                else if (f.isLine) {
                  let e = o.linewidth;
                  (void 0 === e && (e = 1),
                    r.setLineWidth(e * eD()),
                    f.isLineSegments
                      ? D.setMode(eU.LINES)
                      : f.isLineLoop
                        ? D.setMode(eU.LINE_LOOP)
                        : D.setMode(eU.LINE_STRIP));
                } else f.isPoints ? D.setMode(eU.POINTS) : f.isSprite && D.setMode(eU.TRIANGLES);
                if (f.isBatchedMesh)
                  if (null !== f._multiDrawInstances)
                    (x(
                      "WebGLRenderer: renderMultiDrawInstances has been deprecated and will be removed in r184. Append to renderMultiDraw arguments and use indirection.",
                    ),
                      D.renderMultiDrawInstances(
                        f._multiDrawStarts,
                        f._multiDrawCounts,
                        f._multiDrawCount,
                    ...
                    D.renderMultiDraw(f._multiDrawStarts, f._multiDrawCounts, f._multiDrawCount);
                  else {
                    let e = f._multiDrawStarts,
                      t = f._multiDrawCounts,
                      i = f._multiDrawCount,
                      n = y ? d.get(y).bytesPerElement : 1,
                      r = s.get(o).currentProgram.getUniforms();
                    for (let a = 0; a < i; a++) (r.setValue(eU, "_gl_DrawID", a), D.render(e[a] / n, t[a]));
                  }
                else if (f.isInstancedMesh) D.renderInstances(A, I, f.count);
                else if (a.isInstancedBufferGeometry) {
                  let e = void 0 !== a._maxInstanceCount ? a._maxInstanceCount : 1 / 0,
                    t = Math.min(a.instanceCount, e);
                  D.renderInstances(A, I, t);
                } else D.render(A, I);
              }),
              ...
              if (e.layers.test(t.layers)) {
                if (e.isGroup) i = e.renderOrder;
                  ...
                  if (!e.frustumCulled || eE.intersectsSprite(e)) {
                    n && eI.setFromMatrixPosition(e.matrixWorld).applyMatrix4(eR);
                    let t = m.update(e),
                      r = e.material;
                    r.visible && Q.push(e, t, r, i, eI.z, null);
                  }
                  ...
                  if (
                    (n &&
                      (void 0 !== e.boundingSphere
                        ? (null === e.boundingSphere && e.computeBoundingSphere(), eI.copy(e.boundingSphere.center))
                        : (null === t.boundingSphere && t.computeBoundingSphere(), eI.copy(t.boundingSphere.center)),
                      eI.applyMatrix4(e.matrixWorld).applyMatrix4(eR)),
                    Array.isArray(r))
                  ) {
                    let n = t.groups;
                    for (let a = 0, s = n.length; a < s; a++) {
                      let s = n[a],
                        o = r[s.materialIndex];
                      o && o.visible && Q.push(e, t, o, i, eI.z, s);
                    }
                  } else r.visible && Q.push(e, t, r, i, eI.z, null);
                }
              }
              let r = e.children;
              for (let e = 0, a = r.length; e < a; e++) eY(r[e], t, i, n);
            }
            function eK(e, t, i, n) {
              let { opaque: a, transmissive: s, transparent: o } = e;
              (et.setupLightsView(i),
                !0 === eA && E.setGlobalState(ea.clippingPlanes, i),
                n && r.viewport(ed.copy(n)),
                a.length > 0 && eZ(a, t, i),
                s.length > 0 && eZ(s, t, i),
                o.length > 0 && eZ(o, t, i),
            ...
            function eJ(e, t, r, a) {
              ...
              if (void 0 === et.state.transmissionRenderTarget[a.id]) {
                ...
                et.state.transmissionRenderTarget[a.id] = new ee(1, 1, {
                  generateMipmaps: !0,
                  type: e ? 1016 : 1009,
                  minFilter: 1008,
                  samples: n.samples,
              ...
              if (
                ...
                !0 === eA && E.setGlobalState(ea.clippingPlanes, a),
                eZ(e, r, a),
                h.updateMultisampleRenderTarget(s),
                h.updateRenderTargetMipmap(s),
              ...
              (ea.setRenderTarget(l, c, u),
                ea.setClearColor(em, eg),
            ...
            function eQ(e, t, i) {
              ...
              ((r.environment = e.isMeshStandardMaterial ? t.environment : null),
                (r.fog = t.fog),
                (r.envMap = (e.isMeshStandardMaterial ? u : c).get(e.envMap || r.environment)),
                (r.envMapRotation =
                  null !== r.environment && null === e.envMap ? t.environmentRotation : e.envMapRotation),
                void 0 === p && (e.addEventListener("dispose", eG), (r.programs = p = new Map())));
              let f = p.get(d);
              if (void 0 !== f) {
                if (r.currentProgram === f && r.lightsStateVersion === l) return (e1(e, h), f);
              } else
                ((h.uniforms = M.getUniforms(e)),
                  e.onBeforeCompile(h, ea),
                  (f = M.acquireProgram(h, d)),
                  p.set(d, f),
                  (r.uniforms = h.uniforms));
              let m = r.uniforms;
              return (
                ((e.isShaderMaterial || e.isRawShaderMaterial) && !0 !== e.clipping) || (m.clippingPlanes = E.uniform),
                e1(e, h),
                (r.needsLights =
            ...
            function e0(e) {
              if (null === e.uniformsList) {
                ...
                e.uniformsList = az.seqWithValue(t.seq, e.uniforms);
              }
            ...
            (eq.setAnimationLoop(function (e) {
              ...
              "u" > typeof self && eq.setContext(self),
              (this.setAnimationLoop = function (e) {
                ((eW = e), eB.setAnimationLoop(e), null === e ? eq.stop() : eq.start());
              }),
              eB.addEventListener("sessionstart", eX),
              eB.addEventListener("sessionend", ej),
              (this.render = function (e, t) {
                if (void 0 !== t && !0 !== t.isCamera)
                  return void v("WebGLRenderer.render: camera is not an instance of THREE.Camera.");
                if (!0 === es) return;
                let i = !0 === eB.enabled && !0 === eB.isPresenting,
                  n = null !== er && (null === eh || i) && er.begin(ea, eh);
                if (
                  (!0 === e.matrixWorldAutoUpdate && e.updateMatrixWorld(),
                  null === t.parent && !0 === t.matrixWorldAutoUpdate && t.updateMatrixWorld(),
                  !0 === eB.enabled &&
                    !0 === eB.isPresenting &&
                    (null === er || !1 === er.isCompositing()) &&
                    (!0 === eB.cameraAutoUpdate && eB.updateCamera(t), (t = eB.getCamera())),
                  !0 === e.isScene && e.onBeforeRender(ea, e, t, eh),
                  (et = b.get(e, en.length)).init(t),
                  en.push(et),
                  eR.multiplyMatrices(t.projectionMatrix, t.matrixWorldInverse),
                  eE.setFromProjectionMatrix(eR, 2e3, t.reversedDepth),
                  (ew = this.localClippingEnabled),
                  (eA = E.init(this.clippingPlanes, ew)),
                  (Q = T.get(e, ei.length)).init(),
                  ei.push(Q),
                  !0 === eB.enabled && !0 === eB.isPresenting)
                ) {
                  let e = ea.xr.getDepthSensingMesh();
                  null !== e && eY(e, t, -1 / 0, ea.sortObjects);
                }
                (eY(e, t, 0, ea.sortObjects),
                  Q.finish(),
                  !0 === ea.sortObjects && Q.sort(ey, eM),
                  (eN = !1 === eB.enabled || !1 === eB.isPresenting || !1 === eB.hasDepthSensing()) &&
                    w.addToRenderList(Q, e),
                ...
                if (
                  ...
                  !1 === (n && er.hasRenderPass()))
                ) {
                  let i = Q.opaque,
                    n = Q.transmissive;
                  if ((et.setupLights(), t.isArrayCamera)) {
                    let r = t.cameras;
                    if (n.length > 0) for (let t = 0, a = r.length; t < a; t++) eJ(i, n, e, r[t]);
                    eN && w.render(e);
                    for (let t = 0, i = r.length; t < i; t++) {
                      let i = r[t];
                      eK(Q, e, i, i.viewport);
                    }
                  } else (n.length > 0 && eJ(i, n, e, t), eN && w.render(e), eK(Q, e, t));
                }
                (null !== eh && 0 === el && (h.updateMultisampleRenderTarget(eh), h.updateRenderTargetMipmap(eh)),
                  n && er.end(ea),
                  !0 === e.isScene && e.onAfterRender(ea, e, t),
                  L.resetDefaultState(),
                  (ec = -1),
                  (eu = null),
                  en.pop(),
                  en.length > 0
                    ? ((et = en[en.length - 1]), !0 === eA && E.setGlobalState(ea.clippingPlanes, et.state.camera))
                    : (et = null),
                  ei.pop(),
                  (Q = ei.length > 0 ? ei[ei.length - 1] : null));
              }),
              ...
              (this.setRenderTargetTextures = function (e, t, i) {
                ...
                ((n.__autoAllocateDepthBuffer = !1 === e.resolveDepthBuffer),
                  !1 === n.__autoAllocateDepthBuffer && (n.__useRenderToTexture = !1),
                  (s.get(e.texture).__webglTexture = t),
                  (s.get(e.depthTexture).__webglTexture = n.__autoAllocateDepthBuffer ? void 0 : i),
            ...
            ((this.setRenderTarget = function (e, t = 0, i = 0) {
              ...
              if (e) {
                let l = s.get(e);
                if (void 0 !== l.__useDefaultFramebuffer) {
                  (r.bindFramebuffer(eU.FRAMEBUFFER, l.__webglFramebuffer),
                    ed.copy(e.viewport),
                    ep.copy(e.scissor),
                    (ef = e.scissorTest),
                    r.viewport(ed),
                ...
                if (void 0 === l.__webglFramebuffer) h.setupRenderTarget(e);
                else if (l.__hasExternalTextures)
                  h.rebindTextures(e, s.get(e.texture).__webglTexture, s.get(e.depthTexture).__webglTexture);
                else if (e.depthBuffer) {
                  let t = e.depthTexture;
                  if (l.__boundDepthTexture !== t) {
                ...
                (e.isWebGLCubeRenderTarget
                  ...
                  ep.copy(e.scissor),
                  (ef = e.scissorTest));
              } else (ed.copy(eS).multiplyScalar(ex).floor(), ep.copy(eT).multiplyScalar(ex).floor(), (ef = eb));
              if (
                (0 !== i && (n = e3),
                r.bindFramebuffer(eU.FRAMEBUFFER, n) && r.drawBuffers(e, n),
                r.viewport(ed),
                r.scissor(ep),
                r.setScissorTest(ef),
                a)
                ...
                eU.framebufferTexture2D(
                  eU.FRAMEBUFFER,
                  eU.COLOR_ATTACHMENT0,
                  eU.TEXTURE_CUBE_MAP_POSITIVE_X + t,
                  n.__webglTexture,
                  i,
                );
              } else if (o)
                for (let n = 0; n < e.textures.length; n++) {
                  ...
                  eU.framebufferTextureLayer(eU.FRAMEBUFFER, eU.COLOR_ATTACHMENT0 + n, r.__webglTexture, i, t);
                }
              else if (null !== e && 0 !== i) {
                let t = s.get(e.texture);
                eU.framebufferTexture2D(eU.FRAMEBUFFER, eU.COLOR_ATTACHMENT0, eU.TEXTURE_2D, t.__webglTexture, i);
              }
              ec = -1;
            }),
              (this.readRenderTargetPixels = function (e, t, i, a, o, l, h, c = 0) {
                ...
                if ((e.isWebGLCubeRenderTarget && void 0 !== h && (u = u[h]), u)) {
                  r.bindFramebuffer(eU.FRAMEBUFFER, u);
                  try {
                    let r = e.textures[c],
                      s = r.format,
                      h = r.type;
                    ...
                    t >= 0 &&
                      ...
                      i >= 0 &&
                      i <= e.height - o &&
                      (e.textures.length > 1 && eU.readBuffer(eU.COLOR_ATTACHMENT0 + c),
                      eU.readPixels(t, i, a, o, I.convert(s), I.convert(h), l));
                  } finally {
                    let e = null !== eh ? s.get(eh).__webglFramebuffer : null;
                    r.bindFramebuffer(eU.FRAMEBUFFER, e);
                  }
                }
              }),
              (this.readRenderTargetPixelsAsync = async function (e, t, i, a, o, l, h, c = 0) {
                if (!(e && e.isWebGLRenderTarget))
                  throw Error(
                ...
                if ((e.isWebGLCubeRenderTarget && void 0 !== h && (u = u[h]), u))
                  if (t >= 0 && t <= e.width - a && i >= 0 && i <= e.height - o) {
                    ...
                    let f = eU.createBuffer();
                    (eU.bindBuffer(eU.PIXEL_PACK_BUFFER, f),
                      eU.bufferData(eU.PIXEL_PACK_BUFFER, l.byteLength, eU.STREAM_READ),
                      e.textures.length > 1 && eU.readBuffer(eU.COLOR_ATTACHMENT0 + c),
                      eU.readPixels(t, i, a, o, I.convert(d), I.convert(p), 0));
                    let m = null !== eh ? s.get(eh).__webglFramebuffer : null;
                    r.bindFramebuffer(eU.FRAMEBUFFER, m);
                    let g = eU.fenceSync(eU.SYNC_GPU_COMMANDS_COMPLETE, 0);
                    return (
                      eU.flush(),
                      await y(eU, g, 4),
                      eU.bindBuffer(eU.PIXEL_PACK_BUFFER, f),
              ...
              (this.copyFramebufferToTexture = function (e, t = null, i = 0) {
                let n = Math.pow(2, -i),
                  ...
                  o = null !== t ? t.x : 0,
                  l = null !== t ? t.y : 0;
                (h.setTexture2D(e, 0), eU.copyTexSubImage2D(eU.TEXTURE_2D, i, 0, 0, o, l, a, s), r.unbindTexture());
              }));
            const e2 = eU.createFramebuffer(),
              e4 = eU.createFramebuffer();
            ((this.copyTextureToTexture = function (e, t, i = null, n = null, a = 0, o = null) {
              let l, c, u, d, p, f, m, g, _, v;
              null === o &&
                (0 !== a
                  ? (x(
                    ...
                    (a = 0))
                  : (o = 0));
              let y = e.isCompressedTexture ? e.mipmaps[o] : e.image;
              if (null !== i)
                ((l = i.max.x - i.min.x),
                  (c = i.max.y - i.min.y),
                ...
                let t = Math.pow(2, -a);
                ((l = Math.floor(y.width * t)),
                  (c = Math.floor(y.height * t)),
                  (u = e.isDataArrayTexture ? y.depth : e.isData3DTexture ? Math.floor(y.depth * t) : 1),
                  (d = 0),
                  (p = 0),
                  (f = 0));
              }
              null !== n ? ((m = n.x), (g = n.y), (_ = n.z)) : ((m = 0), (g = 0), (_ = 0));
              let M = I.convert(t.format),
                S = I.convert(t.type);
              (t.isData3DTexture
                ? (h.setTexture3D(t, 0), (v = eU.TEXTURE_3D))
                : t.isDataArrayTexture || t.isCompressedArrayTexture
                  ? (h.setTexture2DArray(t, 0), (v = eU.TEXTURE_2D_ARRAY))
                  : (h.setTexture2D(t, 0), (v = eU.TEXTURE_2D)),
                eU.pixelStorei(eU.UNPACK_FLIP_Y_WEBGL, t.flipY),
                eU.pixelStorei(eU.UNPACK_PREMULTIPLY_ALPHA_WEBGL, t.premultiplyAlpha),
                eU.pixelStorei(eU.UNPACK_ALIGNMENT, t.unpackAlignment));
              let T = eU.getParameter(eU.UNPACK_ROW_LENGTH),
                b = eU.getParameter(eU.UNPACK_IMAGE_HEIGHT),
                E = eU.getParameter(eU.UNPACK_SKIP_PIXELS),
                A = eU.getParameter(eU.UNPACK_SKIP_ROWS),
                w = eU.getParameter(eU.UNPACK_SKIP_IMAGES);
              (eU.pixelStorei(eU.UNPACK_ROW_LENGTH, y.width),
                eU.pixelStorei(eU.UNPACK_IMAGE_HEIGHT, y.height),
                eU.pixelStorei(eU.UNPACK_SKIP_PIXELS, d),
                eU.pixelStorei(eU.UNPACK_SKIP_ROWS, p),
                eU.pixelStorei(eU.UNPACK_SKIP_IMAGES, f));
              let R = e.isDataArrayTexture || e.isData3DTexture,
                C = t.isDataArrayTexture || t.isData3DTexture;
              if (e.isDepthTexture) {
                let i = s.get(e),
                  n = s.get(t),
                  h = s.get(i.__renderTarget),
                  v = s.get(n.__renderTarget);
                (r.bindFramebuffer(eU.READ_FRAMEBUFFER, h.__webglFramebuffer),
                  r.bindFramebuffer(eU.DRAW_FRAMEBUFFER, v.__webglFramebuffer));
                for (let i = 0; i < u; i++)
                  (R &&
                    (eU.framebufferTextureLayer(
                      eU.READ_FRAMEBUFFER,
                      eU.COLOR_ATTACHMENT0,
                    ...
                    eU.blitFramebuffer(d, p, l, c, m, g, l, c, eU.DEPTH_BUFFER_BIT, eU.NEAREST));
                ...
                let i = s.get(e),
                  n = s.get(t);
                (r.bindFramebuffer(eU.READ_FRAMEBUFFER, e2), r.bindFramebuffer(eU.DRAW_FRAMEBUFFER, e4));
                for (let e = 0; e < u; e++)
                  (R
                    ? eU.framebufferTextureLayer(eU.READ_FRAMEBUFFER, eU.COLOR_ATTACHMENT0, i.__webglTexture, a, f + e)
                    : eU.framebufferTexture2D(
                        eU.READ_FRAMEBUFFER,
                        eU.COLOR_ATTACHMENT0,
                        eU.TEXTURE_2D,
                    ...
                    0 !== a
                      ? eU.blitFramebuffer(d, p, l, c, m, g, l, c, eU.COLOR_BUFFER_BIT, eU.NEAREST)
                      : C
                        ? eU.copyTexSubImage3D(v, o, m, g, _ + e, d, p, l, c)
                        : eU.copyTexSubImage2D(v, o, m, g, d, p, l, c));
                (r.bindFramebuffer(eU.READ_FRAMEBUFFER, null), r.bindFramebuffer(eU.DRAW_FRAMEBUFFER, null));
              } else
                C
                  ? e.isDataTexture || e.isData3DTexture
                    ? eU.texSubImage3D(v, o, m, g, _, l, c, u, M, S, y.data)
                    : t.isCompressedArrayTexture
                      ? eU.compressedTexSubImage3D(v, o, m, g, _, l, c, u, M, y.data)
                      : eU.texSubImage3D(v, o, m, g, _, l, c, u, M, S, y)
                  : e.isDataTexture
                    ? eU.texSubImage2D(eU.TEXTURE_2D, o, m, g, l, c, M, S, y.data)
                    : e.isCompressedTexture
                      ? eU.compressedTexSubImage2D(eU.TEXTURE_2D, o, m, g, y.width, y.height, M, y.data)
                      : eU.texSubImage2D(eU.TEXTURE_2D, o, m, g, l, c, M, S, y);
              (eU.pixelStorei(eU.UNPACK_ROW_LENGTH, T),
                eU.pixelStorei(eU.UNPACK_IMAGE_HEIGHT, b),
                eU.pixelStorei(eU.UNPACK_SKIP_PIXELS, E),
                eU.pixelStorei(eU.UNPACK_SKIP_ROWS, A),
                eU.pixelStorei(eU.UNPACK_SKIP_IMAGES, w),
                0 === o && t.generateMipmaps && eU.generateMipmap(v),
                r.unbindTexture());
            }),
              (this.initRenderTarget = function (e) {
                void 0 === s.get(e).__webglFramebuffer && h.setupRenderTarget(e);
              }),
              ...
              (this.resetState = function () {
                ((eo = 0), (el = 0), (eh = null), r.reset(), L.reset());
              }),
              "u" > typeof __THREE_DEVTOOLS__ &&
                __THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe", { detail: this })));
          }
          ...
          set outputColorSpace(e) {
            ...
            ((t.drawingBufferColorSpace = G._getDrawingBufferColorSpace(e)),
              (t.unpackColorSpace = G._getUnpackColorSpace()));
          }
        },
      ],
      408560,
    );
    let sU = "KHR_binary_glTF",
      sO = "KHR_draco_mesh_compression",
      sF = "KHR_lights_punctual",
      sB = "KHR_materials_clearcoat",
      sz = "KHR_materials_dispersion",
      sV = "KHR_materials_ior",
      sk = "KHR_materials_sheen",
      sG = "KHR_materials_specular",
      sH = "KHR_materials_transmission",
      sW = "KHR_materials_iridescence",
      sX = "KHR_materials_anisotropy",
      sj = "KHR_materials_unlit",
      sq = "KHR_materials_volume",
      sY = "KHR_texture_basisu",
      sK = "KHR_texture_transform",
      sJ = "KHR_mesh_quantization",
      sZ = "KHR_materials_emissive_strength",
      s$ = "EXT_materials_bump",
      sQ = "EXT_texture_webp",
      s0 = "EXT_texture_avif",
      s1 = "EXT_meshopt_compression",
      s3 = "EXT_mesh_gpu_instancing";
    class s2 {
      constructor(e) {
        ((this.parser = e), (this.name = sF), (this.cache = { refs: {}, uses: {} }));
      }
      _markDefs() {
        let e = this.parser,
      ...
      _loadLight(e) {
        ...
        let a = i.json,
          ...
          o = new td(0xffffff);
        void 0 !== s.color && o.setRGB(s.color[0], s.color[1], s.color[2], l);
        let h = void 0 !== s.range ? s.range : 0;
        switch (s.type) {
          case "directional":
            ((t = new n2(o)).target.position.set(0, 0, -1), t.add(t.target));
            break;
          case "point":
            (t = new n0(o)).distance = h;
            break;
          case "spot":
            (((t = new n$(o)).distance = h),
              (s.spot = s.spot || {}),
    ...
    class s4 {
      ...
      extendParams(e, t, i) {
        let n = [];
        ((e.color = new td(1, 1, 1)), (e.opacity = 1));
        ...
        if (r) {
          ...
          void 0 !== r.baseColorTexture && n.push(i.assignTexture(e, "map", r.baseColorTexture, o));
        }
    ...
    class s6 {
      constructor(e) {
        ((this.parser = e), (this.name = sB));
      }
      getMaterialType(e) {
        let t = this.parser.json.materials[e];
        return t.extensions && t.extensions[this.name] ? nv : null;
      }
      extendMaterialParams(e, t) {
        let i = this.parser,
        ...
        if (
          ...
          void 0 !== a.clearcoatTexture && r.push(i.assignTexture(t, "clearcoatMap", a.clearcoatTexture)),
          void 0 !== a.clearcoatRoughnessFactor && (t.clearcoatRoughness = a.clearcoatRoughnessFactor),
          void 0 !== a.clearcoatRoughnessTexture &&
            r.push(i.assignTexture(t, "clearcoatRoughnessMap", a.clearcoatRoughnessTexture)),
          void 0 !== a.clearcoatNormalTexture &&
            (r.push(i.assignTexture(t, "clearcoatNormalMap", a.clearcoatNormalTexture)),
    ...
    class s9 {
      ...
      extendMaterialParams(e, t) {
        ...
        return (
          ...
          void 0 !== a.iridescenceTexture && r.push(i.assignTexture(t, "iridescenceMap", a.iridescenceTexture)),
          ...
          void 0 !== a.iridescenceThicknessTexture &&
            r.push(i.assignTexture(t, "iridescenceThicknessMap", a.iridescenceThicknessTexture)),
          Promise.all(r)
        );
      }
    }
    class s7 {
      ...
      extendMaterialParams(e, t) {
        ...
        if (!n.extensions || !n.extensions[this.name]) return Promise.resolve();
        let r = [];
        ((t.sheenColor = new td(0, 0, 0)), (t.sheenRoughness = 0), (t.sheen = 1));
        ...
        return (
          ...
          void 0 !== a.sheenColorTexture && r.push(i.assignTexture(t, "sheenColorMap", a.sheenColorTexture, o)),
          void 0 !== a.sheenRoughnessTexture &&
            r.push(i.assignTexture(t, "sheenRoughnessMap", a.sheenRoughnessTexture)),
          Promise.all(r)
        );
      }
    }
    class oe {
      ...
      extendMaterialParams(e, t) {
        ...
        return (
          ...
          void 0 !== a.transmissionTexture && r.push(i.assignTexture(t, "transmissionMap", a.transmissionTexture)),
          Promise.all(r)
        );
      }
    }
    class ot {
      ...
      extendMaterialParams(e, t) {
        ...
        ((t.thickness = void 0 !== a.thicknessFactor ? a.thicknessFactor : 0),
          void 0 !== a.thicknessTexture && r.push(i.assignTexture(t, "thicknessMap", a.thicknessTexture)),
          (t.attenuationDistance = a.attenuationDistance || 1 / 0));
        let s = a.attenuationColor || [1, 1, 1];
        return ((t.attenuationColor = new td().setRGB(s[0], s[1], s[2], l)), Promise.all(r));
      }
    }
    class oi {
      constructor(e) {
        ((this.parser = e), (this.name = sV));
      }
      getMaterialType(e) {
        let t = this.parser.json.materials[e];
        return t.extensions && t.extensions[this.name] ? nv : null;
    ...
    class on {
      ...
      extendMaterialParams(e, t) {
        ...
        ((t.specularIntensity = void 0 !== a.specularFactor ? a.specularFactor : 1),
          void 0 !== a.specularTexture && r.push(i.assignTexture(t, "specularIntensityMap", a.specularTexture)));
        let s = a.specularColorFactor || [1, 1, 1];
        return (
          (t.specularColor = new td().setRGB(s[0], s[1], s[2], l)),
          void 0 !== a.specularColorTexture &&
            r.push(i.assignTexture(t, "specularColorMap", a.specularColorTexture, o)),
          Promise.all(r)
        );
      }
    }
    class or {
      ...
      extendMaterialParams(e, t) {
        ...
        return (
          ...
          void 0 !== a.bumpTexture && r.push(i.assignTexture(t, "bumpMap", a.bumpTexture)),
          Promise.all(r)
        );
      }
    }
    class oa {
      ...
      extendMaterialParams(e, t) {
        ...
        return (
          ...
          void 0 !== a.anisotropyTexture && r.push(i.assignTexture(t, "anisotropyMap", a.anisotropyTexture)),
          Promise.all(r)
        );
      }
    }
        ...
        if (!i.extensions || !i.extensions[this.name]) return null;
        {
          ...
          return n.then(function (t) {
            ...
            return r.decodeGltfBufferAsync
              ? r.decodeGltfBufferAsync(a, s, o, e.mode, e.filter).then(function (e) {
                  return e.buffer;
                })
    ...
    class oc {
      ...
      createNodeMesh(e) {
        ...
        for (let e of t.meshes[i.mesh].primitives)
          if (
            e.mode !== ox.TRIANGLES &&
            e.mode !== ox.TRIANGLE_STRIP &&
            e.mode !== ox.TRIANGLE_FAN &&
            void 0 !== e.mode
          )
            return null;
        let n = i.extensions[this.name].attributes,
          r = [],
          a = {};
        for (let e in n) r.push(this.parser.getDependency("accessor", n[e]).then((t) => ((a[e] = t), a[e])));
        return r.length < 1
          ? null
            ...
            Promise.all(r).then((e) => {
              ...
              for (let e of i) {
                let t = new eP(),
                  ...
                  s = new D(),
                  o = new U(1, 1, 1),
                  l = new iA(e.geometry, e.material, n);
                for (let e = 0; e < n; e++)
                ...
                for (let t in a)
                  if ("_COLOR_0" === t) {
                    let e = a[t];
                    l.instanceColor = new iv(e.array, e.itemSize, e.normalized);
                  } else "TRANSLATION" !== t && "ROTATION" !== t && "SCALE" !== t && e.geometry.setAttribute(t, a[t]);
                (e2.prototype.copy.call(l, e), this.parser.assignFinalMaterial(l), r.push(l));
              }
    ...
    class od {
      constructor(e) {
        ((this.name = sU), (this.content = null), (this.body = null));
    ...
    class op {
      constructor(e, t) {
        ...
        ((this.name = sO), (this.json = e), (this.dracoLoader = t), this.dracoLoader.preload());
      }
      decodePrimitive(e, t) {
        let i = this.json,
          n = this.dracoLoader,
          ...
          o = {},
          h = {};
        for (let e in a) s[ob[e] || e.toLowerCase()] = a[e];
        for (let t in e.attributes) {
          let n = ob[t] || t.toLowerCase();
          if (void 0 !== a[t]) {
            let r = i.accessors[e.attributes[t]],
              a = oy[r.componentType];
            ((h[n] = a.name), (o[n] = !0 === r.normalized));
          }
        }
    ...
    let ox = { POINTS: 0, LINES: 1, LINE_LOOP: 2, LINE_STRIP: 3, TRIANGLES: 4, TRIANGLE_STRIP: 5, TRIANGLE_FAN: 6 },
      oy = {
        5120: Int8Array,
        5121: Uint8Array,
        5122: Int16Array,
      ...
      oM = { 9728: 1003, 9729: 1006, 9984: 1004, 9985: 1007, 9986: 1005, 9987: 1008 },
      oS = { 33071: 1001, 33648: 1002, 10497: 1e3 },
      ...
      oE = { scale: "scale", translation: "position", rotation: "quaternion", weights: "morphTargetInfluences" },
      oA = { CUBICSPLINE: void 0, LINEAR: 2301, STEP: 2300 };
    function ow(e, t, i) {
    ...
    class oL {
      constructor(e = {}, t = {}) {
        ...
        if ("u" > typeof navigator) {
          ...
          ((n = i && t ? parseInt(t[1], 10) : -1),
            (a = (r = e.indexOf("Firefox") > -1) ? e.match(/Firefox\/([0-9]+)\./)[1] : -1));
        }
        ("u" < typeof createImageBitmap || (i && n < 17) || (r && a < 98)
          ? (this.textureLoader = new nX(this.options.manager))
          : (this.textureLoader = new n6(this.options.manager)),
          this.textureLoader.setCrossOrigin(this.options.crossOrigin),
          this.textureLoader.setRequestHeader(this.options.requestHeader),
          (this.fileLoader = new nG(this.options.manager)),
      ...
      loadBuffer(e) {
        ...
        if (void 0 === t.uri && 0 === e) return Promise.resolve(this.extensions[sU].body);
        let n = this.options;
        return new Promise(function (e, r) {
          i.load(n4.resolveURL(t.uri, n.path), e, void 0, function () {
      ...
      loadAccessor(e) {
        ...
        if (void 0 === n.bufferView && void 0 === n.sparse) {
          let e = oT[n.type],
            t = oy[n.componentType],
            i = !0 === n.normalized;
          return Promise.resolve(new ty(new t(n.count * e), e, i));
        }
        let r = [];
        return (
          void 0 !== n.bufferView ? r.push(this.getDependency("bufferView", n.bufferView)) : r.push(null),
          void 0 !== n.sparse &&
          ...
          Promise.all(r).then(function (e) {
            ...
            if (u && u !== h) {
              let e = Math.floor(c / u),
                ...
                h = t.cache.get(i);
              (h || ((h = new t9(new o(a, e * u, (n.count * u) / l), u / l)), t.cache.add(i, h)),
                (r = new ie(h, s, (c % u) / l, d)));
            } else r = new ty(null === a ? new o(n.count * s) : new o(a, c, n.count * s), s, d);
            if (void 0 !== n.sparse) {
              let t = oT.SCALAR,
                i = oy[n.sparse.indices.componentType],
              ...
              (null !== a && (r = new ty(r.array.slice(), r.itemSize, r.normalized)), (r.normalized = !1));
      ...
      loadTextureImage(e, t, i) {
        ...
        let l = this.loadImageSource(t, i)
          .then(function (t) {
            ...
            return (
              (t.magFilter = oM[i.magFilter] || 1006),
              (t.minFilter = oM[i.minFilter] || 1008),
              (t.wrapS = oS[i.wrapS] || 1e3),
              (t.wrapT = oS[i.wrapT] || 1e3),
              (t.generateMipmaps = !t.isCompressedTexture && 1003 !== t.minFilter && 1006 !== t.minFilter),
      ...
      loadImageSource(e, t) {
        ...
        else if (void 0 === r.uri) throw Error("THREE.GLTFLoader: Image " + e + " is missing URI and bufferView");
          ...
          .then(function (e) {
            return new Promise(function (i, r) {
              ...
              (!0 === t.isImageBitmapLoader &&
                ...
                t.load(n4.resolveURL(e, n.path), a, void 0, r));
            });
          })
          .then(function (e) {
            var t;
      ...
      assignTexture(e, t, i, n) {
        ...
        return this.getDependency("texture", i.index).then(function (a) {
          if (!a) return null;
          if ((void 0 !== i.texCoord && i.texCoord > 0 && ((a = a.clone()).channel = i.texCoord), r.extensions[sK])) {
            let e = void 0 !== i.extensions ? i.extensions[sK] : void 0;
            if (e) {
              let t = r.associations.get(a);
              ((a = r.extensions[sK].extendTexture(a, e)), r.associations.set(a, t));
            }
          }
      ...
      assignFinalMaterial(e) {
        ...
        if (n || r || a) {
          ...
          (n && (e += "derivative-tangents:"), r && (e += "vertex-colors:"), a && (e += "flat-shading:"));
          let t = this.cache.get(e);
          (t ||
            ((t = i.clone()),
            r && (t.vertexColors = !0),
      ...
      loadMaterial(e) {
        ...
        if (h[sj]) {
          let e = r[sj];
          ((t = e.getMaterialType()), c.push(e.extendParams(s, a, i)));
        } else {
          let n = a.pbrMetallicRoughness || {};
          if (((s.color = new td(1, 1, 1)), (s.opacity = 1), Array.isArray(n.baseColorFactor))) {
            let e = n.baseColorFactor;
            (s.color.setRGB(e[0], e[1], e[2], l), (s.opacity = e[3]));
          }
          (void 0 !== n.baseColorTexture && c.push(i.assignTexture(s, "map", n.baseColorTexture, o)),
            ...
            void 0 !== n.metallicRoughnessTexture &&
              (c.push(i.assignTexture(s, "metalnessMap", n.metallicRoughnessTexture)),
              c.push(i.assignTexture(s, "roughnessMap", n.metallicRoughnessTexture))),
        ...
        let u = a.alphaMode || "OPAQUE";
        if (
          ("BLEND" === u
            ? ((s.transparent = !0), (s.depthWrite = !1))
            : ((s.transparent = !1), "MASK" === u && (s.alphaTest = void 0 !== a.alphaCutoff ? a.alphaCutoff : 0.5)),
          void 0 !== a.normalTexture &&
            t !== tg &&
            (c.push(i.assignTexture(s, "normalMap", a.normalTexture)),
        ...
        if (
          (void 0 !== a.occlusionTexture &&
            t !== tg &&
            (c.push(i.assignTexture(s, "aoMap", a.occlusionTexture)),
            void 0 !== a.occlusionTexture.strength && (s.aoMapIntensity = a.occlusionTexture.strength)),
          void 0 !== a.emissiveFactor && t !== tg)
        ) {
          let e = a.emissiveFactor;
          s.emissive = new td().setRGB(e[0], e[1], e[2], l);
        }
        return (
          void 0 !== a.emissiveTexture && t !== tg && c.push(i.assignTexture(s, "emissiveMap", a.emissiveTexture, o)),
      ...
      loadGeometries(e) {
        ...
        for (let a = 0, s = e.length; a < s; a++) {
          let s = e[a],
            o = (function (e) {
              let t,
                i = e.extensions && e.extensions[sO];
              if (
                ((t = i
                  ? "draco:" + i.bufferView + ":" + i.indices + ":" + oC(i.attributes)
                  : e.indices + ":" + oC(e.attributes) + ":" + e.mode),
                void 0 !== e.targets)
              )
                for (let i = 0, n = e.targets.length; i < n; i++) t += ":" + oC(e.targets[i]);
              return t;
            })(s),
            l = n[o];
          if (l) r.push(l.promise);
            ...
            let e;
            ((e =
              s.extensions && s.extensions[sO]
                ? (function (e) {
                    return i[sO].decodePrimitive(e, t).then(function (i) {
                      return oN(i, e, t);
                    });
                  })(s)
                : oN(new tI(), s, t)),
        ...
        return (
          ...
          Promise.all(s).then(function (i) {
            ...
            for (let i = 0, h = o.length; i < h; i++) {
              ...
              if (
                u.mode === ox.TRIANGLES ||
                u.mode === ox.TRIANGLE_STRIP ||
                u.mode === ox.TRIANGLE_FAN ||
                void 0 === u.mode
              )
                (!0 === (h = !0 === r.isSkinnedMesh ? new iu(c, d) : new tH(c, d)).isSkinnedMesh &&
                  h.normalizeSkinWeights(),
                  u.mode === ox.TRIANGLE_STRIP
                    ? (h.geometry = sN(h.geometry, 1))
                    : u.mode === ox.TRIANGLE_FAN && (h.geometry = sN(h.geometry, 2)));
              else if (u.mode === ox.LINES) h = new iq(c, d);
              else if (u.mode === ox.LINE_STRIP) h = new iH(c, d);
              else if (u.mode === ox.LINE_LOOP) h = new iY(c, d);
              else if (u.mode === ox.POINTS) h = new i0(c, d);
              ...
              (Object.keys(h.geometry.morphAttributes).length > 0 &&
                ...
                oR(h, r),
                u.extensions && ow(n, h, u),
                t.assignFinalMaterial(h),
                l.push(h));
            }
            for (let i = 0, n = l.length; i < n; i++) t.associations.set(l[i], { meshes: e, primitives: i });
            if (1 === l.length) return (r.extensions && ow(n, l[0], r), l[0]);
            let h = new t5();
            (r.extensions && ow(n, h, r), t.associations.set(h, { meshes: e }));
      ...
      loadCamera(e) {
        ...
        return n
          ? ("perspective" === i.type
              ? (t = new t1(L.radToDeg(n.yfov), n.aspectRatio || 1, n.znear || 1, n.zfar || 2e6))
              : "orthographic" === i.type && (t = new n1(-n.xmag, n.xmag, n.ymag, -n.ymag, n.znear, n.zfar)),
      ...
      loadSkin(e) {
        let t = this.json.skins[e],
          i = [];
        for (let e = 0, n = t.joints.length; e < n; e++) i.push(this._loadNodeShallow(t.joints[e]));
        return (
      ...
      loadAnimation(e) {
        ...
        return Promise.all([Promise.all(a), Promise.all(s), Promise.all(o), Promise.all(l), Promise.all(h)]).then(
          function (e) {
            let t = e[0],
              a = e[1],
              s = e[2],
            ...
            for (let e = 0, n = t.length; e < n; e++) {
              ...
              let p = i._createAnimationTracks(n, r, c, u, d);
              if (p) for (let e = 0; e < p.length; e++) h.push(p[e]);
            }
            let c = new nO(r, void 0, h);
            return (oR(c, n), c);
          },
        );
      }
      ...
      loadNode(e) {
        let t = this.json.nodes[e],
          ...
          n = [],
          r = t.children || [];
        for (let e = 0, t = r.length; e < t; e++) n.push(this.getDependency("node", r[e]));
      ...
      _loadNodeShallow(e) {
        ...
        return (
          ...
          (this.nodeCache[e] = Promise.all(s).then(function (t) {
            let s;
            if ((s = !0 === r.isBone ? new id() : t.length > 1 ? new t5() : 1 === t.length ? t[0] : new e2()) !== t[0])
              for (let e = 0, i = t.length; e < i; e++) s.add(t[e]);
            if (
              (r.name && ((s.userData.name = r.name), (s.name = a)),
              oR(s, r),
              r.extensions && ow(i, s, r),
              void 0 !== r.matrix)
            ) {
              let e = new eP();
            ...
            if (n.associations.has(s)) {
              if (void 0 !== r.mesh && n.meshCache.refs[r.mesh] > 1) {
                let e = n.associations.get(s);
                n.associations.set(s, { ...e });
              }
            } else n.associations.set(s, {});
            return ((n.associations.get(s).nodes = e), s);
          })),
          this.nodeCache[e]
        );
      }
      loadScene(e) {
        let t = this.extensions,
          ...
          n = this,
          r = new t5();
        (i.name && (r.name = n.createUniqueName(i.name)), oR(r, i), i.extensions && ow(t, r, i));
        let a = i.nodes || [],
          s = [];
        for (let e = 0, t = a.length; e < t; e++) s.push(n.getDependency("node", a[e]));
        return Promise.all(s).then(function (e) {
          for (let t = 0, i = e.length; t < i; t++) r.add(e[t]);
          return (
            (n.associations = ((e) => {
              let t = new Map();
              for (let [e, i] of n.associations) (e instanceof tm || e instanceof Z) && t.set(e, i);
              return (
                e.traverse((e) => {
      ...
      _createAnimationTracks(e, t, i, n, r) {
        ...
        switch (
          ...
          case oE.scale:
            ...
            break;
          default:
            a = 1 === i.itemSize ? nI : nU;
        }
        let h = void 0 !== n.interpolation ? oA[n.interpolation] : 2301,
          c = this._getArrayFromAccessor(i);
        for (let e = 0, i = l.length; e < i; e++) {
          let i = new a(l[e] + "." + oE[r.path], t.array, c, h);
          ("CUBICSPLINE" === n.interpolation && this._createCubicSplineTrackInterpolant(i), s.push(i));
        }
        return s;
      }
      ...
      _createCubicSplineTrackInterpolant(e) {
        ((e.createInterpolant = function (e) {
          return new (this instanceof nN ? ov : og)(this.times, this.values, this.getValueSize() / 3, e);
        }),
    ...
    function oN(e, t, i) {
      ...
      return (
        G.workingColorSpace !== l &&
          "COLOR_0" in n &&
          console.warn(
            `THREE.GLTFLoader: Converting vertex colors from "srgb-linear" to "${G.workingColorSpace}" not supported.`,
          ),
        oR(e, t),
        !(function (e, t, i) {
          let n = t.attributes,
          ...
          if (void 0 === n.POSITION) return;
          {
            ...
            if (void 0 === t || void 0 === a)
              return console.warn("THREE.GLTFLoader: Missing min/max properties for accessor POSITION.");
            if ((r.set(new U(t[0], t[1], t[2]), new U(a[0], a[1], a[2])), e.normalized)) {
              let t = oP(oy[e.componentType]);
          ...
          return void 0 !== t.targets
            ? (function (e, t, i) {
                ...
                for (let h = 0, c = t.length; h < c; h++) {
                  let c = t[h];
                  if (n) {
                    let t = void 0 !== c.POSITION ? i.getDependency("accessor", c.POSITION) : e.attributes.position;
                    s.push(t);
                  }
                  if (r) {
                    let t = void 0 !== c.NORMAL ? i.getDependency("accessor", c.NORMAL) : e.attributes.normal;
                    o.push(t);
                  }
                  if (a) {
                    let t = void 0 !== c.COLOR_0 ? i.getDependency("accessor", c.COLOR_0) : e.attributes.color;
                    l.push(t);
                  }
                }
        ...
        class extends nz {
          ...
          load(e, t, i, n) {
            ...
            if ("" !== this.resourcePath) r = this.resourcePath;
              ...
              let t = n4.extractUrlBase(e);
              r = n4.resolveURL(t, this.path);
            } else r = n4.extractUrlBase(e);
            this.manager.itemStart(e);
            let s = function (t) {
          ...
          parse(e, t, i, n) {
            ...
            if ("string" == typeof e) r = JSON.parse(e);
              ...
              if (o.decode(new Uint8Array(e, 0, 4)) === ou) {
                try {
                  a[sU] = new od(e);
                } catch (e) {
                  n && n(e);
