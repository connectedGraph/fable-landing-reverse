(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 325846, stylesModule => {
  stylesModule.v({
...
}, 823698, runtimeModule => {
  "use strict";

  var heroEngineModule = runtimeModule.i(843476),
    reactModule = runtimeModule.i(271645),
    assetModule = runtimeModule.i(343794),
    stylesModule = runtimeModule.i(325846);
  let placeholderText = ".".repeat(160),
    cssClasses = {
      host: stylesModule.default.scene,
      canvas: stylesModule.default.canvas,
      drawn: stylesModule.default.drawn,
      overBird: stylesModule.default["over-bird"],
      looks: stylesModule.default.looks,
      look: stylesModule.default.look,
      on: stylesModule.default.on,
      night: stylesModule.default.night,
      dusk: stylesModule.default.dusk,
      morning: stylesModule.default.morning,
      unsupported: stylesModule.default.unsupported
    };
  runtimeModule.s(["default", 0, function ({
    modelName: modelName,
    version: version,
    companion: companion,
    date: date,
    index: indexItems,
    assets: assetsBase = "/fx/hero/",
    still = !1,
    seed: seed,
    className: className,
    ...restProps
  }) {
    let heroRef = (0, reactModule.useRef)(null),
      titleRef = (0, reactModule.useRef)(null),
      indexRef = (0, reactModule.useRef)(null),
      dateRef = (0, reactModule.useRef)(null),
      titleText = ["Claude", modelName, version].filter(Boolean).join(" "),
      companionText = companion && ["and", companion.modelName, companion.version].filter(Boolean).join(" "),
      accessibleTitle = [titleText, companionText].filter(Boolean).join(" "),
      creditText = ["Made with", modelName, version].filter(Boolean).join(" ");
    return (0, reactModule.useEffect)(() => {
      let e = heroRef.current;
      if (!e) return;
      document.fonts.ready.then(() => e.setAttribute("data-fx-ready", ""));
      let t = e => {
        let t = e.target;
        t instanceof HTMLElement && (t.style.animation = "none", t.style.filter = "none", t.style.opacity = "1");
      };
      return e.addEventListener("animationend", t, !0), () => e.removeEventListener("animationend", t, !0);
    }, []), (0, reactModule.useEffect)(() => {
      let t = heroRef.current;
      if (!t || still) return;
      let a = !1,
        l = null,
        s = null,
        i = () => function (heroElement, titleElement, indexElement, dateElement) {
          let width = heroElement.clientWidth,
          ...
          let getBox = (t, a, l) => {
            ...
            let n = 0,
              o = 0,
              r = t;
            for (; r && r !== heroElement;) n += r.offsetLeft, o += r.offsetTop, r = r.offsetParent;
            return [(n - a) / width, (o - l) / height, (n + t.offsetWidth + a) / width, (o + t.offsetHeight + l) / height];
          };
          return [getBox(titleElement, 32, 18), getBox(indexElement, 40, 22), getBox(dateElement, 56, 30)];
        }(t, titleRef.current, indexRef.current, dateRef.current);
      return runtimeModule.A(43259).then(({
        createFableHero: e
      }) => {
        if (a || !(l = e(t, {
          assets: assetsBase,
    ...
    }, [assetsBase, still, seed]), (0, heroEngineModule.jsxs)("header", {
      ...restProps,
      ref: heroRef,
      className: (0, assetModule.default)(stylesModule.default["launch-hero"], className),
      children: [(0, heroEngineModule.jsxs)("div", {
        className: stylesModule.default.words,
        children: [date && (0, heroEngineModule.jsx)("p", {
          ref: dateRef,
          className: (0, assetModule.default)("text-prehead-tracked", stylesModule.default.date),
          children: date
        }), (0, heroEngineModule.jsxs)("h1", {
          ref: titleRef,
          className: stylesModule.default.title,
          "aria-label": accessibleTitle,
          children: [(0, heroEngineModule.jsxs)("span", {
            className: stylesModule.default["title-line"],
            "aria-hidden": "true",
            children: [(0, heroEngineModule.jsx)("span", {
              className: stylesModule.default["title-claude"],
              children: ":Claude:"
            }), modelName && ` ${modelName}`, version && ` ${version}`]
          }), companionText && (0, heroEngineModule.jsx)("span", {
            className: (0, assetModule.default)(stylesModule.default["title-line"], stylesModule.default["title-line-second"]),
            "aria-hidden": "true",
            children: companionText
          })]
        }), indexItems.length > 0 && (0, heroEngineModule.jsx)("nav", {
          ref: indexRef,
          className: stylesModule.default.index,
          "aria-label": "Contents",
          children: indexItems.map((e, a) => (0, heroEngineModule.jsx)("a", {
            href: e.target,
            className: stylesModule.default["index-row"],
            style: {
              "--fx-row": a
            },
            children: (0, heroEngineModule.jsxs)("span", {
              className: stylesModule.default["index-row-inner"],
              children: [(0, heroEngineModule.jsxs)("span", {
                className: stylesModule.default["index-number"],
                children: ["[", a + 1, "]"]
              }), (0, heroEngineModule.jsx)("span", {
                className: stylesModule.default["index-leader"],
                "aria-hidden": "true",
        ...
        className: stylesModule.default.credit,
        children: creditText
      })]
    });
  }]);
  ...
  e.s(["default", 0, function ({
    ...
    (0, a.useEffect)(() => {
      ...
      return l(), window.addEventListener("scroll", s, {
        passive: !0
      }), window.addEventListener("resize", s), () => {
        window.removeEventListener("scroll", s), window.removeEventListener("resize", s), cancelAnimationFrame(a);
      };
    }, [e]);
    let p = e => {
      e.currentTarget.hasPointerCapture(e.pointerId) && e.currentTarget.releasePointerCapture(e.pointerId), f.current.active = !1, m(!1);
    };
    return 0 === e.length ? null : (0, t.jsx)("nav", {
      ...
      children: (0, t.jsx)("ol", {
        ...
        onPointerMove: e => {
          let t = f.current;
          !t.active || !t.moved && 4 > Math.abs(e.clientY - t.startY) || (t.moved || (t.moved = !0, m(!0), e.currentTarget.setPointerCapture(e.pointerId)), (e => {
            let t,
              a,
              l,
              s = _.current;
            ...
            let i = s.getBoundingClientRect(),
              ...
              } = (t = h.current.find(Boolean), a = document.querySelector("footer"), {
                start: l = t ? t.getBoundingClientRect().top + window.scrollY - 96 : 0,
                end: Math.max(l, a ? a.getBoundingClientRect().top + window.scrollY - window.innerHeight : document.body.scrollHeight - window.innerHeight)
              });
            window.scrollTo({
              top: o + n * (r - o),
              behavior: "auto"
  ...
  function c({
    ...
    return ((0, l.useEffect)(() => {
    ...
    }, [r, h, f]), 0 === e.length) ? null : (0, t.jsxs)("div", {
      ...i,
      ...
      children: [(0, t.jsx)("div", {
        ...
        children: (0, t.jsx)("div", {
          ...
          ref: _,
          children: e.map((e, a) => (0, t.jsxs)("figure", {
            ...
            children: [(0, t.jsx)("div", {
              ...
              children: "image" === e.kind ? (0, t.jsx)(n.default, {
                src: e.src,
                alt: e.alt,
                width: e.width,
                height: e.height,
            ...
            }), e.caption && (0, t.jsx)("figcaption", {
              className: "caption",
              children: e.caption
            })]
          }, a))
        })
      }), e.length > 1 && h && (0, t.jsxs)("div", {
        ...
        children: [(0, t.jsxs)("div", {
          ...
          children: [(0, t.jsx)("button", {
            ...
            children: (0, t.jsx)(o.IconCaretDown, {
              height: 16,
              width: 16
            })
          }), (0, t.jsx)("button", {
  ...
  function _(e) {
    ...
    let l,
      ...
      o,
      r = e?.media;
    return r?.mediaType === "image" ? (t = r.image, l = t?.url?.trim(), s = t?.width, i = t?.height, l && "number" == typeof s && "number" == typeof i ? {
      kind: "image",
      src: l,
      ...
      height: i,
      caption: f(t?.caption)
    } : null) : r?.mediaType === "video" ? (a = r.video, n = a?.url?.trim() || void 0, o = a?.embedUrl?.trim() || void 0, n || o ? {
      kind: "video",
      src: n,
      embedUrl: o,
      poster: function (e) {
        let t = e?.url?.trim(),
          a = e?.width,
          l = e?.height;
        if (t && "number" == typeof a && "number" == typeof l) return {
          src: t,
          width: a,
          height: l
        };
  ...
  function f(e) {
    if (Array.isArray(e) && 0 !== e.length) return (0, t.jsx)(h.default, {
      stripBlock: !0,
      marks: {
        sup: ({
          children: e
  ...
  function p({
    ...
    let a,
      l,
      s = 0 === (l = (Array.isArray(a = e?.items) ? a : []).map(_).filter(e => null !== e)).length ? null : {
        figures: l
      };
    return s ? (0, t.jsx)(c, {
      ...s
  ...
  function y({
    ...
    let _ = e.length,
      ...
      p = e => {
        ...
        t !== (c ?? o) && (m(t), u(!1), window.clearTimeout(h.current), h.current = window.setTimeout(() => {
          r(t), m(null);
        }, 180));
      };
    return (0, t.jsxs)("figure", {
      ...
      children: [_ > 1 && (0, t.jsxs)("div", {
        ...
        children: [(0, t.jsx)("button", {
          ...
          className: w.default["pagination-count"],
          children: [(c ?? o) + 1, " of ", _]
        }), (0, t.jsx)("button", {
          type: "button",
          className: w.default["pagination-button"],
        ...
        children: d ? (0, t.jsx)("iframe", {
          ...
          src: (n = f.youtubeId, `https://www.youtube-nocookie.com/embed/${n}?autoplay=1&rel=0&modestbranding=1&playsinline=1`),
          title: f.caption ?? "Video",
          allow: "autoplay; encrypted-media; picture-in-picture",
          allowFullScreen: !0
        }) : (0, t.jsxs)(t.Fragment, {
          children: [f.animatedPosterUrl ? (0, t.jsx)("video", {
            ...
            muted: !0,
            playsInline: !0
          }, f.animatedPosterUrl) : f.poster && (0, t.jsx)(g.default, {
            className: w.default.poster,
            src: f.poster.url,
            alt: f.poster.alt,
  ...
  let b = {
    manateeVideoSwitcher: ({
      ...
      return (0, t.jsx)("div", {
        ...
        children: (0, t.jsx)(y, {
          videos: (a = e, Array.isArray(l = a?.videos) ? l.map(e => {
  ...
  e.s(["default", 0, function ({
    ...
    let {
        ...
        let t, a;
        return t = {}, a = new Set(), e.forEach((l, s) => {
          if (l?._type !== "manateeNavMarker") return;
          let i = l.anchor?.current?.trim();
          if (!l._key || !i) return;
          let n = e[s + 1];
          n?._type === "block" && "string" == typeof n.style && v.HEADING_STYLES.has(n.style) && n._key && (t[n._key] = i, a.add(l._key));
        }), {
          headingIds: t,
          adoptedMarkers: a
        };
      ...
      n = (0, l.useMemo)(() => ({
        ...
        manateeNavMarker: ({
          ...
          return !a || e._key && i.has(e._key) ? null : (0, t.jsx)("span", {
            id: a,
            className: x.default.anchor
          });
        }
      }), [i]);
  ...
  e.v(t => Promise.all(["static/chunks/3ikv1zfcxpxsn.js", "static/chunks/2gmlunbgaqe4d.js"].map(t => e.l(t))).then(() => t(520697)));
}, 296349, e => {
  ...
  e.v(t => Promise.all(["static/chunks/14c8frmb4u5hu.js", "static/chunks/43wzyymewd7k8.js"].map(t => e.l(t))).then(() => t(222197)));
}, 52572, e => {
